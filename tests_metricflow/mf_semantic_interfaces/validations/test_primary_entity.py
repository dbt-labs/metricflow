...
def test_primary_entity_not_set(simple_semantic_manifest: PydanticSemanticManifest) -> None:  # noqa:D
...
def test_primary_entity_conflict(simple_semantic_manifest: PydanticSemanticManifest) -> None:  # noqa:D
    semantic_manifest_copy = deepcopy(simple_semantic_manifest)
