...
# # TODO: move these tests to normal rendering test section (unless already covered)
# @pytest.mark.sql_engine_snapshot
...
#         time_spine_node=time_spine_node,  # TODO
#         replace_time_dimension_specs=[MTD_SPEC_DAY],
