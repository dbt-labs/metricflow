...
# from typing import Iterator, Mapping, Optional, Sequence, Generic, Type
#
# from metricflow_semantics.toolkit.mf_logging.lazy_formattable import LazyFormat
# from tests_metricflow.release_validation.process_interface import WorkerInputMessageT, WorkerOutputMessageT, \
...
#
# # WorkerProcessInitArgument(Generic[WorkerInputMessageT, WorkerOutputMessageT]):
...
# #     input_queue: Queue[Optional[WorkerInputMessageT]]
# #     output_queue: Queue[WorkerOutputMessageT]
# #     environment_variables: Tuple[Tuple[str, str], ...]
#
# class WorkerProcessRunner(Generic[WorkerInputMessageT, WorkerOutputMessageT]):
...
#     """
#
#     def __init__(self, input_message_class: Type[WorkerInputMessageT], output_message_class: Type[WorkerOutputMessageT]) -> None:
#
...
#         self._input_message_class = input_message_class
#         self._output_message_class = output_message_class
#
#     @contextmanager
...
#
#
#         executor_process_starting_parameter_set = WorkerProcessInitArgument(
#             log_file_path=log_file_path,
#             input_queue=input_queue,
#             output_queue=output_queue,
#             input_message_class=self._input_message_class,
#             output_message_class=self._output_message_class,
#         )
#
#         executor_process: multiprocessing.context.SpawnProcess = self._multiprocessing_context.Process(
#             target=WorkerProcessRunner._process_target,
