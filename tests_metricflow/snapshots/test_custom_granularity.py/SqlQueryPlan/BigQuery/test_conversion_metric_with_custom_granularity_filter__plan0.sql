...
SELECT
  ...
  , CAST(subq_20.buys AS FLOAT64) / CAST(NULLIF(subq_20.visits, 0) AS FLOAT64) AS visit_buy_conversion_rate_7days
FROM (
            ...
            ON
              (
                ...
                (
                  ...
                  subq_11.ds__day > DATE_SUB(CAST(subq_14.ds__day AS DATETIME), INTERVAL 7 day)
                )
              )
          ) subq_15
        ) subq_16
