...
SELECT
  ...
  , CAST(subq_19.buys AS DOUBLE) / CAST(NULLIF(subq_19.visits, 0) AS DOUBLE) AS visit_buy_conversion_rate_7days
FROM (
  -- Combine Aggregated Outputs
  SELECT
    COALESCE(subq_5.metric_time__martian_day, subq_18.metric_time__martian_day) AS metric_time__martian_day
  ...
  ON
    subq_5.metric_time__martian_day = subq_18.metric_time__martian_day
  GROUP BY
