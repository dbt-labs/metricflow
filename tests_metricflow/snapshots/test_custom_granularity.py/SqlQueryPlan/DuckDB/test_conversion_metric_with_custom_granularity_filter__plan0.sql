...
SELECT
  ...
  , CAST(subq_20.buys AS DOUBLE) / CAST(NULLIF(subq_20.visits, 0) AS DOUBLE) AS visit_buy_conversion_rate_7days
FROM (
            ...
            ON
              (
                ...
                (
                  ...
                  subq_11.metric_time__day > subq_14.metric_time__day - INTERVAL 7 day
                )
              )
          ) subq_15
        ) subq_16
