...
SELECT
  subq_10.listing__ds__martian_day
  , subq_10.bookings
FROM (
  -- Aggregate Measures
  SELECT
    subq_9.listing__ds__martian_day
  ...
  FROM (
    ...
    FROM (
      ...
      SELECT
        ...
        , subq_7.martian_day AS listing__ds__martian_day
      FROM (
        -- Join Standard Outputs
        SELECT
          subq_5.ds__day AS listing__ds__day
      ...
      ON
        subq_6.listing__ds__day = subq_7.ds
    ) subq_8
  ) subq_9
  GROUP BY
    subq_9.listing__ds__martian_day
