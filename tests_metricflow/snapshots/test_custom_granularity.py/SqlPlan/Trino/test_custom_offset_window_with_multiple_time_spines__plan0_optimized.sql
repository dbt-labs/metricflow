...
FROM (
  ...
  FROM (
    ...
    SELECT
      ...
      , CASE
        WHEN DATE_ADD('hour', (cte_6.ts__hour__row_number - 1), subq_28.ts__hour__first_value__lead) <= subq_28.ts__hour__last_value__lead
          THEN DATE_ADD('hour', (cte_6.ts__hour__row_number - 1), subq_28.ts__hour__first_value__lead)
        ELSE NULL
