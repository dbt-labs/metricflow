          ...
          FROM (
            ...
            FROM (
              ...
              SELECT
                ...
                , CASE
                  WHEN DATE_ADD('day', (subq_3.ds__day__row_number - 1), subq_8.ds__martian_day__first_value__offset) <= subq_8.ds__martian_day__last_value__offset
                    THEN DATE_ADD('day', (subq_3.ds__day__row_number - 1), subq_8.ds__martian_day__first_value__offset)
