...
FROM (
  ...
  FROM (
    ...
    SELECT
      ...
      , CASE
        WHEN addDays(subq_27.ds__alien_day__first_value__lead, (cte_6.ds__day__row_number - 1)) <= subq_27.ds__alien_day__last_value__lead
          THEN addDays(subq_27.ds__alien_day__first_value__lead, (cte_6.ds__day__row_number - 1))
        ELSE NULL
