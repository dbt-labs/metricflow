...
FROM (
  SELECT
    ...
    , toStartOfMonth(subq_29.ds__day__lead) AS booking__ds__month
    , toYear(subq_29.ds__day__lead) AS metric_time__extract_year
  ...
  FROM (
    ...
    SELECT
      ...
      , CASE
        WHEN addDays(subq_28.ds__alien_day__first_value__lead, (cte_6.ds__day__row_number - 1)) <= subq_28.ds__alien_day__last_value__lead
          THEN addDays(subq_28.ds__alien_day__first_value__lead, (cte_6.ds__day__row_number - 1))
        ELSE NULL
