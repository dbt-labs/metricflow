            ...
            FROM (
              ...
              FROM (
                ...
                FROM (
                  SELECT
                    subq_9.ds__day
                    , toStartOfMonth(subq_9.ds__day__lead) AS booking__ds__month
                    , toYear(subq_9.ds__day__lead) AS metric_time__extract_year
                  ...
                  FROM (
                    ...
                    SELECT
                      ...
                      , CASE
                        WHEN addDays(subq_8.ds__alien_day__first_value__lead, (cte_2.ds__day__row_number - 1)) <= subq_8.ds__alien_day__last_value__lead
                          THEN addDays(subq_8.ds__alien_day__first_value__lead, (cte_2.ds__day__row_number - 1))
                        ELSE NULL
