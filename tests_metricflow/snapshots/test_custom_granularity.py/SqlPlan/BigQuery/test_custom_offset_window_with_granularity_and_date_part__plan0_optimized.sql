...
FROM (
  ...
  SELECT
    ...
    , DATETIME_TRUNC(subq_25.ds__day__lead, month) AS booking__ds__month
  ...
  FROM (
    ...
    SELECT
      ...
      , CASE
        WHEN DATE_ADD(CAST(subq_24.ds__martian_day__first_value__offset AS DATETIME), INTERVAL cgb_1_cte.ds__day__row_number - 1 day) <= subq_24.ds__martian_day__last_value__offset
          THEN DATE_ADD(CAST(subq_24.ds__martian_day__first_value__offset AS DATETIME), INTERVAL cgb_1_cte.ds__day__row_number - 1 day)
