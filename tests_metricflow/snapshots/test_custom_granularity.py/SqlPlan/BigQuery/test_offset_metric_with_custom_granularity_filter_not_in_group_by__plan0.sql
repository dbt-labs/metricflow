...
FROM (
  ...
  SELECT
    ...
    , nr_subq_8.bookings AS bookings_5_days_ago
  FROM (
    -- Aggregate Measures
    SELECT
    ...
    FROM (
      ...
      FROM (
        ...
        SELECT
          ...
          , nr_subq_5.paid_at__day
          , nr_subq_5.paid_at__week
          , nr_subq_5.paid_at__month
          , nr_subq_5.paid_at__quarter
          , nr_subq_5.paid_at__year
          , nr_subq_5.paid_at__extract_year
          , nr_subq_5.paid_at__extract_quarter
          , nr_subq_5.paid_at__extract_month
          , nr_subq_5.paid_at__extract_day
          , nr_subq_5.paid_at__extract_dow
          , nr_subq_5.paid_at__extract_doy
          , nr_subq_5.booking__ds__day
          , nr_subq_5.booking__ds__week
          , nr_subq_5.booking__ds__month
          , nr_subq_5.booking__ds__quarter
          , nr_subq_5.booking__ds__year
          , nr_subq_5.booking__ds__extract_year
          , nr_subq_5.booking__ds__extract_quarter
          , nr_subq_5.booking__ds__extract_month
          , nr_subq_5.booking__ds__extract_day
          , nr_subq_5.booking__ds__extract_dow
          , nr_subq_5.booking__ds__extract_doy
          , nr_subq_5.booking__ds_partitioned__day
          , nr_subq_5.booking__ds_partitioned__week
          , nr_subq_5.booking__ds_partitioned__month
          , nr_subq_5.booking__ds_partitioned__quarter
          , nr_subq_5.booking__ds_partitioned__year
          , nr_subq_5.booking__ds_partitioned__extract_year
          , nr_subq_5.booking__ds_partitioned__extract_quarter
          , nr_subq_5.booking__ds_partitioned__extract_month
          , nr_subq_5.booking__ds_partitioned__extract_day
          , nr_subq_5.booking__ds_partitioned__extract_dow
          , nr_subq_5.booking__ds_partitioned__extract_doy
          , nr_subq_5.booking__paid_at__day
          , nr_subq_5.booking__paid_at__week
          , nr_subq_5.booking__paid_at__month
          , nr_subq_5.booking__paid_at__quarter
          , nr_subq_5.booking__paid_at__year
          , nr_subq_5.booking__paid_at__extract_year
          , nr_subq_5.booking__paid_at__extract_quarter
          , nr_subq_5.booking__paid_at__extract_month
          , nr_subq_5.booking__paid_at__extract_day
          , nr_subq_5.booking__paid_at__extract_dow
          , nr_subq_5.booking__paid_at__extract_doy
          ...
          , nr_subq_5.guest
          , nr_subq_5.host
          , nr_subq_5.booking__listing
          , nr_subq_5.booking__guest
          , nr_subq_5.booking__host
          , nr_subq_5.is_instant
          , nr_subq_5.booking__is_instant
          , nr_subq_5.bookings
          , nr_subq_5.instant_bookings
          , nr_subq_5.booking_value
          , nr_subq_5.max_booking_value
          , nr_subq_5.min_booking_value
          , nr_subq_5.bookers
          , nr_subq_5.average_booking_value
          , nr_subq_5.referred_bookings
          , nr_subq_5.median_booking_value
          , nr_subq_5.booking_value_p99
          , nr_subq_5.discrete_booking_value_p99
          , nr_subq_5.approximate_continuous_booking_value_p99
          , nr_subq_5.approximate_discrete_booking_value_p99
        FROM (
          ...
          ON
            nr_subq_3.metric_time__day = nr_subq_4.ds
        ) nr_subq_5
