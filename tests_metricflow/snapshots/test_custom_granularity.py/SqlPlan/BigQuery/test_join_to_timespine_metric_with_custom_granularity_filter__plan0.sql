...
FROM (
  ...
  SELECT
    nr_subq_8.metric_time__martian_day AS metric_time__martian_day
    ...
    FROM (
      ...
      FROM (
        ...
        SELECT
          ...
          , nr_subq_5.ds__martian_day AS metric_time__martian_day
        FROM (
  ...
  ON
    nr_subq_8.metric_time__martian_day = nr_subq_4.metric_time__martian_day
) nr_subq_9
