            ...
            FROM (
              ...
              WITH cte_2 AS (
                ...
                SELECT
                  ...
                  , subq_7.ds__alien_day AS ds__alien_day
                  , FIRST_VALUE(subq_8.ts__hour) OVER (
                    PARTITION BY subq_7.ds__alien_day
              ...
              SELECT
                ...
                , CASE
                  WHEN DATE_ADD(CAST(subq_10.ts__hour__first_value__lead AS DATETIME), INTERVAL cte_2.ts__hour__row_number - 1 hour) <= subq_10.ts__hour__last_value__lead
                    THEN DATE_ADD(CAST(subq_10.ts__hour__first_value__lead AS DATETIME), INTERVAL cte_2.ts__hour__row_number - 1 hour)
                  ELSE NULL
              ...
              INNER JOIN (
                ...
                SELECT
                  ...
                  , LEAD(subq_9.ts__hour__first_value, 1) OVER (ORDER BY subq_9.ds__alien_day) AS ts__hour__first_value__lead
                  , LEAD(subq_9.ts__hour__last_value, 1) OVER (ORDER BY subq_9.ds__alien_day) AS ts__hour__last_value__lead
                FROM (
              ...
              ON
                cte_2.ds__alien_day = subq_10.ds__alien_day
            ) subq_11
          ) subq_12
        ) subq_13
        INNER JOIN (
