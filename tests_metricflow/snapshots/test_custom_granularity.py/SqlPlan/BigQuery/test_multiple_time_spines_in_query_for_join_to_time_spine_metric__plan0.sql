    ...
    FROM (
      ...
      FROM (
        ...
        SELECT
          ...
          , subq_5.ts__week AS ts__week
          , subq_5.ts__month AS ts__month
          , subq_5.ts__quarter AS ts__quarter
          , subq_5.ts__year AS ts__year
          , subq_5.ts__extract_year AS ts__extract_year
          , subq_5.ts__extract_quarter AS ts__extract_quarter
          , subq_5.ts__extract_month AS ts__extract_month
