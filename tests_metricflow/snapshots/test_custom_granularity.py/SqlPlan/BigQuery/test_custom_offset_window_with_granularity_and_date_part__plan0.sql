      ...
      FROM (
        ...
        FROM (
          ...
          FROM (
            ...
            SELECT
              subq_9.ds__day
              , DATETIME_TRUNC(subq_9.ds__day__lead, month) AS booking__ds__month
            ...
            FROM (
              ...
              SELECT
                ...
                , CASE
                  WHEN DATE_ADD(CAST(subq_8.ds__martian_day__first_value__offset AS DATETIME), INTERVAL subq_3.ds__day__row_number - 1 day) <= subq_8.ds__martian_day__last_value__offset
                    THEN DATE_ADD(CAST(subq_8.ds__martian_day__first_value__offset AS DATETIME), INTERVAL subq_3.ds__day__row_number - 1 day)
