      ...
      FROM (
        ...
        FROM (
          ...
          FROM (
            ...
            SELECT
              subq_5.ds__day
              , DATETIME_TRUNC(subq_5.ds__day__lead, month) AS booking__ds__month
            ...
            FROM (
              ...
              SELECT
                ...
                , CASE
                  WHEN DATE_ADD(CAST(subq_4.ds__martian_day__first_value__lead AS DATETIME), INTERVAL cte_2.ds__day__row_number - 1 day) <= subq_4.ds__martian_day__last_value__lead
                    THEN DATE_ADD(CAST(subq_4.ds__martian_day__first_value__lead AS DATETIME), INTERVAL cte_2.ds__day__row_number - 1 day)
                  ELSE NULL
