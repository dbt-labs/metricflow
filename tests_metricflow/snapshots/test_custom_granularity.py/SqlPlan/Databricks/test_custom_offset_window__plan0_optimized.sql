...
FROM (
  ...
  FROM (
    ...
    SELECT
      ...
      , CASE
        WHEN DATEADD(day, (cgb_1_cte.ds__day__row_number - 1), subq_23.ds__martian_day__first_value__offset) <= subq_23.ds__martian_day__last_value__offset
          THEN DATEADD(day, (cgb_1_cte.ds__day__row_number - 1), subq_23.ds__martian_day__first_value__offset)
