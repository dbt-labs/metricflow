          ...
          FROM (
            ...
            FROM (
              ...
              SELECT
                ...
                , CASE
                  WHEN DATEADD(day, (cte_2.ds__day__row_number - 1), nr_subq_7.ds__martian_day__first_value__lead) <= nr_subq_7.ds__martian_day__last_value__lead
                    THEN DATEADD(day, (cte_2.ds__day__row_number - 1), nr_subq_7.ds__martian_day__first_value__lead)
                  ELSE NULL
