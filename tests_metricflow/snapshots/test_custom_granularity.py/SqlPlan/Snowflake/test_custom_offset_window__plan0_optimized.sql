...
FROM (
  ...
  FROM (
    ...
    SELECT
      ...
      , CASE
        WHEN DATEADD(day, (cte_6.ds__day__row_number - 1), subq_16.ds__martian_day__first_value__lead) <= subq_16.ds__martian_day__last_value__lead
          THEN DATEADD(day, (cte_6.ds__day__row_number - 1), subq_16.ds__martian_day__first_value__lead)
        ELSE NULL
