          ...
          FROM (
            ...
            FROM (
              ...
              SELECT
                ...
                , CASE
                  WHEN DATEADD(hour, (cte_2.ts__hour__row_number - 1), subq_10.ts__hour__first_value__lead) <= subq_10.ts__hour__last_value__lead
                    THEN DATEADD(hour, (cte_2.ts__hour__row_number - 1), subq_10.ts__hour__first_value__lead)
                  ELSE NULL
