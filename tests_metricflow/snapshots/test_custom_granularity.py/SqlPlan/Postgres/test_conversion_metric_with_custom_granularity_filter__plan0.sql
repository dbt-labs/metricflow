...
SELECT
  ...
  , subq_18.visit_buy_conversion_rate_7days
FROM (
  ...
  FROM (
      ...
      FROM (
        ...
        FROM (
          ...
          SELECT
            ...
            , subq_2.visits
            , subq_2.visits_fill_nulls_with_0_join_to_timespine
          FROM (
            ...
            SELECT
              ...
              , subq_0.visits_fill_nulls_with_0_join_to_timespine AS visits_fill_nulls_with_0_join_to_timespine
            ...
            FROM (
              ...
              FROM (
                ...
                SELECT
                  ...
                  , subq_7.visits
                  , subq_7.visits_fill_nulls_with_0_join_to_timespine
                FROM (
                  -- Metric Time Dimension 'ds'
                  -- Join to Custom Granularity Dataset
                  SELECT
    ...
    GROUP BY
      COALESCE(subq_5.metric_time__alien_day, subq_16.metric_time__alien_day)
  ) subq_17
) subq_18
