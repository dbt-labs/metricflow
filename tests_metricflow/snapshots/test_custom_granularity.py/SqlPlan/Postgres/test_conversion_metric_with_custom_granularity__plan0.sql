...
FROM (
  ...
  SELECT
    ...
    , CAST(subq_15.__buys AS DOUBLE PRECISION) / CAST(NULLIF(subq_15.__visits, 0) AS DOUBLE PRECISION) AS visit_buy_conversion_rate_7days
  FROM (
