...
FROM (
      ...
      ON
        (
          ...
          (
            ...
            nr_subq_20.metric_time__day > nr_subq_22.metric_time__day - MAKE_INTERVAL(days => 7)
          )
        )
    ) nr_subq_23
    GROUP BY
  ...
  GROUP BY
    COALESCE(nr_subq_17.metric_time__martian_day, nr_subq_26.metric_time__martian_day)
) nr_subq_27
