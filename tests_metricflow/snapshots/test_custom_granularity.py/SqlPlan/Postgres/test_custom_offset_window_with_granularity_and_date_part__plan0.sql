      ...
      FROM (
        ...
        FROM (
          ...
          FROM (
            ...
            SELECT
              nr_subq_8.ds__day
              , DATE_TRUNC('month', nr_subq_8.ds__day__lead) AS booking__ds__month
            ...
            FROM (
              ...
              SELECT
                ...
                , CASE
                  WHEN nr_subq_7.ds__martian_day__first_value__lead + MAKE_INTERVAL(days => CAST ((cte_2.ds__day__row_number - 1) AS INTEGER)) <= nr_subq_7.ds__martian_day__last_value__lead
                    THEN nr_subq_7.ds__martian_day__first_value__lead + MAKE_INTERVAL(days => CAST ((cte_2.ds__day__row_number - 1) AS INTEGER))
                  ELSE NULL
