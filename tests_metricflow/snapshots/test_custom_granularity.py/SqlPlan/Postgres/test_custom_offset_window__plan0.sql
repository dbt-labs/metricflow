          ...
          FROM (
            ...
            FROM (
              ...
              SELECT
                ...
                , CASE
                  WHEN subq_8.ds__martian_day__first_value__offset + MAKE_INTERVAL(days => CAST ((subq_3.ds__day__row_number - 1) AS INTEGER)) <= subq_8.ds__martian_day__last_value__offset
                    THEN subq_8.ds__martian_day__first_value__offset + MAKE_INTERVAL(days => CAST ((subq_3.ds__day__row_number - 1) AS INTEGER))
