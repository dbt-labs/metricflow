          ...
          FROM (
            ...
            INNER JOIN (
              ...
              FROM (
                ...
                SELECT
                  ...
                  , DATE_TRUNC('milliseconds', users_ds_source_src_28000.last_profile_edit_ts) AS last_profile_edit_ts__millisecond
                  ...
                  , DATE_TRUNC('milliseconds', users_ds_source_src_28000.last_profile_edit_ts) AS user__last_profile_edit_ts__millisecond
            ...
            ON
              (
                ...
                subq_1.metric_time__hour > TIMESTAMPADD(hour, -3, subq_2.metric_time__hour)
              )
            LEFT OUTER JOIN
