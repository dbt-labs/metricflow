                ...
                FROM (
                  ...
                  FROM (
                    ...
                    SELECT
                      ...
                      , CASE
                        WHEN TIMESTAMPADD(day, (cte_2.ds__day__row_number - 1), subq_8.ds__alien_day__first_value__lead) <= subq_8.ds__alien_day__last_value__lead
                          THEN TIMESTAMPADD(day, (cte_2.ds__day__row_number - 1), subq_8.ds__alien_day__first_value__lead)
                        ELSE NULL
