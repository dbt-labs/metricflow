...
SELECT
  CAST(MAX(subq_35.__buys) AS DOUBLE PRECISION) / CAST(NULLIF(MAX(subq_24.__visits), 0) AS DOUBLE PRECISION) AS visit_buy_conversion_rate_7days
FROM (
