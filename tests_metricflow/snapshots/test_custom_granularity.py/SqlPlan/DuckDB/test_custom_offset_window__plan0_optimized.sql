...
FROM (
  ...
  FROM (
    ...
    SELECT
      ...
      , CASE
        WHEN subq_24.ds__day__first_value__lead + INTERVAL (cte_6.ds__day__row_number - 1) day <= subq_24.ds__day__last_value__lead
          THEN subq_24.ds__day__first_value__lead + INTERVAL (cte_6.ds__day__row_number - 1) day
        ELSE NULL
