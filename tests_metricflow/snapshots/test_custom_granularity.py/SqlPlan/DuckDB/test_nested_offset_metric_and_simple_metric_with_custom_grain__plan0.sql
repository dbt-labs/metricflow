...
-- Write to DataTable
SELECT
  subq_26.metric_time__alien_day
  , subq_26.bookings_offset_twice
  , subq_26.bookings
FROM (
  -- Combine Aggregated Outputs
  SELECT
    COALESCE(subq_19.metric_time__alien_day, subq_25.metric_time__alien_day) AS metric_time__alien_day
    , MAX(subq_19.bookings_offset_twice) AS bookings_offset_twice
  ...
  FROM (
    ...
    FROM (
      ...
      FROM (
          ...
          FROM (
            ...
            FROM (
              ...
              SELECT
                ...
                , subq_13.ds__alien_day AS metric_time__alien_day
              FROM (
        ...
        INNER JOIN (
          ...
          FROM (
            ...
            FROM (
              ...
              FROM (
                -- Select: ['metric_time__alien_day', 'metric_time__day']
                SELECT
        ...
        ON
          subq_16.metric_time__alien_day - INTERVAL 2 day = subq_12.metric_time__alien_day
      ) subq_17
    ) subq_18
  ) subq_19
  FULL OUTER JOIN (
    -- Compute Metrics via Expressions
    SELECT
      subq_24.metric_time__alien_day
      , subq_24.__bookings AS bookings
    FROM (
      -- Aggregate Inputs for Simple Metrics
      SELECT
        subq_23.metric_time__alien_day
  ...
  ON
    subq_19.metric_time__alien_day = subq_25.metric_time__alien_day
  GROUP BY
    COALESCE(subq_19.metric_time__alien_day, subq_25.metric_time__alien_day)
) subq_26
