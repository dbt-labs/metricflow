          ...
          FROM (
            ...
            FROM (
              ...
              SELECT
                ...
                , CASE
                  WHEN nr_subq_7.ds__martian_day__first_value__lead + INTERVAL (cte_2.ds__day__row_number - 1) day <= nr_subq_7.ds__martian_day__last_value__lead
                    THEN nr_subq_7.ds__martian_day__first_value__lead + INTERVAL (cte_2.ds__day__row_number - 1) day
                  ELSE NULL
