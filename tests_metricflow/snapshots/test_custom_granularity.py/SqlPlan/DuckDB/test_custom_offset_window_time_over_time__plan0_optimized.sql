  ...
  FROM (
    ...
    FROM (
      ...
      SELECT
        ...
        , CASE
          WHEN subq_29.ds__martian_day__first_value__lead + INTERVAL (cte_7.ds__day__row_number - 1) day <= subq_29.ds__martian_day__last_value__lead
            THEN subq_29.ds__martian_day__first_value__lead + INTERVAL (cte_7.ds__day__row_number - 1) day
          ELSE NULL
