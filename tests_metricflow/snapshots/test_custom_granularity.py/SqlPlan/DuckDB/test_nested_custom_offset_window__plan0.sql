...
FROM (
  ...
  SELECT
    ...
    , subq_20.bookings_offset_one_martian_day AS bookings_offset_one_martian_day
  FROM (
    ...
    FROM (
      ...
      FROM (
        ...
        WITH cte_6 AS (
          ...
          SELECT
            subq_21.ds__day
            , subq_21.ds__martian_day
            , FIRST_VALUE(subq_21.ds__day) OVER (
              PARTITION BY subq_21.ds__martian_day
              ORDER BY subq_21.ds__day
              ROWS BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING
            ) AS ds__day__first_value
            , LAST_VALUE(subq_21.ds__day) OVER (
              PARTITION BY subq_21.ds__martian_day
              ORDER BY subq_21.ds__day
              ROWS BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING
        ...
        SELECT
          ...
          , CASE
            WHEN subq_23.ds__day__first_value__lead + INTERVAL (cte_6.ds__day__row_number - 1) day <= subq_23.ds__day__last_value__lead
              THEN subq_23.ds__day__first_value__lead + INTERVAL (cte_6.ds__day__row_number - 1) day
            ELSE NULL
        ...
        INNER JOIN (
          ...
          SELECT
            subq_22.ds__martian_day
            , LEAD(subq_22.ds__day__first_value, 2) OVER (ORDER BY subq_22.ds__martian_day) AS ds__day__first_value__lead
            , LEAD(subq_22.ds__day__last_value, 2) OVER (ORDER BY subq_22.ds__martian_day) AS ds__day__last_value__lead
          FROM (
            -- Get Unique Rows for Custom Granularity Bounds
            SELECT
              cte_6.ds__martian_day
              , cte_6.ds__day__first_value
              , cte_6.ds__day__last_value
            FROM cte_6 cte_6
            GROUP BY
              cte_6.ds__martian_day
              , cte_6.ds__day__first_value
        ...
        ON
          cte_6.ds__martian_day = subq_23.ds__martian_day
      ) subq_24
    ) subq_25
  ) subq_26
  INNER JOIN (
              ...
              FROM (
                ...
                FROM (
                  ...
                  SELECT
                    ...
                    , CASE
                      WHEN subq_12.ds__day__first_value__lead + INTERVAL (cte_4.ds__day__row_number - 1) day <= subq_12.ds__day__last_value__lead
                        THEN subq_12.ds__day__first_value__lead + INTERVAL (cte_4.ds__day__row_number - 1) day
                      ELSE NULL
                    END AS ds__day__lead
                  FROM cte_4 cte_4
                  INNER JOIN (
                    ...
                    SELECT
                      ...
                      , LEAD(subq_11.ds__day__first_value, 1) OVER (ORDER BY subq_11.ds__martian_day) AS ds__day__first_value__lead
                      , LEAD(subq_11.ds__day__last_value, 1) OVER (ORDER BY subq_11.ds__martian_day) AS ds__day__last_value__lead
                    FROM (
                      -- Get Unique Rows for Custom Granularity Bounds
                      SELECT
                        cte_4.ds__martian_day
                        , cte_4.ds__day__first_value
                        , cte_4.ds__day__last_value
                      FROM cte_4 cte_4
                      GROUP BY
                        cte_4.ds__martian_day
                        , cte_4.ds__day__first_value
  ...
  ON
    subq_26.ds__day = subq_20.metric_time__day
) subq_27
