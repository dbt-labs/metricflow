    ...
    FROM (
      ...
      FROM (
        ...
        SELECT
          ...
          , CASE
            WHEN subq_23.ds__martian_day__first_value__lead + INTERVAL (cte_6.ds__day__row_number - 1) day <= subq_23.ds__martian_day__last_value__lead
              THEN subq_23.ds__martian_day__first_value__lead + INTERVAL (cte_6.ds__day__row_number - 1) day
            ELSE NULL
        ...
        INNER JOIN (
          ...
          SELECT
            ...
            , LEAD(subq_22.ds__martian_day__first_value, 2) OVER (ORDER BY subq_22.ds__martian_day) AS ds__martian_day__first_value__lead
            , LEAD(subq_22.ds__martian_day__last_value, 2) OVER (ORDER BY subq_22.ds__martian_day) AS ds__martian_day__last_value__lead
          FROM (
