...
FROM (
  ...
  SELECT
    ...
    , subq_0.ds__fiscal_quarter AS ds__fiscal_quarter
    , subq_0.ds__fiscal_year AS ds__fiscal_year
    ...
    , subq_0.ds__fiscal_quarter AS metric_time__fiscal_quarter
    , subq_0.ds__fiscal_year AS metric_time__fiscal_year
