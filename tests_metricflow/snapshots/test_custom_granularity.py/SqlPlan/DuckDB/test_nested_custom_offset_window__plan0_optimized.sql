...
FROM (
  ...
  FROM (
    ...
    SELECT
      ...
      , CASE
        WHEN subq_51.ds__martian_day__first_value__lead + INTERVAL (cte_15.ds__day__row_number - 1) day <= subq_51.ds__martian_day__last_value__lead
          THEN subq_51.ds__martian_day__first_value__lead + INTERVAL (cte_15.ds__day__row_number - 1) day
        ELSE NULL
    ...
    FROM (
      ...
      FROM (
        ...
        SELECT
          ...
          , CASE
            WHEN subq_40.ds__martian_day__first_value__lead + INTERVAL (cte_13.ds__day__row_number - 1) day <= subq_40.ds__martian_day__last_value__lead
              THEN subq_40.ds__martian_day__first_value__lead + INTERVAL (cte_13.ds__day__row_number - 1) day
            ELSE NULL
          END AS ds__day__lead
        FROM cte_13 cte_13
        INNER JOIN (
