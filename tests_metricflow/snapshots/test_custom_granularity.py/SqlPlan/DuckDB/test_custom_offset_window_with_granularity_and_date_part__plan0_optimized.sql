...
FROM (
  ...
  FROM (
    ...
    SELECT
      ...
      , CASE
        WHEN subq_17.ds__martian_day__first_value__offset + INTERVAL (cte_6.ds__day__row_number - 1) day <= subq_17.ds__martian_day__last_value__offset
          THEN subq_17.ds__martian_day__first_value__offset + INTERVAL (cte_6.ds__day__row_number - 1) day
        ELSE NULL
