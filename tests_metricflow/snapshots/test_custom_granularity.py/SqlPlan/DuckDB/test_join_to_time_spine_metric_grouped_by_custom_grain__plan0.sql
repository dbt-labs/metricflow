...
SELECT
  ...
  , nr_subq_7.bookings AS bookings_join_to_time_spine
FROM (
  -- Join to Time Spine Dataset
  SELECT
    nr_subq_6.metric_time__martian_day AS metric_time__martian_day
  ...
  FROM (
    ...
    FROM (
      ...
      SELECT
        ...
        , nr_subq_4.ds__martian_day AS metric_time__martian_day
      FROM (
  ...
  ON
    nr_subq_6.metric_time__martian_day = nr_subq_3.metric_time__martian_day
) nr_subq_7
