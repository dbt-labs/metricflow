...
FROM (
  ...
  SELECT
    ...
    , CAST(subq_18.__buys AS DOUBLE) / CAST(NULLIF(subq_18.__visits, 0) AS DOUBLE) AS visit_buy_conversion_rate_7days
  FROM (
              ...
              ON
                (
                  ...
                  (
                    ...
                    subq_9.metric_time__day > DATE_SUB(subq_12.metric_time__day, INTERVAL 7 DAY)
                  )
                )
            ) subq_13
          ) subq_14
