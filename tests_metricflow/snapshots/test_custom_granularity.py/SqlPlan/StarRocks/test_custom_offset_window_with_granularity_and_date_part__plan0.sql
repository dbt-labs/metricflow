...
SELECT
  ...
  , subq_19.bookings_offset_one_alien_day
FROM (
      ...
      FROM (
        ...
        FROM (
          ...
          FROM (
            ...
            SELECT
              subq_12.booking__ds__month AS booking__ds__month
                ...
                FROM (
                  ...
                  FROM (
                    ...
                    SELECT
                      ...
                      , CASE
                        WHEN DATE_ADD(subq_8.ds__alien_day__first_value__lead, INTERVAL (cte_2.ds__day__row_number - 1) DAY) <= subq_8.ds__alien_day__last_value__lead
                          THEN DATE_ADD(subq_8.ds__alien_day__first_value__lead, INTERVAL (cte_2.ds__day__row_number - 1) DAY)
                        ELSE NULL
