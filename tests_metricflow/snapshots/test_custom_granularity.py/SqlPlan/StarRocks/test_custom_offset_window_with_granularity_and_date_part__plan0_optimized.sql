...
FROM (
  ...
  FROM (
    ...
    SELECT
      ...
      , CASE
        WHEN DATE_ADD(subq_28.ds__alien_day__first_value__lead, INTERVAL (cte_6.ds__day__row_number - 1) DAY) <= subq_28.ds__alien_day__last_value__lead
          THEN DATE_ADD(subq_28.ds__alien_day__first_value__lead, INTERVAL (cte_6.ds__day__row_number - 1) DAY)
        ELSE NULL
