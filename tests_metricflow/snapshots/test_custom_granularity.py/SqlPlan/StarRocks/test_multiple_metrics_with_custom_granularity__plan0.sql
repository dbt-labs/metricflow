...
FROM (
  ...
  SELECT
    COALESCE(subq_6.metric_time__alien_day, subq_13.metric_time__alien_day) AS metric_time__alien_day
  ...
  ON
    subq_6.metric_time__alien_day = subq_13.metric_time__alien_day
  GROUP BY
    COALESCE(subq_6.metric_time__alien_day, subq_13.metric_time__alien_day)
) subq_14
