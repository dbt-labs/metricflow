  ...
  CROSS JOIN (
    ...
    FROM (
      ...
      SELECT
        ...
        , subq_3.ds__alien_day
        , subq_3.ds__fiscal_quarter
        , subq_3.ds__fiscal_year
        ...
        , subq_3.ds__alien_day AS metric_time__alien_day
        , subq_3.ds__fiscal_quarter AS metric_time__fiscal_quarter
        , subq_3.ds__fiscal_year AS metric_time__fiscal_year
      FROM (
