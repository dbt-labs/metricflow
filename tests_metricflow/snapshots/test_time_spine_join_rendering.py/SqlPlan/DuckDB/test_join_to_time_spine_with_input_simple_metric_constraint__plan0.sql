...
SELECT
  ...
  , subq_10.instant_bookings_with_measure_filter
FROM (
  -- Compute Metrics via Expressions
  SELECT
    subq_9.metric_time__day
    , subq_9.booking__is_instant
    , subq_9.__instant_bookings_with_measure_filter AS instant_bookings_with_measure_filter
  FROM (
    ...
    LEFT OUTER JOIN (
      ...
      SELECT
        ...
        , SUM(subq_3.__instant_bookings_with_measure_filter) AS __instant_bookings_with_measure_filter
      FROM (
