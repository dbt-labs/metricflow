...
FROM (
  ...
  SELECT
    ...
    , nr_subq_13.bookings AS bookings
  FROM (
  ...
  ON
    nr_subq_17.metric_time__day = nr_subq_13.metric_time__day
  WHERE nr_subq_17.metric_time__day BETWEEN timestamp '2020-01-03' AND timestamp '2020-01-05'
) nr_subq_19
