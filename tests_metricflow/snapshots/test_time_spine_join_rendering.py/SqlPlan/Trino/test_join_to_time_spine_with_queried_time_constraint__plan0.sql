  ...
  FROM (
    ...
    FROM (
      ...
      FROM (
        ...
        WHERE nr_subq_6.metric_time__day BETWEEN timestamp '2020-01-03' AND timestamp '2020-01-05'
      ) nr_subq_7
    ) nr_subq_8
    LEFT OUTER JOIN (
      -- Aggregate Measures
      ...
      FROM (
        ...
        FROM (
          ...
          WHERE nr_subq_1.metric_time__day BETWEEN timestamp '2020-01-03' AND timestamp '2020-01-05'
        ) nr_subq_2
      ) nr_subq_3
      GROUP BY
        nr_subq_3.metric_time__day
    ...
    ON
      nr_subq_8.metric_time__day = nr_subq_4.metric_time__day
  ) nr_subq_9
  WHERE nr_subq_9.metric_time__day BETWEEN timestamp '2020-01-03' AND timestamp '2020-01-05'
) nr_subq_10
