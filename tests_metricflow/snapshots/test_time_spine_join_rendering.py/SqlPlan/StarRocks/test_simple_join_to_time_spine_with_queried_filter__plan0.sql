...
FROM (
  ...
  SELECT
    ...
    , COALESCE(subq_11.__bookings_fill_nulls_with_0, 0) AS bookings_fill_nulls_with_0
  FROM (
    ...
    FROM (
      ...
      LEFT OUTER JOIN (
        ...
        SELECT
          ...
          , SUM(subq_4.__bookings_fill_nulls_with_0) AS __bookings_fill_nulls_with_0
        FROM (
          ...
          FROM (
            -- Constrain Output with WHERE
            SELECT
              subq_2.bookings_fill_nulls_with_0 AS __bookings_fill_nulls_with_0
