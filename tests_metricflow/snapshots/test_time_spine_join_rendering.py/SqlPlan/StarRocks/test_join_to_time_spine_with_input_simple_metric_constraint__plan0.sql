...
FROM (
  ...
  SELECT
    ...
    , subq_11.__instant_bookings_with_measure_filter AS instant_bookings_with_measure_filter
  FROM (
    ...
    LEFT OUTER JOIN (
      ...
      FROM (
        ...
        FROM (
          -- Constrain Output with WHERE
          SELECT
            subq_2.instant_bookings_with_measure_filter AS __instant_bookings_with_measure_filter
