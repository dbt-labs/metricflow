...
SELECT
  ...
  , subq_12.archived_users_join_to_time_spine
FROM (
  -- Compute Metrics via Expressions
  SELECT
    subq_11.metric_time__day
    , subq_11.__archived_users_join_to_time_spine AS archived_users_join_to_time_spine
  FROM (
          ...
          FROM (
            ...
            FROM (
              ...
              SELECT
                ...
                , TIMESTAMP_TRUNC(time_spine_src_28005.ts, day) AS ts__day
                , TIMESTAMP_TRUNC(time_spine_src_28005.ts, isoweek) AS ts__week
                , TIMESTAMP_TRUNC(time_spine_src_28005.ts, month) AS ts__month
                , TIMESTAMP_TRUNC(time_spine_src_28005.ts, quarter) AS ts__quarter
                , TIMESTAMP_TRUNC(time_spine_src_28005.ts, year) AS ts__year
    ...
    LEFT OUTER JOIN (
      ...
      FROM (
        ...
        FROM (
          -- Constrain Output with WHERE
          SELECT
            subq_2.archived_users_join_to_time_spine AS __archived_users_join_to_time_spine
          ...
          FROM (
            ...
            SELECT
              ...
              , subq_1.__archived_users_join_to_time_spine AS archived_users_join_to_time_spine
            FROM (
