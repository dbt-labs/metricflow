...
SELECT
  ...
  , subq_17.bookings_fill_nulls_with_0
FROM (
  -- Compute Metrics via Expressions
  SELECT
    subq_16.metric_time__day
    , COALESCE(subq_16.__bookings_fill_nulls_with_0, 0) AS bookings_fill_nulls_with_0
  FROM (
    -- Constrain Time Range to [2020-01-03T00:00:00, 2020-01-05T00:00:00]
    SELECT
      subq_15.metric_time__day
      , subq_15.__bookings_fill_nulls_with_0
    FROM (
      ...
      ON
        subq_14.metric_time__day = subq_8.metric_time__day
    ) subq_15
    WHERE subq_15.metric_time__day BETWEEN '2020-01-03' AND '2020-01-05'
  ) subq_16
) subq_17
