...
FROM (
  ...
  SELECT
    ...
    , subq_11.__bookings_join_to_time_spine_with_tiered_filters AS bookings_join_to_time_spine_with_tiered_filters
  FROM (
        ...
        FROM (
          ...
          FROM (
            ...
            SELECT
              ...
              , subq_6.ds__week
              , subq_6.ds__month AS booking__ds__month
              , subq_6.ds__quarter
              , subq_6.ds__year
    ...
    LEFT OUTER JOIN (
      ...
      FROM (
        ...
        FROM (
          -- Constrain Output with WHERE
          SELECT
            subq_2.bookings_join_to_time_spine_with_tiered_filters AS __bookings_join_to_time_spine_with_tiered_filters
    ...
    ON
      subq_10.booking__ds__day = subq_5.booking__ds__day
  ) subq_11
) subq_12
