...
FROM (
  ...
  SELECT
    ...
    , subq_9.__archived_users_join_to_time_spine AS archived_users_join_to_time_spine
  FROM (
    -- Join to Time Spine Dataset
    SELECT
      subq_8.metric_time__day AS metric_time__day
      , subq_4.__archived_users_join_to_time_spine AS __archived_users_join_to_time_spine
    FROM (
    ...
    LEFT OUTER JOIN (
      ...
      SELECT
        ...
        , SUM(subq_3.__archived_users_join_to_time_spine) AS __archived_users_join_to_time_spine
      FROM (
