...
SELECT
  ...
  , subq_10.bookings_join_to_time_spine_with_tiered_filters
FROM (
  -- Compute Metrics via Expressions
  SELECT
    subq_9.metric_time__day
    , subq_9.__bookings_join_to_time_spine_with_tiered_filters AS bookings_join_to_time_spine_with_tiered_filters
  FROM (
    ...
    LEFT OUTER JOIN (
      ...
      SELECT
        ...
        , SUM(subq_3.__bookings_join_to_time_spine_with_tiered_filters) AS __bookings_join_to_time_spine_with_tiered_filters
      FROM (
