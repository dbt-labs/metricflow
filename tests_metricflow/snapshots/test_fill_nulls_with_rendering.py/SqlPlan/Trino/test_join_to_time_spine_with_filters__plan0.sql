...
FROM (
  ...
  SELECT
    ...
    , COALESCE(subq_13.bookings_fill_nulls_with_0, 0) AS bookings_fill_nulls_with_0
  FROM (
    ...
    FROM (
      ...
      SELECT
        ...
        , subq_6.bookings_fill_nulls_with_0 AS bookings_fill_nulls_with_0
      FROM (
      ...
      LEFT OUTER JOIN (
        ...
        SELECT
          ...
          , SUM(subq_5.bookings_fill_nulls_with_0) AS bookings_fill_nulls_with_0
        FROM (
