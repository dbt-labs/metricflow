...
FROM (
  ...
  FROM (
    ...
    FROM (
      ...
      FROM (
        ...
        WHERE nr_subq_8.metric_time__day BETWEEN timestamp '2020-01-03' AND timestamp '2020-01-05'
      ) nr_subq_9
    ) nr_subq_10
    LEFT OUTER JOIN (
      -- Aggregate Measures
  ...
  WHERE nr_subq_11.metric_time__day BETWEEN timestamp '2020-01-03' AND timestamp '2020-01-05'
) nr_subq_12
