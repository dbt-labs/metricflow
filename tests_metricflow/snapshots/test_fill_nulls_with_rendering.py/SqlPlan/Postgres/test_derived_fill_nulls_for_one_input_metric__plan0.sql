  ...
  FROM (
    ...
    FROM (
      ...
      SELECT
        ...
        , COALESCE(subq_7.bookings_fill_nulls_with_0, 0) AS bookings_fill_nulls_with_0
      FROM (
        -- Join to Time Spine Dataset
        SELECT
          subq_6.metric_time__day AS metric_time__day
          , subq_3.bookings_fill_nulls_with_0 AS bookings_fill_nulls_with_0
        FROM (
        ...
        LEFT OUTER JOIN (
          ...
          SELECT
            ...
            , SUM(subq_2.bookings_fill_nulls_with_0) AS bookings_fill_nulls_with_0
          FROM (
