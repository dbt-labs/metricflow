...
SELECT
  ...
  , subq_18.bookings_growth_2_weeks_fill_nulls_with_0_for_non_offset
FROM (
  ...
  FROM (
    ...
    FROM (
      ...
      SELECT
        ...
        , COALESCE(subq_7.__bookings_fill_nulls_with_0, 0) AS bookings_fill_nulls_with_0
      FROM (
        -- Join to Time Spine Dataset
        SELECT
          subq_6.metric_time__day AS metric_time__day
          , subq_3.__bookings_fill_nulls_with_0 AS __bookings_fill_nulls_with_0
        FROM (
        ...
        LEFT OUTER JOIN (
          ...
          SELECT
            ...
            , SUM(subq_2.__bookings_fill_nulls_with_0) AS __bookings_fill_nulls_with_0
          FROM (
    ...
    FULL OUTER JOIN (
      ...
      SELECT
        ...
        , subq_15.__bookings AS bookings_2_weeks_ago
      FROM (
        -- Join to Time Spine Dataset
        SELECT
        ...
        ON
          subq_14.metric_time__day - MAKE_INTERVAL(days => 14) = subq_11.metric_time__day
      ) subq_15
    ) subq_16
    ON
