...
FROM (
  ...
  SELECT
    ...
    , subq_9.bookings_join_to_time_spine_with_tiered_filters
  FROM (
    ...
    LEFT OUTER JOIN (
      ...
      SELECT
        ...
        , SUM(subq_3.bookings_join_to_time_spine_with_tiered_filters) AS bookings_join_to_time_spine_with_tiered_filters
      FROM (
