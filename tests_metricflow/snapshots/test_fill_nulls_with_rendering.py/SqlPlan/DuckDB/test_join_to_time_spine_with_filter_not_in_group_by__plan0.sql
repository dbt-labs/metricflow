...
FROM (
  ...
  SELECT
    ...
    , subq_4.bookings AS bookings_join_to_time_spine_with_tiered_filters
  FROM (
    -- Aggregate Measures
    SELECT
    ...
    FROM (
      ...
      FROM (
        ...
        WHERE ((((metric_time__day >= '2020-01-02') AND (metric_time__day <= '2020-01-02')) AND (metric_time__day >= '2020-01-02')) AND (metric_time__day <= '2020-01-02')) AND (metric_time__month > '2020-01-01')
      ) subq_2
    ) subq_3
    GROUP BY
      subq_3.metric_time__day
