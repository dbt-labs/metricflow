...
SELECT
  ...
  , subq_16.bookings_fill_nulls_with_0
FROM (
  -- Compute Metrics via Expressions
  SELECT
    subq_15.metric_time__day
    , COALESCE(subq_15.__bookings_fill_nulls_with_0, 0) AS bookings_fill_nulls_with_0
  FROM (
    -- Constrain Time Range to [2020-01-03T00:00:00, 2020-01-05T00:00:00]
    SELECT
      subq_14.metric_time__day
      , subq_14.__bookings_fill_nulls_with_0
    FROM (
          ...
          FROM (
            ...
            FROM (
              ...
              SELECT
                ...
                , subq_3.__bookings_fill_nulls_with_0 AS bookings_fill_nulls_with_0
              FROM (
                -- Constrain Time Range to [2020-01-03T00:00:00, 2020-01-05T00:00:00]
                SELECT
                  subq_2.ds__day
      ...
      ON
        subq_13.metric_time__day = subq_7.metric_time__day
    ) subq_14
