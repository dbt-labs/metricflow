  ...
  FROM (
    ...
    FROM (
      ...
      FROM (
        ...
        WHERE ((((metric_time__day >= '2020-01-02') AND (metric_time__day <= '2020-01-02')) AND (metric_time__day >= '2020-01-02')) AND (metric_time__day <= '2020-01-02')) AND (booking__ds__month > '2020-01-01')
      ) subq_2
    ) subq_3
    GROUP BY
      subq_3.metric_time__day
