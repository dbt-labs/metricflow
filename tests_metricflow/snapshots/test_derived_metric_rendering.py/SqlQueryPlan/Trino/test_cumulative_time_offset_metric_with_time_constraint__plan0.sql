      ...
      FROM (
        ...
        FROM (
          ...
          SELECT
            ...
            , EXTRACT(DAY_OF_WEEK FROM subq_5.metric_time__day) AS metric_time__extract_dow
        ...
        WHERE subq_7.metric_time__day BETWEEN timestamp '2019-12-19' AND timestamp '2020-01-02'
      ) subq_8
    ) subq_9
    GROUP BY
      subq_9.metric_time__day
