...
SELECT
  COALESCE(nr_subq_5.metric_time__day, nr_subq_9.metric_time__day) AS metric_time__day
  , MAX(nr_subq_5.nested_fill_nulls_without_time_spine) AS nested_fill_nulls_without_time_spine
...
ON
  nr_subq_5.metric_time__day = nr_subq_9.metric_time__day
GROUP BY
  COALESCE(nr_subq_5.metric_time__day, nr_subq_9.metric_time__day)
