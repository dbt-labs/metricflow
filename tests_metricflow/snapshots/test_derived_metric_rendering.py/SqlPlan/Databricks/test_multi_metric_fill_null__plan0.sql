...
SELECT
  ...
  , MAX(nr_subq_4.twice_bookings_fill_nulls_with_0_without_time_spine) AS twice_bookings_fill_nulls_with_0_without_time_spine
  , MAX(nr_subq_8.listings) AS listings
FROM (
...
FULL OUTER JOIN (
  ...
  FROM (
    ...
    SELECT
      ...
      , SUM(nr_subq_6.listings) AS listings
    FROM (
