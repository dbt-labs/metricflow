...
SELECT
  ...
  , subq_14.bookings_growth_since_start_of_month
FROM (
  ...
  FROM (
    ...
    FULL OUTER JOIN (
      ...
      SELECT
        ...
        , subq_11.__bookings AS bookings_at_start_of_month
      FROM (
        ...
        ON
          DATETIME_TRUNC(subq_10.booking__ds__day, month) = subq_7.booking__ds__day
      ) subq_11
    ) subq_12
    ON
