  ...
  FROM (
    ...
    FROM (
      ...
      SELECT
        ...
        , subq_7.__bookings AS month_start_bookings
      FROM (
    ...
    FULL OUTER JOIN (
      ...
      SELECT
        ...
        , subq_15.__bookings AS bookings_1_month_ago
      FROM (
        -- Aggregate Inputs for Simple Metrics
        SELECT
        ...
        FROM (
          ...
          FROM (
            ...
            SELECT
              ...
              , subq_9.__average_booking_value AS __average_booking_value
              , subq_9.__instant_bookings AS __instant_bookings
              , subq_9.__booking_value AS __booking_value
              , subq_9.__max_booking_value AS __max_booking_value
              , subq_9.__min_booking_value AS __min_booking_value
              , subq_9.__instant_booking_value AS __instant_booking_value
              , subq_9.__average_instant_booking_value AS __average_instant_booking_value
              , subq_9.__booking_value_for_non_null_listing_id AS __booking_value_for_non_null_listing_id
              , subq_9.__bookers AS __bookers
              , subq_9.__referred_bookings AS __referred_bookings
              , subq_9.__median_booking_value AS __median_booking_value
              , subq_9.__booking_value_p99 AS __booking_value_p99
              , subq_9.__discrete_booking_value_p99 AS __discrete_booking_value_p99
              , subq_9.__approximate_continuous_booking_value_p99 AS __approximate_continuous_booking_value_p99
              , subq_9.__approximate_discrete_booking_value_p99 AS __approximate_discrete_booking_value_p99
              , subq_9.__bookings_join_to_time_spine AS __bookings_join_to_time_spine
              , subq_9.__bookings_fill_nulls_with_0_without_time_spine AS __bookings_fill_nulls_with_0_without_time_spine
              , subq_9.__bookings_fill_nulls_with_0 AS __bookings_fill_nulls_with_0
              , subq_9.__instant_bookings_with_measure_filter AS __instant_bookings_with_measure_filter
              , subq_9.__bookings_join_to_time_spine_with_tiered_filters AS __bookings_join_to_time_spine_with_tiered_filters
              , subq_9.__bookers_fill_nulls_with_0_join_to_timespine AS __bookers_fill_nulls_with_0_join_to_timespine
            FROM (
              -- Pass Only Elements: ['metric_time__day', 'metric_time__year']
              SELECT
            ...
            ON
              DATE_SUB(CAST(subq_12.metric_time__day AS DATETIME), INTERVAL 1 month) = subq_9.metric_time__day
          ) subq_13
        ) subq_14
        GROUP BY
          metric_time__year
