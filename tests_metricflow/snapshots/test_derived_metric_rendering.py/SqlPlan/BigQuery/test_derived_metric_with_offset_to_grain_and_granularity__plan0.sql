...
FROM (
  ...
  SELECT
    COALESCE(nr_subq_3.metric_time__week, nr_subq_11.metric_time__week) AS metric_time__week
    ...
    FROM (
      ...
      FROM (
        ...
        FROM (
          ...
          FROM (
            ...
            FROM (
              ...
              SELECT
                ...
                , nr_subq_5.ds__week AS metric_time__week
                , nr_subq_5.ds__month
          ...
          ON
            DATETIME_TRUNC(nr_subq_7.metric_time__day, month) = nr_subq_4.metric_time__day
          WHERE nr_subq_7.metric_time__week = nr_subq_7.metric_time__day
        ) nr_subq_8
      ) nr_subq_9
      GROUP BY
        metric_time__week
  ...
  ON
    nr_subq_3.metric_time__week = nr_subq_11.metric_time__week
  GROUP BY
    metric_time__week
) nr_subq_12
