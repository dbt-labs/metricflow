...
SELECT
  ...
  , subq_14.booking_fees_last_week_per_booker_this_week
FROM (
  ...
  FROM (
    ...
    FROM (
      ...
      SELECT
        ...
        , subq_7.__booking_value AS booking_value
      FROM (
        -- Join to Time Spine Dataset
        SELECT
          subq_6.booking__ds__day AS booking__ds__day
          , subq_3.__booking_value AS __booking_value
        FROM (
          ...
          FROM (
            ...
            SELECT
              subq_4.ds__day AS booking__ds__day
              , subq_4.ds__week
              , subq_4.ds__month
              , subq_4.ds__quarter
              , subq_4.ds__year
        ...
        INNER JOIN (
          ...
          SELECT
            ...
            , SUM(subq_2.__booking_value) AS __booking_value
          FROM (
        ...
        ON
          DATE_SUB(CAST(subq_6.booking__ds__day AS DATETIME), INTERVAL 1 week) = subq_3.booking__ds__day
      ) subq_7
    ) subq_8
    FULL OUTER JOIN (
      -- Compute Metrics via Expressions
