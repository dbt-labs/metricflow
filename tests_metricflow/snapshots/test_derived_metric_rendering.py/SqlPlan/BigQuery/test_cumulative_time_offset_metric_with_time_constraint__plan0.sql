...
FROM (
  ...
  SELECT
    ...
    , nr_subq_10.bookers AS every_2_days_bookers_2_days_ago
  FROM (
    -- Aggregate Measures
    SELECT
      nr_subq_9.metric_time__day
      , COUNT(DISTINCT nr_subq_9.bookers) AS bookers
    FROM (
      ...
      FROM (
        ...
        SELECT
          ...
          , nr_subq_7.ds_partitioned__week
          , nr_subq_7.ds_partitioned__month
          , nr_subq_7.ds_partitioned__quarter
          , nr_subq_7.ds_partitioned__year
          , nr_subq_7.ds_partitioned__extract_year
          , nr_subq_7.ds_partitioned__extract_quarter
          , nr_subq_7.ds_partitioned__extract_month
          , nr_subq_7.ds_partitioned__extract_day
          , nr_subq_7.ds_partitioned__extract_dow
          , nr_subq_7.ds_partitioned__extract_doy
          , nr_subq_7.paid_at__day
          , nr_subq_7.paid_at__week
          , nr_subq_7.paid_at__month
          , nr_subq_7.paid_at__quarter
          , nr_subq_7.paid_at__year
          , nr_subq_7.paid_at__extract_year
          , nr_subq_7.paid_at__extract_quarter
          , nr_subq_7.paid_at__extract_month
          , nr_subq_7.paid_at__extract_day
          , nr_subq_7.paid_at__extract_dow
          , nr_subq_7.paid_at__extract_doy
          , nr_subq_7.booking__ds__day
          , nr_subq_7.booking__ds__week
          , nr_subq_7.booking__ds__month
          , nr_subq_7.booking__ds__quarter
          , nr_subq_7.booking__ds__year
          , nr_subq_7.booking__ds__extract_year
          , nr_subq_7.booking__ds__extract_quarter
          , nr_subq_7.booking__ds__extract_month
          , nr_subq_7.booking__ds__extract_day
          , nr_subq_7.booking__ds__extract_dow
          , nr_subq_7.booking__ds__extract_doy
          , nr_subq_7.booking__ds_partitioned__day
          , nr_subq_7.booking__ds_partitioned__week
          , nr_subq_7.booking__ds_partitioned__month
          , nr_subq_7.booking__ds_partitioned__quarter
          , nr_subq_7.booking__ds_partitioned__year
          , nr_subq_7.booking__ds_partitioned__extract_year
          , nr_subq_7.booking__ds_partitioned__extract_quarter
          , nr_subq_7.booking__ds_partitioned__extract_month
          , nr_subq_7.booking__ds_partitioned__extract_day
          , nr_subq_7.booking__ds_partitioned__extract_dow
          , nr_subq_7.booking__ds_partitioned__extract_doy
          , nr_subq_7.booking__paid_at__day
          , nr_subq_7.booking__paid_at__week
          , nr_subq_7.booking__paid_at__month
          , nr_subq_7.booking__paid_at__quarter
          , nr_subq_7.booking__paid_at__year
          , nr_subq_7.booking__paid_at__extract_year
          , nr_subq_7.booking__paid_at__extract_quarter
          , nr_subq_7.booking__paid_at__extract_month
          , nr_subq_7.booking__paid_at__extract_day
          , nr_subq_7.booking__paid_at__extract_dow
          , nr_subq_7.booking__paid_at__extract_doy
          ...
          , nr_subq_7.guest
          , nr_subq_7.host
          , nr_subq_7.booking__listing
          , nr_subq_7.booking__guest
          , nr_subq_7.booking__host
          , nr_subq_7.is_instant
          , nr_subq_7.booking__is_instant
          , nr_subq_7.bookings
          , nr_subq_7.instant_bookings
          , nr_subq_7.booking_value
          , nr_subq_7.max_booking_value
          , nr_subq_7.min_booking_value
          , nr_subq_7.bookers
          , nr_subq_7.average_booking_value
          , nr_subq_7.referred_bookings
          , nr_subq_7.median_booking_value
          , nr_subq_7.booking_value_p99
          , nr_subq_7.discrete_booking_value_p99
          , nr_subq_7.approximate_continuous_booking_value_p99
          , nr_subq_7.approximate_discrete_booking_value_p99
        FROM (
          ...
          ON
            DATE_SUB(CAST(nr_subq_6.metric_time__day AS DATETIME), INTERVAL 2 day) = nr_subq_3.metric_time__day
        ) nr_subq_7
        WHERE nr_subq_7.metric_time__day BETWEEN '2019-12-19' AND '2020-01-02'
      ) nr_subq_8
    ) nr_subq_9
    GROUP BY
      metric_time__day
