    ...
    FROM (
      ...
      FROM (
        ...
        FROM (
            ...
            FROM (
              ...
              FROM (
                ...
                SELECT
                  ...
                  , TIMESTAMP_TRUNC(time_spine_src_16006.ds, isoweek) AS ds__week
                  , TIMESTAMP_TRUNC(time_spine_src_16006.ds, month) AS ds__month
                  , TIMESTAMP_TRUNC(time_spine_src_16006.ds, quarter) AS ds__quarter
                  , TIMESTAMP_TRUNC(time_spine_src_16006.ds, year) AS ds__year
                  ...
                  , IF(EXTRACT(dayofweek FROM time_spine_src_16006.ds) = 1, 7, EXTRACT(dayofweek FROM time_spine_src_16006.ds) - 1) AS ds__extract_dow
                  , EXTRACT(dayofyear FROM time_spine_src_16006.ds) AS ds__extract_doy
          ...
          INNER JOIN (
            ...
            FROM (
              ...
              SELECT
                ...
                , TIMESTAMP_TRUNC(monthly_bookings_source_src_16000.ds, month) AS ds__month
                , TIMESTAMP_TRUNC(monthly_bookings_source_src_16000.ds, quarter) AS ds__quarter
                , TIMESTAMP_TRUNC(monthly_bookings_source_src_16000.ds, year) AS ds__year
                ...
                , TIMESTAMP_TRUNC(monthly_bookings_source_src_16000.ds, month) AS booking_monthly__ds__month
                , TIMESTAMP_TRUNC(monthly_bookings_source_src_16000.ds, quarter) AS booking_monthly__ds__quarter
                , TIMESTAMP_TRUNC(monthly_bookings_source_src_16000.ds, year) AS booking_monthly__ds__year
          ...
          ON
            DATE_SUB(CAST(subq_4.metric_time__month AS DATETIME), INTERVAL 1 month) = subq_1.metric_time__month
        ) subq_5
      ) subq_6
      GROUP BY
        metric_time__month
