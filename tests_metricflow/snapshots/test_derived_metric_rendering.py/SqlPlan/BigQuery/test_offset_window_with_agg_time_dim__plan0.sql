...
SELECT
  ...
  , subq_14.bookings_growth_2_weeks
FROM (
  ...
  FROM (
    ...
    FULL OUTER JOIN (
      ...
      SELECT
        ...
        , subq_11.__bookings AS bookings_2_weeks_ago
      FROM (
        ...
        FROM (
          ...
          FROM (
            ...
            SELECT
              subq_8.ds__day AS booking__ds__day
              , subq_8.ds__week
              , subq_8.ds__month
              , subq_8.ds__quarter
              , subq_8.ds__year
        ...
        ON
          DATE_SUB(CAST(subq_10.booking__ds__day AS DATETIME), INTERVAL 14 day) = subq_7.booking__ds__day
      ) subq_11
    ) subq_12
    ON
