  ...
  FROM (
        ...
        FROM (
          ...
          FROM (
            ...
            SELECT
              ...
              , subq_1.average_booking_value AS __average_booking_value
              , subq_1.instant_bookings AS __instant_bookings
              , subq_1.booking_value AS __booking_value
              , subq_1.max_booking_value AS __max_booking_value
              , subq_1.min_booking_value AS __min_booking_value
              , subq_1.instant_booking_value AS __instant_booking_value
              , subq_1.average_instant_booking_value AS __average_instant_booking_value
              , subq_1.booking_value_for_non_null_listing_id AS __booking_value_for_non_null_listing_id
              , subq_1.bookers AS __bookers
              , subq_1.referred_bookings AS __referred_bookings
              , subq_1.median_booking_value AS __median_booking_value
              , subq_1.booking_value_p99 AS __booking_value_p99
              , subq_1.discrete_booking_value_p99 AS __discrete_booking_value_p99
              , subq_1.approximate_continuous_booking_value_p99 AS __approximate_continuous_booking_value_p99
              , subq_1.approximate_discrete_booking_value_p99 AS __approximate_discrete_booking_value_p99
              , subq_1.bookings_join_to_time_spine AS __bookings_join_to_time_spine
              , subq_1.bookings_fill_nulls_with_0_without_time_spine AS __bookings_fill_nulls_with_0_without_time_spine
              , subq_1.bookings_fill_nulls_with_0 AS __bookings_fill_nulls_with_0
              , subq_1.instant_bookings_with_measure_filter AS __instant_bookings_with_measure_filter
              , subq_1.bookings_join_to_time_spine_with_tiered_filters AS __bookings_join_to_time_spine_with_tiered_filters
              , subq_1.bookers_fill_nulls_with_0_join_to_timespine AS __bookers_fill_nulls_with_0_join_to_timespine
              , subq_1.is_instant
    ...
    FULL OUTER JOIN (
      ...
      FROM (
          ...
          FROM (
            ...
            FROM (
              ...
              SELECT
                ...
                , subq_6.instant_bookings AS __instant_bookings
                , subq_6.booking_value AS __booking_value
                , subq_6.max_booking_value AS __max_booking_value
                , subq_6.min_booking_value AS __min_booking_value
                , subq_6.instant_booking_value AS __instant_booking_value
                , subq_6.average_instant_booking_value AS __average_instant_booking_value
                , subq_6.booking_value_for_non_null_listing_id AS __booking_value_for_non_null_listing_id
                , subq_6.bookers AS __bookers
                , subq_6.referred_bookings AS __referred_bookings
                , subq_6.median_booking_value AS __median_booking_value
                , subq_6.booking_value_p99 AS __booking_value_p99
                , subq_6.discrete_booking_value_p99 AS __discrete_booking_value_p99
                , subq_6.approximate_continuous_booking_value_p99 AS __approximate_continuous_booking_value_p99
                , subq_6.approximate_discrete_booking_value_p99 AS __approximate_discrete_booking_value_p99
                , subq_6.bookings_join_to_time_spine AS __bookings_join_to_time_spine
                , subq_6.bookings_fill_nulls_with_0_without_time_spine AS __bookings_fill_nulls_with_0_without_time_spine
                , subq_6.bookings_fill_nulls_with_0 AS __bookings_fill_nulls_with_0
                , subq_6.instant_bookings_with_measure_filter AS __instant_bookings_with_measure_filter
                , subq_6.bookings_join_to_time_spine_with_tiered_filters AS __bookings_join_to_time_spine_with_tiered_filters
                , subq_6.bookers_fill_nulls_with_0_join_to_timespine AS __bookers_fill_nulls_with_0_join_to_timespine
                , subq_6.is_instant
        ...
        ON
          DATE_SUB(CAST(subq_13.metric_time__day AS DATETIME), INTERVAL 14 day) = subq_9.metric_time__day
      ) subq_14
    ) subq_15
    ON
