      ...
      FROM (
        ...
        INNER JOIN (
          ...
          SELECT
            ...
            , SUM(subq_8.bookings) AS bookings_2_weeks_ago
          FROM (
            -- Pass Only Elements: ['bookings', 'metric_time__day']
            SELECT
            ...
            FROM (
              ...
              SELECT
                ...
                , subq_6.instant_booking_value
                , subq_6.average_instant_booking_value
                , subq_6.booking_value_for_non_null_listing_id
                , subq_6.bookers
                ...
                , subq_6.bookings_join_to_time_spine
                , subq_6.bookings_fill_nulls_with_0_without_time_spine
                , subq_6.bookings_fill_nulls_with_0
                , subq_6.instant_bookings_with_measure_filter
                , subq_6.bookings_join_to_time_spine_with_tiered_filters
                , subq_6.bookers_fill_nulls_with_0_join_to_timespine
              FROM (
                -- Metric Time Dimension 'ds'
                SELECT
                  subq_0.ds__day
