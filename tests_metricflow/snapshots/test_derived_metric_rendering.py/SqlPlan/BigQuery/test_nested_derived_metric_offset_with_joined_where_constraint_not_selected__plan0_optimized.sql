  ...
  FROM (
    ...
    INNER JOIN (
      ...
      FROM (
        ...
        ON
          DATE_SUB(CAST(time_spine_src_28006.ds AS DATETIME), INTERVAL 5 day) = nr_subq_15.metric_time__day
        GROUP BY
          metric_time__day
          , booking__is_instant
      ) nr_subq_22
    ...
    ON
      DATE_SUB(CAST(time_spine_src_28006.ds AS DATETIME), INTERVAL 2 day) = nr_subq_23.metric_time__day
  ) nr_subq_27
