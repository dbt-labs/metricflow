  ...
  FROM (
    ...
    INNER JOIN (
      ...
      FROM (
        ...
        ON
          DATE_SUB(CAST(rss_28018_cte.ds__day AS DATETIME), INTERVAL 5 day) = subq_20.metric_time__day
      ) subq_25
    ) subq_26
    ON
      DATE_SUB(CAST(rss_28018_cte.ds__day AS DATETIME), INTERVAL 2 day) = subq_26.metric_time__day
  ) subq_30
