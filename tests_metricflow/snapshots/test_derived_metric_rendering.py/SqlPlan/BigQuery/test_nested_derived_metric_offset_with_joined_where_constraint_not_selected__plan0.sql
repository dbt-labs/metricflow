        ...
        INNER JOIN (
          ...
          FROM (
            ...
            FROM (
              ...
              ON
                DATE_SUB(CAST(subq_6.metric_time__day AS DATETIME), INTERVAL 5 day) = subq_3.metric_time__day
            ) subq_7
          ) subq_8
        ) subq_9
        ON
          DATE_SUB(CAST(subq_12.metric_time__day AS DATETIME), INTERVAL 2 day) = subq_9.metric_time__day
      ) subq_13
