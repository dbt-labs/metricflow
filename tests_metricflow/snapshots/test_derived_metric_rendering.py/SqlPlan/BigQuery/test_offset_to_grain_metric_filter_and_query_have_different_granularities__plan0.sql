    ...
    FROM (
      ...
      FROM (
        ...
        FROM (
          ...
          ON
            DATETIME_TRUNC(nr_subq_3.metric_time__day, month) = nr_subq_0.metric_time__day
          WHERE nr_subq_3.metric_time__month = nr_subq_3.metric_time__day
        ) nr_subq_4
