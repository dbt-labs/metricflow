    ...
    FROM (
      ...
      FROM (
        ...
        FROM (
          ...
          ON
            DATE_ADD('day', -5, nr_subq_3.metric_time__day) = nr_subq_0.metric_time__day
        ) nr_subq_4
        WHERE nr_subq_4.metric_time__day BETWEEN timestamp '2019-12-19' AND timestamp '2020-01-02'
      ) nr_subq_5
    ) nr_subq_6
    GROUP BY
      nr_subq_6.metric_time__day
