      ...
      INNER JOIN (
        ...
        FROM (
          ...
          FROM (
            ...
            ON
              DATE_ADD('day', -5, subq_8.metric_time__day) = subq_4.metric_time__day
          ) subq_9
        ) subq_10
      ) subq_11
      ON
        DATE_ADD('day', -2, subq_15.metric_time__day) = subq_11.metric_time__day
    ) subq_16
    WHERE subq_16.metric_time__day BETWEEN timestamp '2020-01-12' AND timestamp '2020-01-13'
  ) subq_17
) subq_18
