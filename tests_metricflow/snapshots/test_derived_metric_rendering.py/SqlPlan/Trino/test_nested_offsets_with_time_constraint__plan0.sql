      ...
      INNER JOIN (
        ...
        FROM (
          ...
          FROM (
            ...
            ON
              DATE_ADD('day', -5, subq_6.metric_time__day) = subq_3.metric_time__day
          ) subq_7
        ) subq_8
      ) subq_9
      ON
        DATE_ADD('day', -2, subq_12.metric_time__day) = subq_9.metric_time__day
    ) subq_13
    WHERE subq_13.metric_time__day BETWEEN timestamp '2020-01-12' AND timestamp '2020-01-13'
  ) subq_14
) subq_15
