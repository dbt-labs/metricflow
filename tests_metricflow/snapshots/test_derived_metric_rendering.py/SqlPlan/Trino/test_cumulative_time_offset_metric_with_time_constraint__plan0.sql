    ...
    FROM (
      ...
      FROM (
        ...
        FROM (
          ...
          ON
            DATE_ADD('day', -2, nr_subq_6.metric_time__day) = nr_subq_3.metric_time__day
        ) nr_subq_7
        WHERE nr_subq_7.metric_time__day BETWEEN timestamp '2019-12-19' AND timestamp '2020-01-02'
      ) nr_subq_8
    ) nr_subq_9
    GROUP BY
      nr_subq_9.metric_time__day
