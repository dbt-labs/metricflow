        ...
        FROM (
          ...
          FROM (
            ...
            FROM (
              ...
              WHERE subq_15.metric_time__day BETWEEN timestamp '2019-12-19' AND timestamp '2020-01-02'
            ) subq_16
          ) subq_17
          INNER JOIN (
                  ...
                  FROM (
                    ...
                    ON
                      (
                        ...
                        subq_5.metric_time__day > DATE_ADD('day', -2, subq_6.metric_time__day)
                      )
                  ) subq_8
                ) subq_9
                WHERE subq_9.metric_time__day BETWEEN timestamp '2019-12-19' AND timestamp '2020-01-02'
              ) subq_10
            ) subq_11
            GROUP BY
              subq_11.metric_time__day
          ...
          ON
            DATE_ADD('day', -2, subq_17.metric_time__day) = subq_12.metric_time__day
        ) subq_18
        WHERE subq_18.metric_time__day BETWEEN timestamp '2019-12-19' AND timestamp '2020-01-02'
      ) subq_19
    ) subq_20
  ) subq_21
) subq_22
