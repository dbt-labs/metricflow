...
FROM (
  ...
  INNER JOIN (
    ...
    WHERE subq_20.ds BETWEEN timestamp '2019-12-19' AND timestamp '2020-01-02'
    GROUP BY
      subq_20.ds
  ) subq_24
  ON
    DATE_ADD('day', -2, subq_28.metric_time__day) = subq_24.metric_time__day
  WHERE subq_28.metric_time__day BETWEEN timestamp '2019-12-19' AND timestamp '2020-01-02'
) subq_32
