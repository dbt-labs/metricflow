  ...
  INNER JOIN (
    ...
    ON
      (
        ...
        DATE_TRUNC('day', bookings_source_src_28000.ds) > DATE_ADD('day', -2, subq_30.ds)
      )
    WHERE subq_30.ds BETWEEN timestamp '2019-12-19' AND timestamp '2020-01-02'
    GROUP BY
      subq_30.ds
  ) subq_35
  ON
    DATE_ADD('day', -2, subq_40.metric_time__day) = subq_35.metric_time__day
  WHERE subq_40.metric_time__day BETWEEN timestamp '2019-12-19' AND timestamp '2020-01-02'
) subq_44
