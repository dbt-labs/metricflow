...
FROM (
  ...
  INNER JOIN (
    ...
    WHERE subq_19.ds BETWEEN timestamp '2019-12-19' AND timestamp '2020-01-02'
    GROUP BY
      subq_19.ds
  ) subq_23
  ON
    DATE_ADD('day', -2, subq_27.metric_time__day) = subq_23.metric_time__day
  WHERE subq_27.metric_time__day BETWEEN timestamp '2019-12-19' AND timestamp '2020-01-02'
) subq_30
