    ...
    FROM (
      ...
      FROM (
        ...
        FROM (
                  ...
                  FROM (
                    ...
                    ON
                      (
                        ...
                        subq_5.metric_time__day > DATE_SUB(CAST(subq_6.metric_time__day AS DATETIME), INTERVAL 2 day)
                      )
                  ) subq_8
                ) subq_9
          ...
          ON
            DATE_SUB(CAST(subq_17.metric_time__day AS DATETIME), INTERVAL 2 day) = subq_12.metric_time__day
        ) subq_18
