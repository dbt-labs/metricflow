...
FROM (
  ...
  INNER JOIN (
    ...
    ON
      (
        ...
        DATE_TRUNC('day', bookings_source_src_28000.ds) > DATE_SUB(CAST(subq_30.ds AS DATETIME), INTERVAL 2 day)
      )
  ...
  ON
    DATE_SUB(CAST(subq_40.metric_time__day AS DATETIME), INTERVAL 2 day) = subq_35.metric_time__day
