...
SELECT
  ...
  , subq_17.instant_plus_non_referred_bookings_pct
FROM (
  ...
  FROM (
      ...
      FROM (
        ...
        FROM (
          ...
          SELECT
            ...
            , subq_3.__referred_bookings AS ref_bookings
          FROM (
            -- Aggregate Inputs for Simple Metrics
            SELECT
              subq_2.metric_time__day
              , SUM(subq_2.__referred_bookings) AS __referred_bookings
            FROM (
    ...
    FULL OUTER JOIN (
      ...
      SELECT
        ...
        , subq_13.__instant_bookings AS instant
      FROM (
        -- Aggregate Inputs for Simple Metrics
        SELECT
          subq_12.metric_time__day
          , SUM(subq_12.__instant_bookings) AS __instant_bookings
        FROM (
