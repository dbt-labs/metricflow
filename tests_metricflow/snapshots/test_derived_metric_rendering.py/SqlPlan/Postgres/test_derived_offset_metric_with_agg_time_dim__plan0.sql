...
SELECT
  nr_subq_12.booking__ds__day
  , booking_value * 0.05 / bookers AS booking_fees_last_week_per_booker_this_week
FROM (
  -- Combine Aggregated Outputs
  SELECT
    COALESCE(nr_subq_7.booking__ds__day, nr_subq_11.booking__ds__day) AS booking__ds__day
        ...
        FROM (
          ...
          FROM (
            ...
            FROM (
              ...
              SELECT
                nr_subq_1.ds__day AS booking__ds__day
                , nr_subq_1.ds__week
                , nr_subq_1.ds__month
          ...
          ON
            nr_subq_3.booking__ds__day - MAKE_INTERVAL(weeks => 1) = nr_subq_0.booking__ds__day
        ) nr_subq_4
      ) nr_subq_5
      GROUP BY
        nr_subq_5.booking__ds__day
  ...
  ON
    nr_subq_7.booking__ds__day = nr_subq_11.booking__ds__day
  GROUP BY
    COALESCE(nr_subq_7.booking__ds__day, nr_subq_11.booking__ds__day)
) nr_subq_12
