  ...
  INNER JOIN (
    ...
    ON
      (
        ...
        DATE_TRUNC('day', bookings_source_src_28000.ds) > nr_subq_13.ds - MAKE_INTERVAL(days => 2)
      )
  ) nr_subq_14
  ON
    time_spine_src_28006.ds - MAKE_INTERVAL(days => 2) = nr_subq_14.metric_time__day
  GROUP BY
