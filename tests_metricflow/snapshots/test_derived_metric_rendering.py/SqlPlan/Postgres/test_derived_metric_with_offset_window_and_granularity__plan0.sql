...
FROM (
  ...
  SELECT
    COALESCE(nr_subq_3.metric_time__quarter, nr_subq_11.metric_time__quarter) AS metric_time__quarter
  ...
  FULL OUTER JOIN (
    ...
    FROM (
      ...
      FROM (
        -- Pass Only Elements: ['bookings', 'metric_time__quarter']
        SELECT
          nr_subq_8.metric_time__quarter
          , nr_subq_8.bookings
        FROM (
          ...
          FROM (
            ...
            FROM (
              ...
              SELECT
                ...
                , nr_subq_5.ds__week
                , nr_subq_5.ds__month
                , nr_subq_5.ds__quarter AS metric_time__quarter
                , nr_subq_5.ds__year
  ...
  ON
    nr_subq_3.metric_time__quarter = nr_subq_11.metric_time__quarter
  GROUP BY
    COALESCE(nr_subq_3.metric_time__quarter, nr_subq_11.metric_time__quarter)
) nr_subq_12
