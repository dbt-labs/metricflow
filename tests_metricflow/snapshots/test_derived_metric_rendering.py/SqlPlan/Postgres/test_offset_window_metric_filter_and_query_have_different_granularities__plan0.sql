...
FROM (
  ...
  SELECT
    COALESCE(nr_subq_8.metric_time__month, nr_subq_13.metric_time__month) AS metric_time__month
    , MAX(nr_subq_8.booking_value) AS booking_value
    , MAX(nr_subq_13.bookers) AS bookers
  FROM (
    -- Compute Metrics via Expressions
    SELECT
      ...
      FROM (
        ...
        FROM (
          ...
          SELECT
            ...
            , nr_subq_4.ds_partitioned__day
            , nr_subq_4.ds_partitioned__week
            , nr_subq_4.ds_partitioned__month
            , nr_subq_4.ds_partitioned__quarter
            , nr_subq_4.ds_partitioned__year
            , nr_subq_4.ds_partitioned__extract_year
            , nr_subq_4.ds_partitioned__extract_quarter
            , nr_subq_4.ds_partitioned__extract_month
            , nr_subq_4.ds_partitioned__extract_day
            , nr_subq_4.ds_partitioned__extract_dow
            , nr_subq_4.ds_partitioned__extract_doy
            , nr_subq_4.paid_at__day
            , nr_subq_4.paid_at__week
            , nr_subq_4.paid_at__month
            , nr_subq_4.paid_at__quarter
            , nr_subq_4.paid_at__year
            , nr_subq_4.paid_at__extract_year
            , nr_subq_4.paid_at__extract_quarter
            , nr_subq_4.paid_at__extract_month
            , nr_subq_4.paid_at__extract_day
            , nr_subq_4.paid_at__extract_dow
            , nr_subq_4.paid_at__extract_doy
            , nr_subq_4.booking__ds__day
            , nr_subq_4.booking__ds__week
            , nr_subq_4.booking__ds__month
            , nr_subq_4.booking__ds__quarter
            , nr_subq_4.booking__ds__year
            , nr_subq_4.booking__ds__extract_year
            , nr_subq_4.booking__ds__extract_quarter
            , nr_subq_4.booking__ds__extract_month
            , nr_subq_4.booking__ds__extract_day
            , nr_subq_4.booking__ds__extract_dow
            , nr_subq_4.booking__ds__extract_doy
            , nr_subq_4.booking__ds_partitioned__day
            , nr_subq_4.booking__ds_partitioned__week
            , nr_subq_4.booking__ds_partitioned__month
            , nr_subq_4.booking__ds_partitioned__quarter
            , nr_subq_4.booking__ds_partitioned__year
            , nr_subq_4.booking__ds_partitioned__extract_year
            , nr_subq_4.booking__ds_partitioned__extract_quarter
            , nr_subq_4.booking__ds_partitioned__extract_month
            , nr_subq_4.booking__ds_partitioned__extract_day
            , nr_subq_4.booking__ds_partitioned__extract_dow
            , nr_subq_4.booking__ds_partitioned__extract_doy
            , nr_subq_4.booking__paid_at__day
            , nr_subq_4.booking__paid_at__week
            , nr_subq_4.booking__paid_at__month
            , nr_subq_4.booking__paid_at__quarter
            , nr_subq_4.booking__paid_at__year
            , nr_subq_4.booking__paid_at__extract_year
            , nr_subq_4.booking__paid_at__extract_quarter
            , nr_subq_4.booking__paid_at__extract_month
            , nr_subq_4.booking__paid_at__extract_day
            , nr_subq_4.booking__paid_at__extract_dow
            , nr_subq_4.booking__paid_at__extract_doy
            ...
            , nr_subq_4.guest
            , nr_subq_4.host
            , nr_subq_4.booking__listing
            , nr_subq_4.booking__guest
            , nr_subq_4.booking__host
            , nr_subq_4.is_instant
            , nr_subq_4.booking__is_instant
            , nr_subq_4.bookings
            , nr_subq_4.instant_bookings
            , nr_subq_4.booking_value
            , nr_subq_4.max_booking_value
            , nr_subq_4.min_booking_value
            , nr_subq_4.bookers
            , nr_subq_4.average_booking_value
            , nr_subq_4.referred_bookings
            , nr_subq_4.median_booking_value
            , nr_subq_4.booking_value_p99
            , nr_subq_4.discrete_booking_value_p99
            , nr_subq_4.approximate_continuous_booking_value_p99
            , nr_subq_4.approximate_discrete_booking_value_p99
          FROM (
            ...
            ON
              nr_subq_3.metric_time__day - MAKE_INTERVAL(weeks => 1) = nr_subq_0.metric_time__day
          ) nr_subq_4
  ...
  ON
    nr_subq_8.metric_time__month = nr_subq_13.metric_time__month
  GROUP BY
    COALESCE(nr_subq_8.metric_time__month, nr_subq_13.metric_time__month)
) nr_subq_14
