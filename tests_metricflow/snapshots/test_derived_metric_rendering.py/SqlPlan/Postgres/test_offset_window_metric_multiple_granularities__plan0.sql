...
FROM (
  ...
  SELECT
    COALESCE(nr_subq_7.metric_time__day, nr_subq_11.metric_time__day) AS metric_time__day
    , COALESCE(nr_subq_7.metric_time__month, nr_subq_11.metric_time__month) AS metric_time__month
    , COALESCE(nr_subq_7.metric_time__year, nr_subq_11.metric_time__year) AS metric_time__year
    , MAX(nr_subq_7.booking_value) AS booking_value
    , MAX(nr_subq_11.bookers) AS bookers
  FROM (
    -- Compute Metrics via Expressions
    SELECT
  ...
  ON
    (
      nr_subq_7.metric_time__day = nr_subq_11.metric_time__day
    ) AND (
      nr_subq_7.metric_time__month = nr_subq_11.metric_time__month
    ) AND (
      nr_subq_7.metric_time__year = nr_subq_11.metric_time__year
    )
  GROUP BY
    COALESCE(nr_subq_7.metric_time__day, nr_subq_11.metric_time__day)
    , COALESCE(nr_subq_7.metric_time__month, nr_subq_11.metric_time__month)
    , COALESCE(nr_subq_7.metric_time__year, nr_subq_11.metric_time__year)
) nr_subq_12
