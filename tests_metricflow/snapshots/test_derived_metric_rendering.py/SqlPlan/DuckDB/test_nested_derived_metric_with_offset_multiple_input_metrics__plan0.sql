...
FROM (
  ...
  FROM (
    ...
    SELECT
      ...
      , MAX(subq_6.booking_fees) AS booking_fees
    ...
    FULL OUTER JOIN (
      ...
      SELECT
        ...
        , subq_12.booking_fees_start_of_month AS booking_fees_start_of_month
      FROM (
      ...
      ON
        DATE_TRUNC('month', subq_16.metric_time__day) = subq_12.metric_time__day
    ) subq_17
    ON
