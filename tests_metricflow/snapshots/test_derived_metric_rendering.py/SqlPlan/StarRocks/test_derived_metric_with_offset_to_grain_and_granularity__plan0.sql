...
SELECT
  ...
  , subq_17.bookings_growth_since_start_of_month
FROM (
  ...
  FROM (
    ...
    SELECT
      COALESCE(subq_5.metric_time__week, subq_15.metric_time__week) AS metric_time__week
    ...
    FULL OUTER JOIN (
      ...
      SELECT
        ...
        , subq_14.__bookings AS bookings_at_start_of_month
      FROM (
        -- Aggregate Inputs for Simple Metrics
        SELECT
        ...
        FROM (
          ...
          FROM (
            ...
            FROM (
              ...
              WHERE subq_10.metric_time__week = subq_10.metric_time__day
            ) subq_11
          ) subq_12
        ) subq_13
        GROUP BY
    ...
    ON
      subq_5.metric_time__week = subq_15.metric_time__week
    GROUP BY
      COALESCE(subq_5.metric_time__week, subq_15.metric_time__week)
  ) subq_16
) subq_17
