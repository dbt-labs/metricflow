      ...
      INNER JOIN (
        ...
        FROM (
          ...
          FROM (
            ...
            ON
              DATE_SUB(subq_8.metric_time__day, INTERVAL 5 DAY) = subq_4.metric_time__day
          ) subq_9
        ) subq_10
      ) subq_11
      ON
        DATE_SUB(subq_15.metric_time__day, INTERVAL 2 DAY) = subq_11.metric_time__day
    ) subq_16
    WHERE subq_16.metric_time__day BETWEEN '2020-01-12' AND '2020-01-13'
  ) subq_17
) subq_18
