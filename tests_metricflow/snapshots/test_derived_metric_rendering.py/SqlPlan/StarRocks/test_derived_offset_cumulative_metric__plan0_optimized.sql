  ...
  INNER JOIN (
    ...
    ON
      (
        ...
        DATE_TRUNC('day', bookings_source_src_28000.ds) > DATE_SUB(subq_19.ds, INTERVAL 2 DAY)
      )
    GROUP BY
      subq_19.ds
  ) subq_23
  ON
    DATE_SUB(time_spine_src_28006.ds, INTERVAL 2 DAY) = subq_23.metric_time__day
) subq_30
