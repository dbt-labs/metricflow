...
FROM (
  ...
  INNER JOIN (
    ...
    ON
      (
        ...
        DATE_TRUNC('day', bookings_source_src_28000.ds) > DATE_SUB(subq_30.ds, INTERVAL 2 DAY)
      )
  ...
  ON
    DATE_SUB(subq_40.metric_time__day, INTERVAL 2 DAY) = subq_35.metric_time__day
