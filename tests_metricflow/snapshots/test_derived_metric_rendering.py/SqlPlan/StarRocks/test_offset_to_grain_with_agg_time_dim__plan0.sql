...
FROM (
  ...
  FROM (
    ...
    SELECT
      COALESCE(subq_5.booking__ds__day, subq_15.booking__ds__day) AS booking__ds__day
    ...
    FULL OUTER JOIN (
      ...
      FROM (
        ...
        FROM (
          ...
          FROM (
            ...
            FROM (
              ...
              SELECT
                subq_10.ds__day AS booking__ds__day
                , subq_10.ds__week
                , subq_10.ds__month
                , subq_10.ds__quarter
                , subq_10.ds__year
        ...
        ON
          DATE_TRUNC('month', subq_13.booking__ds__day) = subq_9.booking__ds__day
      ) subq_14
    ) subq_15
    ON
      subq_5.booking__ds__day = subq_15.booking__ds__day
    GROUP BY
      COALESCE(subq_5.booking__ds__day, subq_15.booking__ds__day)
  ) subq_16
) subq_17
