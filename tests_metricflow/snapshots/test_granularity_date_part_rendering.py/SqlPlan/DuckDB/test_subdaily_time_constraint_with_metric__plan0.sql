...
FROM (
  ...
  FROM (
    ...
    FROM (
      ...
      FROM (
        ...
        WHERE nr_subq_6.metric_time__hour BETWEEN '2020-01-01 02:00:00' AND '2020-01-01 05:00:00'
      ) nr_subq_7
    ) nr_subq_8
    LEFT OUTER JOIN (
      -- Aggregate Measures
      ...
      FROM (
        ...
        FROM (
          ...
          WHERE nr_subq_1.metric_time__hour BETWEEN '2020-01-01 02:00:00' AND '2020-01-01 05:00:00'
        ) nr_subq_2
      ) nr_subq_3
      GROUP BY
        nr_subq_3.metric_time__hour
  ...
  WHERE nr_subq_9.metric_time__hour BETWEEN '2020-01-01 02:00:00' AND '2020-01-01 05:00:00'
) nr_subq_10
