                ...
                FROM (
                  ...
                  FROM (
                    ...
                    SELECT
                      ...
                      , IF(EXTRACT(DOW FROM users_ds_source_src_28000.ds) = 1, 7, EXTRACT(DOW FROM users_ds_source_src_28000.ds) - 1) AS ds__extract_dow
                      ...
                      , IF(EXTRACT(DOW FROM users_ds_source_src_28000.created_at) = 1, 7, EXTRACT(DOW FROM users_ds_source_src_28000.created_at) - 1) AS created_at__extract_dow
                      ...
                      , IF(EXTRACT(DOW FROM users_ds_source_src_28000.ds_partitioned) = 1, 7, EXTRACT(DOW FROM users_ds_source_src_28000.ds_partitioned) - 1) AS ds_partitioned__extract_dow
                      ...
                      , IF(EXTRACT(DOW FROM users_ds_source_src_28000.last_profile_edit_ts) = 1, 7, EXTRACT(DOW FROM users_ds_source_src_28000.last_profile_edit_ts) - 1) AS last_profile_edit_ts__extract_dow
                      ...
                      , IF(EXTRACT(DOW FROM users_ds_source_src_28000.bio_added_ts) = 1, 7, EXTRACT(DOW FROM users_ds_source_src_28000.bio_added_ts) - 1) AS bio_added_ts__extract_dow
                      ...
                      , IF(EXTRACT(DOW FROM users_ds_source_src_28000.last_login_ts) = 1, 7, EXTRACT(DOW FROM users_ds_source_src_28000.last_login_ts) - 1) AS last_login_ts__extract_dow
                      ...
                      , IF(EXTRACT(DOW FROM users_ds_source_src_28000.archived_at) = 1, 7, EXTRACT(DOW FROM users_ds_source_src_28000.archived_at) - 1) AS archived_at__extract_dow
                      ...
                      , IF(EXTRACT(DOW FROM users_ds_source_src_28000.ds) = 1, 7, EXTRACT(DOW FROM users_ds_source_src_28000.ds) - 1) AS user__ds__extract_dow
                      ...
                      , IF(EXTRACT(DOW FROM users_ds_source_src_28000.created_at) = 1, 7, EXTRACT(DOW FROM users_ds_source_src_28000.created_at) - 1) AS user__created_at__extract_dow
                      ...
                      , IF(EXTRACT(DOW FROM users_ds_source_src_28000.ds_partitioned) = 1, 7, EXTRACT(DOW FROM users_ds_source_src_28000.ds_partitioned) - 1) AS user__ds_partitioned__extract_dow
                      ...
                      , IF(EXTRACT(DOW FROM users_ds_source_src_28000.last_profile_edit_ts) = 1, 7, EXTRACT(DOW FROM users_ds_source_src_28000.last_profile_edit_ts) - 1) AS user__last_profile_edit_ts__extract_dow
                      ...
                      , IF(EXTRACT(DOW FROM users_ds_source_src_28000.bio_added_ts) = 1, 7, EXTRACT(DOW FROM users_ds_source_src_28000.bio_added_ts) - 1) AS user__bio_added_ts__extract_dow
                      ...
                      , IF(EXTRACT(DOW FROM users_ds_source_src_28000.last_login_ts) = 1, 7, EXTRACT(DOW FROM users_ds_source_src_28000.last_login_ts) - 1) AS user__last_login_ts__extract_dow
                      ...
                      , IF(EXTRACT(DOW FROM users_ds_source_src_28000.archived_at) = 1, 7, EXTRACT(DOW FROM users_ds_source_src_28000.archived_at) - 1) AS user__archived_at__extract_dow
