      ...
      FROM (
        ...
        FROM (
          ...
          SELECT
            ...
            , CASE WHEN EXTRACT(dow FROM time_spine_src_28003.ts) = 0 THEN EXTRACT(dow FROM time_spine_src_28003.ts) + 7 ELSE EXTRACT(dow FROM time_spine_src_28003.ts) END AS ts__extract_dow
