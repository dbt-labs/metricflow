...
FROM (
  ...
  FROM (
    ...
    SELECT
      ...
      , subq_6.__simple_subdaily_metric_default_day AS simple_subdaily_metric_default_day
    FROM (
      -- Aggregate Inputs for Simple Metrics
      SELECT
        subq_5.metric_time__hour
        , SUM(subq_5.__simple_subdaily_metric_default_day) AS __simple_subdaily_metric_default_day
      FROM (
