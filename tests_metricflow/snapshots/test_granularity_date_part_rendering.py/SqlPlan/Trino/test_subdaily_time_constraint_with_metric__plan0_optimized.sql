...
SELECT
  nr_subq_17.metric_time__hour AS metric_time__hour
  , nr_subq_13.archived_users AS subdaily_join_to_time_spine_metric
FROM (
...
ON
  nr_subq_17.metric_time__hour = nr_subq_13.metric_time__hour
WHERE nr_subq_17.metric_time__hour BETWEEN timestamp '2020-01-01 02:00:00' AND timestamp '2020-01-01 05:00:00'
