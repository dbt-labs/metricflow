...
SELECT
  nr_subq_10.metric_time__hour
  , nr_subq_10.archived_users AS subdaily_join_to_time_spine_metric
FROM (
  -- Constrain Time Range to [2020-01-01T02:00:00, 2020-01-01T05:00:00]
  SELECT
    nr_subq_9.metric_time__hour
    , nr_subq_9.archived_users
  FROM (
    -- Join to Time Spine Dataset
    SELECT
      nr_subq_8.metric_time__hour AS metric_time__hour
      , nr_subq_4.archived_users AS archived_users
    FROM (
      ...
      FROM (
        ...
        SELECT
          ...
          , nr_subq_6.ts__week
          , nr_subq_6.ts__month
          , nr_subq_6.ts__quarter
          , nr_subq_6.ts__year
          , nr_subq_6.ts__extract_year
          , nr_subq_6.ts__extract_quarter
          , nr_subq_6.ts__extract_month
          , nr_subq_6.ts__extract_day
          , nr_subq_6.ts__extract_dow
          , nr_subq_6.ts__extract_doy
        FROM (
          -- Change Column Aliases
          SELECT
            nr_subq_5.ts__hour AS metric_time__hour
            , nr_subq_5.ts__day
            , nr_subq_5.ts__week
            , nr_subq_5.ts__month
            , nr_subq_5.ts__quarter
            , nr_subq_5.ts__year
            , nr_subq_5.ts__extract_year
            , nr_subq_5.ts__extract_quarter
            , nr_subq_5.ts__extract_month
            , nr_subq_5.ts__extract_day
            , nr_subq_5.ts__extract_dow
            , nr_subq_5.ts__extract_doy
          FROM (
        ...
        WHERE nr_subq_6.metric_time__hour BETWEEN timestamp '2020-01-01 02:00:00' AND timestamp '2020-01-01 05:00:00'
      ) nr_subq_7
    ) nr_subq_8
    LEFT OUTER JOIN (
      -- Aggregate Measures
      SELECT
        nr_subq_3.metric_time__hour
        , SUM(nr_subq_3.archived_users) AS archived_users
      FROM (
        -- Pass Only Elements: ['archived_users', 'metric_time__hour']
        SELECT
          nr_subq_2.metric_time__hour
          , nr_subq_2.archived_users
        FROM (
          -- Constrain Time Range to [2020-01-01T02:00:00, 2020-01-01T05:00:00]
          SELECT
            nr_subq_1.ds__day
            ...
            , nr_subq_1.last_profile_edit_ts__millisecond
            , nr_subq_1.last_profile_edit_ts__second
            , nr_subq_1.last_profile_edit_ts__minute
            , nr_subq_1.last_profile_edit_ts__hour
            , nr_subq_1.last_profile_edit_ts__day
            , nr_subq_1.last_profile_edit_ts__week
            , nr_subq_1.last_profile_edit_ts__month
            , nr_subq_1.last_profile_edit_ts__quarter
            , nr_subq_1.last_profile_edit_ts__year
            , nr_subq_1.last_profile_edit_ts__extract_year
            , nr_subq_1.last_profile_edit_ts__extract_quarter
            , nr_subq_1.last_profile_edit_ts__extract_month
            , nr_subq_1.last_profile_edit_ts__extract_day
            , nr_subq_1.last_profile_edit_ts__extract_dow
            , nr_subq_1.last_profile_edit_ts__extract_doy
            , nr_subq_1.bio_added_ts__second
            , nr_subq_1.bio_added_ts__minute
            , nr_subq_1.bio_added_ts__hour
            , nr_subq_1.bio_added_ts__day
            , nr_subq_1.bio_added_ts__week
            , nr_subq_1.bio_added_ts__month
            , nr_subq_1.bio_added_ts__quarter
            , nr_subq_1.bio_added_ts__year
            , nr_subq_1.bio_added_ts__extract_year
            , nr_subq_1.bio_added_ts__extract_quarter
            , nr_subq_1.bio_added_ts__extract_month
            , nr_subq_1.bio_added_ts__extract_day
            , nr_subq_1.bio_added_ts__extract_dow
            , nr_subq_1.bio_added_ts__extract_doy
            , nr_subq_1.last_login_ts__minute
            , nr_subq_1.last_login_ts__hour
            , nr_subq_1.last_login_ts__day
            , nr_subq_1.last_login_ts__week
            , nr_subq_1.last_login_ts__month
            , nr_subq_1.last_login_ts__quarter
            , nr_subq_1.last_login_ts__year
            , nr_subq_1.last_login_ts__extract_year
            , nr_subq_1.last_login_ts__extract_quarter
            , nr_subq_1.last_login_ts__extract_month
            , nr_subq_1.last_login_ts__extract_day
            , nr_subq_1.last_login_ts__extract_dow
            , nr_subq_1.last_login_ts__extract_doy
            , nr_subq_1.archived_at__hour
            , nr_subq_1.archived_at__day
            , nr_subq_1.archived_at__week
            , nr_subq_1.archived_at__month
            , nr_subq_1.archived_at__quarter
            , nr_subq_1.archived_at__year
            , nr_subq_1.archived_at__extract_year
            , nr_subq_1.archived_at__extract_quarter
            , nr_subq_1.archived_at__extract_month
            , nr_subq_1.archived_at__extract_day
            , nr_subq_1.archived_at__extract_dow
            , nr_subq_1.archived_at__extract_doy
            , nr_subq_1.user__ds__day
            , nr_subq_1.user__ds__week
            , nr_subq_1.user__ds__month
            , nr_subq_1.user__ds__quarter
            , nr_subq_1.user__ds__year
            , nr_subq_1.user__ds__extract_year
            , nr_subq_1.user__ds__extract_quarter
            , nr_subq_1.user__ds__extract_month
            , nr_subq_1.user__ds__extract_day
            , nr_subq_1.user__ds__extract_dow
            , nr_subq_1.user__ds__extract_doy
            , nr_subq_1.user__created_at__day
            , nr_subq_1.user__created_at__week
            , nr_subq_1.user__created_at__month
            , nr_subq_1.user__created_at__quarter
            , nr_subq_1.user__created_at__year
            , nr_subq_1.user__created_at__extract_year
            , nr_subq_1.user__created_at__extract_quarter
            , nr_subq_1.user__created_at__extract_month
            , nr_subq_1.user__created_at__extract_day
            , nr_subq_1.user__created_at__extract_dow
            , nr_subq_1.user__created_at__extract_doy
            , nr_subq_1.user__ds_partitioned__day
            , nr_subq_1.user__ds_partitioned__week
            , nr_subq_1.user__ds_partitioned__month
            , nr_subq_1.user__ds_partitioned__quarter
            , nr_subq_1.user__ds_partitioned__year
            , nr_subq_1.user__ds_partitioned__extract_year
            , nr_subq_1.user__ds_partitioned__extract_quarter
            , nr_subq_1.user__ds_partitioned__extract_month
            , nr_subq_1.user__ds_partitioned__extract_day
            , nr_subq_1.user__ds_partitioned__extract_dow
            , nr_subq_1.user__ds_partitioned__extract_doy
            , nr_subq_1.user__last_profile_edit_ts__millisecond
            , nr_subq_1.user__last_profile_edit_ts__second
            , nr_subq_1.user__last_profile_edit_ts__minute
            , nr_subq_1.user__last_profile_edit_ts__hour
            , nr_subq_1.user__last_profile_edit_ts__day
            , nr_subq_1.user__last_profile_edit_ts__week
            , nr_subq_1.user__last_profile_edit_ts__month
            , nr_subq_1.user__last_profile_edit_ts__quarter
            , nr_subq_1.user__last_profile_edit_ts__year
            , nr_subq_1.user__last_profile_edit_ts__extract_year
            , nr_subq_1.user__last_profile_edit_ts__extract_quarter
            , nr_subq_1.user__last_profile_edit_ts__extract_month
            , nr_subq_1.user__last_profile_edit_ts__extract_day
            , nr_subq_1.user__last_profile_edit_ts__extract_dow
            , nr_subq_1.user__last_profile_edit_ts__extract_doy
            , nr_subq_1.user__bio_added_ts__second
            , nr_subq_1.user__bio_added_ts__minute
            , nr_subq_1.user__bio_added_ts__hour
            , nr_subq_1.user__bio_added_ts__day
            , nr_subq_1.user__bio_added_ts__week
            , nr_subq_1.user__bio_added_ts__month
            , nr_subq_1.user__bio_added_ts__quarter
            , nr_subq_1.user__bio_added_ts__year
            , nr_subq_1.user__bio_added_ts__extract_year
            , nr_subq_1.user__bio_added_ts__extract_quarter
            , nr_subq_1.user__bio_added_ts__extract_month
            , nr_subq_1.user__bio_added_ts__extract_day
            , nr_subq_1.user__bio_added_ts__extract_dow
            , nr_subq_1.user__bio_added_ts__extract_doy
            , nr_subq_1.user__last_login_ts__minute
            , nr_subq_1.user__last_login_ts__hour
            , nr_subq_1.user__last_login_ts__day
            , nr_subq_1.user__last_login_ts__week
            , nr_subq_1.user__last_login_ts__month
            , nr_subq_1.user__last_login_ts__quarter
            , nr_subq_1.user__last_login_ts__year
            , nr_subq_1.user__last_login_ts__extract_year
            , nr_subq_1.user__last_login_ts__extract_quarter
            , nr_subq_1.user__last_login_ts__extract_month
            , nr_subq_1.user__last_login_ts__extract_day
            , nr_subq_1.user__last_login_ts__extract_dow
            , nr_subq_1.user__last_login_ts__extract_doy
            , nr_subq_1.user__archived_at__hour
            , nr_subq_1.user__archived_at__day
            , nr_subq_1.user__archived_at__week
            , nr_subq_1.user__archived_at__month
            , nr_subq_1.user__archived_at__quarter
            , nr_subq_1.user__archived_at__year
            , nr_subq_1.user__archived_at__extract_year
            , nr_subq_1.user__archived_at__extract_quarter
            , nr_subq_1.user__archived_at__extract_month
            , nr_subq_1.user__archived_at__extract_day
            , nr_subq_1.user__archived_at__extract_dow
            , nr_subq_1.user__archived_at__extract_doy
            ...
            , nr_subq_1.user__home_state
            , nr_subq_1.archived_users
          FROM (
          ...
          WHERE nr_subq_1.metric_time__hour BETWEEN timestamp '2020-01-01 02:00:00' AND timestamp '2020-01-01 05:00:00'
        ) nr_subq_2
      ) nr_subq_3
      GROUP BY
        nr_subq_3.metric_time__hour
    ...
    ON
      nr_subq_8.metric_time__hour = nr_subq_4.metric_time__hour
  ) nr_subq_9
  WHERE nr_subq_9.metric_time__hour BETWEEN timestamp '2020-01-01 02:00:00' AND timestamp '2020-01-01 05:00:00'
) nr_subq_10
