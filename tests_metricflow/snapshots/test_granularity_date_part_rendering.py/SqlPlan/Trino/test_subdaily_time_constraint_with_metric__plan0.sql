...
FROM (
  ...
  FROM (
    ...
    FROM (
      ...
      FROM (
        ...
        WHERE subq_6.metric_time__hour BETWEEN timestamp '2020-01-01 02:00:00' AND timestamp '2020-01-01 05:00:00'
      ) subq_7
    ) subq_8
    LEFT OUTER JOIN (
      -- Aggregate Measures
      ...
      FROM (
        ...
        FROM (
          ...
          WHERE subq_1.metric_time__hour BETWEEN timestamp '2020-01-01 02:00:00' AND timestamp '2020-01-01 05:00:00'
        ) subq_2
      ) subq_3
      GROUP BY
        subq_3.metric_time__hour
  ...
  WHERE subq_9.metric_time__hour BETWEEN timestamp '2020-01-01 02:00:00' AND timestamp '2020-01-01 05:00:00'
) subq_10
