...
FROM (
  ...
  FROM (
        ...
        FROM (
          ...
          FROM (
            ...
            FROM (
              ...
              WHERE subq_3.metric_time__hour BETWEEN timestamp '2020-01-01 02:00:00' AND timestamp '2020-01-01 05:00:00'
            ) subq_4
          ) subq_5
        ) subq_6
        GROUP BY
    ...
    WHERE subq_13.metric_time__hour BETWEEN timestamp '2020-01-01 02:00:00' AND timestamp '2020-01-01 05:00:00'
  ) subq_14
) subq_15
