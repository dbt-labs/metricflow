...
FROM (
  ...
  FROM (
    ...
    SELECT
      COALESCE(subq_5.metric_time__extract_dow, subq_15.metric_time__extract_dow) AS metric_time__extract_dow
        ...
        FROM (
          ...
          FROM (
            ...
            FROM (
              ...
              FROM (
                -- Select: ['metric_time__day', 'metric_time__extract_dow']
                SELECT
              ...
              ON
                DATE_SUB(subq_10.metric_time__day, INTERVAL 14 DAY) = subq_6.metric_time__day
            ) subq_11
          ) subq_12
        ) subq_13
        GROUP BY
    ...
    ON
      subq_5.metric_time__extract_dow = subq_15.metric_time__extract_dow
    GROUP BY
      COALESCE(subq_5.metric_time__extract_dow, subq_15.metric_time__extract_dow)
  ) subq_16
) subq_17
