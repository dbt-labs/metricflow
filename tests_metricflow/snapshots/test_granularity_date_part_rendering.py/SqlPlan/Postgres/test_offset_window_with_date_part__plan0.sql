...
FROM (
  ...
  SELECT
    COALESCE(nr_subq_3.metric_time__extract_dow, nr_subq_11.metric_time__extract_dow) AS metric_time__extract_dow
  ...
  FULL OUTER JOIN (
    ...
    FROM (
      ...
      FROM (
        -- Pass Only Elements: ['bookings', 'metric_time__extract_dow']
        SELECT
          nr_subq_8.metric_time__extract_dow
          , nr_subq_8.bookings
        FROM (
          ...
          FROM (
            ...
            FROM (
              ...
              SELECT
                ...
                , nr_subq_5.ds__extract_dow AS metric_time__extract_dow
          ...
          ON
            nr_subq_7.metric_time__day - MAKE_INTERVAL(days => 14) = nr_subq_4.metric_time__day
        ) nr_subq_8
      ) nr_subq_9
      GROUP BY
        nr_subq_9.metric_time__extract_dow
  ...
  ON
    nr_subq_3.metric_time__extract_dow = nr_subq_11.metric_time__extract_dow
  GROUP BY
    COALESCE(nr_subq_3.metric_time__extract_dow, nr_subq_11.metric_time__extract_dow)
) nr_subq_12
