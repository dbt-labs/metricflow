...
SELECT
  ...
  , CAST(__buys_null_filled AS DOUBLE) / CAST(NULLIF(__visits_fill_nulls_with_0_join_to_timespine, 0) AS DOUBLE) AS visit_buy_conversion_rate_7days_fill_nulls_with_0
FROM (
        ...
        ON
          (
            ...
            (
              ...
              sma_28019_cte.metric_time__day > subq_43.metric_time__day - INTERVAL 7 day
            )
          )
      ) subq_44
      GROUP BY
