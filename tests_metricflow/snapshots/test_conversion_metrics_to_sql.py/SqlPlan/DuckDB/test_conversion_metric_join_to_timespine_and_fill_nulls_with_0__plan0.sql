...
FROM (
  ...
  SELECT
    ...
    , CAST(subq_21.__buys_fill_nulls_with_0_join_to_timespine AS DOUBLE) / CAST(NULLIF(subq_21.__visits_fill_nulls_with_0_join_to_timespine, 0) AS DOUBLE) AS visit_buy_conversion_rate_7days_fill_nulls_with_0
  FROM (
