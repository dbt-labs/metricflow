...
SELECT
  ...
  , CAST(subq_22.buys AS Nullable(DOUBLE PRECISION)) / CAST(NULLIF(subq_22.visits, 0) AS Nullable(DOUBLE PRECISION)) AS visit_buy_conversion_rate_7days_fill_nulls_with_0
FROM (
