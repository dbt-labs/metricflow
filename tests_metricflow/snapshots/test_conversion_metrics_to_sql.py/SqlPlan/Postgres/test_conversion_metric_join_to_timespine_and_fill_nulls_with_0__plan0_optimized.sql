...
SELECT
  ...
  , CAST(buys_fill_nulls_with_0_join_to_timespine AS DOUBLE PRECISION) / CAST(NULLIF(visits_fill_nulls_with_0_join_to_timespine, 0) AS DOUBLE PRECISION) AS visit_buy_conversion_rate_7days_fill_nulls_with_0
FROM (
        ...
        ON
          (
            ...
            (
              ...
              sma_28019_cte.metric_time__day > subq_35.metric_time__day - MAKE_INTERVAL(days => 7)
            )
          )
      ) subq_36
      GROUP BY
