...
FROM (
  ...
  SELECT
    ...
    , CAST(subq_26.__buys_null_filled AS DOUBLE PRECISION) / CAST(NULLIF(subq_26.__visits_fill_nulls_with_0_join_to_timespine, 0) AS DOUBLE PRECISION) AS visit_buy_conversion_rate_7days_fill_nulls_with_0
  FROM (
