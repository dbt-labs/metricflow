...
FROM (
  ...
  SELECT
    ...
    , CAST(subq_21.buys_fill_nulls_with_0_join_to_timespine AS DOUBLE PRECISION) / CAST(NULLIF(subq_21.visits_fill_nulls_with_0_join_to_timespine, 0) AS DOUBLE PRECISION) AS visit_buy_conversion_rate_7days_fill_nulls_with_0
  FROM (
