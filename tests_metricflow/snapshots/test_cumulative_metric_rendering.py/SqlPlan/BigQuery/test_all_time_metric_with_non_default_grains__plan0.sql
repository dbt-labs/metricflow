...
SELECT
  ...
  , nr_subq_7.revenue_all_time
FROM (
  -- Window Function for Metric Re-aggregation
  SELECT
    nr_subq_6.metric_time__week
    , nr_subq_6.metric_time__quarter
    , LAST_VALUE(nr_subq_6.revenue_all_time) OVER (
      PARTITION BY
        nr_subq_6.metric_time__week
        , nr_subq_6.metric_time__quarter
  ...
  FROM (
    ...
    SELECT
      ...
      , nr_subq_5.txn_revenue AS revenue_all_time
    FROM (
      -- Aggregate Measures
      SELECT
      ...
      FROM (
        ...
        FROM (
          ...
          SELECT
            ...
            , nr_subq_1.metric_time__quarter AS metric_time__quarter
          ...
          FROM (
            ...
            SELECT
              ...
              , DATETIME_TRUNC(nr_subq_2.ds, quarter) AS metric_time__quarter
