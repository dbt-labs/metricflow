...
FROM (
  ...
  FROM (
    ...
    SELECT
      ...
      , LAST_VALUE(subq_9.revenue_all_time) OVER (
        PARTITION BY
          subq_9.metric_time__week
          , subq_9.metric_time__quarter
    ...
    FROM (
      ...
      SELECT
        ...
        , subq_8.revenue AS revenue_all_time
      FROM (
        -- Compute Metrics via Expressions
        SELECT
              ...
              FROM (
                ...
                FROM (
                  ...
                  SELECT
                    ...
                    , TIMESTAMP_TRUNC(subq_3.ds, isoweek) AS metric_time__week
                    , TIMESTAMP_TRUNC(subq_3.ds, quarter) AS metric_time__quarter
