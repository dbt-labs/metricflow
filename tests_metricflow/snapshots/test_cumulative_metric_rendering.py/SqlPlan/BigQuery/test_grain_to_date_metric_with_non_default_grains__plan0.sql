        ...
        FROM (
          ...
          FROM (
            ...
            FROM (
              ...
              SELECT
                TIMESTAMP_TRUNC(subq_3.ds, quarter) AS revenue_instance__ds__quarter
                , TIMESTAMP_TRUNC(subq_3.ds, year) AS revenue_instance__ds__year
            ...
            ON
              (
                ...
                subq_1.metric_time__day >= TIMESTAMP_TRUNC(subq_2.metric_time__day, month)
              )
          ) subq_4
        ) subq_5
        GROUP BY
