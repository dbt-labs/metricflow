...
FROM (
  ...
  SELECT
    ...
    , FIRST_VALUE(nr_subq_6.revenue_mtd) OVER (
      PARTITION BY nr_subq_6.metric_time__month
      ...
      FROM (
        ...
        FROM (
          ...
          SELECT
            ...
            , nr_subq_1.metric_time__month AS metric_time__month
          ...
          FROM (
            ...
            SELECT
              ...
              , DATETIME_TRUNC(nr_subq_2.ds, month) AS metric_time__month
          ...
          ON
            (
              ...
              nr_subq_0.metric_time__day >= DATETIME_TRUNC(nr_subq_1.metric_time__day, month)
            )
        ) nr_subq_3
      ) nr_subq_4
      GROUP BY
