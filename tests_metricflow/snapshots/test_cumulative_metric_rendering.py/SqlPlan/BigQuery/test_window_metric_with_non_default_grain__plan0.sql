...
FROM (
  ...
  FROM (
    ...
    SELECT
      ...
      , AVG(subq_9.trailing_2_months_revenue) OVER (PARTITION BY subq_9.metric_time__year) AS trailing_2_months_revenue
    FROM (
              ...
              FROM (
                ...
                FROM (
                  ...
                  SELECT
                    ...
                    , TIMESTAMP_TRUNC(subq_3.ds, year) AS metric_time__year
