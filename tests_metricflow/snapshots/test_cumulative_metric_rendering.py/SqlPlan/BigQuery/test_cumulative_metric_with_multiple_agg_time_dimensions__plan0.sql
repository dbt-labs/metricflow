...
FROM (
  -- Aggregate Measures
  SELECT
    nr_subq_4.revenue_instance__ds__day
  ...
  FROM (
    ...
    SELECT
      nr_subq_3.revenue_instance__ds__day
      , nr_subq_3.revenue_instance__ds__month
      , nr_subq_3.txn_revenue
    FROM (
      -- Join Self Over Time Range
      SELECT
        nr_subq_1.revenue_instance__ds__day AS revenue_instance__ds__day
      ...
      FROM (
        ...
        SELECT
          nr_subq_2.ds AS revenue_instance__ds__day
          , DATETIME_TRUNC(nr_subq_2.ds, month) AS revenue_instance__ds__month
      ...
      ON
        (
          nr_subq_0.revenue_instance__ds__day <= nr_subq_1.revenue_instance__ds__day
        ) AND (
          nr_subq_0.revenue_instance__ds__day > DATE_SUB(CAST(nr_subq_1.revenue_instance__ds__day AS DATETIME), INTERVAL 2 month)
        )
    ) nr_subq_3
  ) nr_subq_4
  GROUP BY
