...
SELECT
  ...
  , subq_16.every_two_days_bookers_fill_nulls_with_0
FROM (
  -- Re-aggregate Metric via Group By
  SELECT
    subq_15.metric_time__week
    , subq_15.booking__ds__month
    , subq_15.every_two_days_bookers_fill_nulls_with_0
  FROM (
    -- Window Function for Metric Re-aggregation
    SELECT
      subq_14.metric_time__week
      , subq_14.booking__ds__month
      , FIRST_VALUE(subq_14.every_two_days_bookers_fill_nulls_with_0) OVER (
        PARTITION BY
          subq_14.metric_time__week
          , subq_14.booking__ds__month
        ORDER BY subq_14.metric_time__day
    ...
    FROM (
      ...
      SELECT
        ...
        , subq_13.bookers_fill_nulls_with_0_join_to_timespine AS every_two_days_bookers_fill_nulls_with_0
      FROM (
        -- Compute Metrics via Expressions
        SELECT
          ...
          , COALESCE(subq_12.__bookers_fill_nulls_with_0_join_to_timespine, 0) AS bookers_fill_nulls_with_0_join_to_timespine
        FROM (
            ...
            FROM (
              ...
              FROM (
                ...
                SELECT
                  ...
                  , subq_8.ds__month AS booking__ds__month
                  , subq_8.ds__quarter
                  , subq_8.ds__year
          ...
          ON
            subq_11.metric_time__day = subq_7.metric_time__day
        ) subq_12
      ) subq_13
    ) subq_14
  ) subq_15
