    ...
    FROM (
      ...
      FROM (
        ...
        FROM (
          ...
          WHERE nr_subq_4.ds BETWEEN timestamp '2020-01-01' AND timestamp '2020-01-01'
        ) nr_subq_3
        INNER JOIN (
          ...
          WHERE nr_subq_1.metric_time__day BETWEEN timestamp '2019-11-01' AND timestamp '2020-01-01'
        ) nr_subq_2
        ON
          (
            nr_subq_2.metric_time__day <= nr_subq_3.metric_time__day
          ) AND (
            nr_subq_2.metric_time__day > DATE_ADD('month', -2, nr_subq_3.metric_time__day)
          )
      ) nr_subq_5
      WHERE nr_subq_5.metric_time__day BETWEEN timestamp '2020-01-01' AND timestamp '2020-01-01'
    ) nr_subq_6
  ) nr_subq_7
  GROUP BY
    nr_subq_7.metric_time__day
