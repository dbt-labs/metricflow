          ...
          FROM (
            ...
            FROM (
              ...
              FROM (
                ...
                WHERE subq_8.ds BETWEEN timestamp '2020-01-01' AND timestamp '2020-01-01'
              ) subq_7
              INNER JOIN (
                ...
                WHERE subq_5.metric_time__day BETWEEN timestamp '2019-11-01' AND timestamp '2020-01-01'
              ) subq_6
              ON
                (
                  subq_6.metric_time__day <= subq_7.metric_time__day
                ) AND (
                  subq_6.metric_time__day > DATE_ADD('month', -2, subq_7.metric_time__day)
                )
            ) subq_9
          ) subq_10
          WHERE subq_10.metric_time__day BETWEEN timestamp '2020-01-01' AND timestamp '2020-01-01'
        ) subq_11
      ) subq_12
      GROUP BY
        subq_12.metric_time__day
