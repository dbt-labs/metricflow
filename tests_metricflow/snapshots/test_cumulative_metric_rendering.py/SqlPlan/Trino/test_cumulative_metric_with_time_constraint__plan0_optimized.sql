...
ON
  (
    ...
    subq_14.metric_time__day > DATE_ADD('month', -2, subq_15.metric_time__day)
  )
WHERE subq_15.metric_time__day BETWEEN timestamp '2020-01-01' AND timestamp '2020-01-01'
GROUP BY
