...
ON
  (
    ...
    nr_subq_9.metric_time__day > DATE_ADD('month', -2, nr_subq_10.metric_time__day)
  )
WHERE nr_subq_10.metric_time__day BETWEEN timestamp '2020-01-01' AND timestamp '2020-01-01'
GROUP BY
