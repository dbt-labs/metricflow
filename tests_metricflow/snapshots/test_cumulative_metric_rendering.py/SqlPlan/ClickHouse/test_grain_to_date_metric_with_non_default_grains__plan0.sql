          ...
          FROM (
            ...
            FROM (
              ...
              FROM (
                ...
                FROM (
                  SELECT
                    toStartOfQuarter(subq_3.ds) AS revenue_instance__ds__quarter
                    , toStartOfYear(subq_3.ds) AS revenue_instance__ds__year
                ...
                ON
                  (
                    ...
                    subq_1.metric_time__day >= toStartOfMonth(subq_2.metric_time__day)
                  )
              ) subq_4
            ) subq_5
          ) subq_6
