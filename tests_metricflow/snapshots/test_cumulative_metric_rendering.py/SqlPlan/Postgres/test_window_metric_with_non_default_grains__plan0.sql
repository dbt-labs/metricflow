...
FROM (
  ...
  SELECT
    ...
    , subq_13.every_two_days_bookers_fill_nulls_with_0
  FROM (
    -- Window Function for Metric Re-aggregation
    SELECT
      subq_12.metric_time__week
      , subq_12.booking__ds__month
      , FIRST_VALUE(subq_12.every_two_days_bookers_fill_nulls_with_0) OVER (
        PARTITION BY
          subq_12.metric_time__week
          , subq_12.booking__ds__month
        ORDER BY subq_12.metric_time__day
    ...
    FROM (
      ...
      SELECT
        ...
        , subq_11.bookers_fill_nulls_with_0_join_to_timespine AS every_two_days_bookers_fill_nulls_with_0
      FROM (
        -- Compute Metrics via Expressions
        SELECT
          ...
          , COALESCE(subq_10.bookers_fill_nulls_with_0_join_to_timespine, 0) AS bookers_fill_nulls_with_0_join_to_timespine
        FROM (
          ...
          SELECT
            ...
            , subq_6.bookers_fill_nulls_with_0_join_to_timespine AS bookers_fill_nulls_with_0_join_to_timespine
          FROM (
          ...
          LEFT OUTER JOIN (
            ...
            SELECT
              ...
              , COUNT(DISTINCT subq_5.bookers_fill_nulls_with_0_join_to_timespine) AS bookers_fill_nulls_with_0_join_to_timespine
            FROM (
