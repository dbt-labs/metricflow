    ...
    FROM (
      ...
      FROM (
        ...
        SELECT
          ...
          , COALESCE(subq_10.__bookers_fill_nulls_with_0_join_to_timespine, 0) AS bookers_fill_nulls_with_0_join_to_timespine
        FROM (
          ...
          LEFT OUTER JOIN (
            ...
            SELECT
              ...
              , COUNT(DISTINCT subq_5.__bookers_fill_nulls_with_0_join_to_timespine) AS __bookers_fill_nulls_with_0_join_to_timespine
            FROM (
