...
SELECT
  ...
  , TIMESTAMP_TRUNC(paid_at, day) AS metric_time__day
  , TIMESTAMP_TRUNC(paid_at, isoweek) AS metric_time__week
  , TIMESTAMP_TRUNC(paid_at, month) AS metric_time__month
  , TIMESTAMP_TRUNC(paid_at, quarter) AS metric_time__quarter
  , TIMESTAMP_TRUNC(paid_at, year) AS metric_time__year
