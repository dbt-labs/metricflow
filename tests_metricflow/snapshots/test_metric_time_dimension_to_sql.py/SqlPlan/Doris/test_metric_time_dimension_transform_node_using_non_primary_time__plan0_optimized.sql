...
SELECT
  ...
  , IF(EXTRACT(DOW FROM ds) = 1, 7, EXTRACT(DOW FROM ds) - 1) AS ds__extract_dow
  ...
  , IF(EXTRACT(DOW FROM ds_partitioned) = 1, 7, EXTRACT(DOW FROM ds_partitioned) - 1) AS ds_partitioned__extract_dow
  ...
  , IF(EXTRACT(DOW FROM paid_at) = 1, 7, EXTRACT(DOW FROM paid_at) - 1) AS paid_at__extract_dow
  ...
  , IF(EXTRACT(DOW FROM ds) = 1, 7, EXTRACT(DOW FROM ds) - 1) AS booking__ds__extract_dow
  ...
  , IF(EXTRACT(DOW FROM ds_partitioned) = 1, 7, EXTRACT(DOW FROM ds_partitioned) - 1) AS booking__ds_partitioned__extract_dow
  ...
  , IF(EXTRACT(DOW FROM paid_at) = 1, 7, EXTRACT(DOW FROM paid_at) - 1) AS booking__paid_at__extract_dow
  ...
  , IF(EXTRACT(DOW FROM paid_at) = 1, 7, EXTRACT(DOW FROM paid_at) - 1) AS metric_time__extract_dow
