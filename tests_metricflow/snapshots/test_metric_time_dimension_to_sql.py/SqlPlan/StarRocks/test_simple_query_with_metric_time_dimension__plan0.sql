...
FROM (
  ...
  FULL OUTER JOIN (
    ...
    SELECT
      ...
      , subq_10.__booking_payments AS booking_payments
    FROM (
      -- Aggregate Inputs for Simple Metrics
      SELECT
        ...
        FROM (
          ...
          FROM (
            ...
            SELECT
              ...
              , subq_6.paid_at__day AS metric_time__day
              , subq_6.paid_at__week AS metric_time__week
              , subq_6.paid_at__month AS metric_time__month
              , subq_6.paid_at__quarter AS metric_time__quarter
              , subq_6.paid_at__year AS metric_time__year
              , subq_6.paid_at__extract_year AS metric_time__extract_year
              , subq_6.paid_at__extract_quarter AS metric_time__extract_quarter
              , subq_6.paid_at__extract_month AS metric_time__extract_month
              , subq_6.paid_at__extract_day AS metric_time__extract_day
              , subq_6.paid_at__extract_dow AS metric_time__extract_dow
              , subq_6.paid_at__extract_doy AS metric_time__extract_doy
              , subq_6.listing
              , subq_6.guest
              , subq_6.host
