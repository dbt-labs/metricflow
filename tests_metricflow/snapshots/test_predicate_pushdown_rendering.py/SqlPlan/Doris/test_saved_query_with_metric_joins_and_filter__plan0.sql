              ...
              FROM (
                ...
                FROM (
                  ...
                  SELECT
                    ...
                    , IF(EXTRACT(DOW FROM bookings_source_src_28000.ds) = 1, 7, EXTRACT(DOW FROM bookings_source_src_28000.ds) - 1) AS ds__extract_dow
                    ...
                    , IF(EXTRACT(DOW FROM bookings_source_src_28000.ds_partitioned) = 1, 7, EXTRACT(DOW FROM bookings_source_src_28000.ds_partitioned) - 1) AS ds_partitioned__extract_dow
                    ...
                    , IF(EXTRACT(DOW FROM bookings_source_src_28000.paid_at) = 1, 7, EXTRACT(DOW FROM bookings_source_src_28000.paid_at) - 1) AS paid_at__extract_dow
                    ...
                    , IF(EXTRACT(DOW FROM bookings_source_src_28000.ds) = 1, 7, EXTRACT(DOW FROM bookings_source_src_28000.ds) - 1) AS booking__ds__extract_dow
                    ...
                    , IF(EXTRACT(DOW FROM bookings_source_src_28000.ds_partitioned) = 1, 7, EXTRACT(DOW FROM bookings_source_src_28000.ds_partitioned) - 1) AS booking__ds_partitioned__extract_dow
                    ...
                    , IF(EXTRACT(DOW FROM bookings_source_src_28000.paid_at) = 1, 7, EXTRACT(DOW FROM bookings_source_src_28000.paid_at) - 1) AS booking__paid_at__extract_dow
                ...
                FROM (
                  ...
                  FROM (
                    ...
                    SELECT
                      ...
                      , IF(EXTRACT(DOW FROM listings_latest_src_28000.created_at) = 1, 7, EXTRACT(DOW FROM listings_latest_src_28000.created_at) - 1) AS ds__extract_dow
                      ...
                      , IF(EXTRACT(DOW FROM listings_latest_src_28000.created_at) = 1, 7, EXTRACT(DOW FROM listings_latest_src_28000.created_at) - 1) AS created_at__extract_dow
                      ...
                      , IF(EXTRACT(DOW FROM listings_latest_src_28000.created_at) = 1, 7, EXTRACT(DOW FROM listings_latest_src_28000.created_at) - 1) AS listing__ds__extract_dow
                      ...
                      , IF(EXTRACT(DOW FROM listings_latest_src_28000.created_at) = 1, 7, EXTRACT(DOW FROM listings_latest_src_28000.created_at) - 1) AS listing__created_at__extract_dow
              ...
              FROM (
                ...
                FROM (
                  ...
                  SELECT
                    ...
                    , IF(EXTRACT(DOW FROM views_source_src_28000.ds) = 1, 7, EXTRACT(DOW FROM views_source_src_28000.ds) - 1) AS ds__extract_dow
                    ...
                    , IF(EXTRACT(DOW FROM views_source_src_28000.ds_partitioned) = 1, 7, EXTRACT(DOW FROM views_source_src_28000.ds_partitioned) - 1) AS ds_partitioned__extract_dow
                    ...
                    , IF(EXTRACT(DOW FROM views_source_src_28000.ds) = 1, 7, EXTRACT(DOW FROM views_source_src_28000.ds) - 1) AS view__ds__extract_dow
                    ...
                    , IF(EXTRACT(DOW FROM views_source_src_28000.ds_partitioned) = 1, 7, EXTRACT(DOW FROM views_source_src_28000.ds_partitioned) - 1) AS view__ds_partitioned__extract_dow
