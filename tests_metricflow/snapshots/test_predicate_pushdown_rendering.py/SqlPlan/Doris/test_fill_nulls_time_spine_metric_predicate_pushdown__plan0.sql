  ...
  FROM (
            ...
            FROM (
              ...
              FROM (
                ...
                SELECT
                  ...
                  , IF(EXTRACT(DOW FROM time_spine_src_28006.ds) = 1, 7, EXTRACT(DOW FROM time_spine_src_28006.ds) - 1) AS ds__extract_dow
    ...
    FULL OUTER JOIN (
      ...
      FROM (
        ...
        ON
          DATE_SUB(CAST(subq_27.metric_time__day AS DATETIME), INTERVAL 14 day) = subq_23.metric_time__day
      ) subq_28
    ) subq_29
    ON
      (
