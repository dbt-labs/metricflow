...
SELECT
  ...
  , CAST(nr_subq_19.buys AS FLOAT64) / CAST(NULLIF(nr_subq_19.visits, 0) AS FLOAT64) AS visit_buy_conversion_rate_7days
FROM (
          ...
          ON
            (
              ...
              (
                ...
                nr_subq_12.metric_time__day > DATE_SUB(CAST(nr_subq_14.metric_time__day AS DATETIME), INTERVAL 7 day)
              )
            )
        ) nr_subq_15
      ) nr_subq_16
