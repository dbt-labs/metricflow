...
FROM (
  ...
  SELECT
    ...
    , CAST(subq_21.__buys AS FLOAT64) / CAST(NULLIF(subq_21.__visits, 0) AS FLOAT64) AS visit_buy_conversion_rate_7days
  FROM (
      ...
      FROM (
        ...
        FROM (
          ...
          FROM (
            ...
            SELECT DISTINCT
              FIRST_VALUE(subq_13.__visits) OVER (
                PARTITION BY
                  subq_16.user
            ...
            INNER JOIN (
              ...
              SELECT
                ...
                , subq_15.__buys_fill_nulls_with_0_join_to_timespine
