...
SELECT
  ...
  , subq_11.instant_booking_fraction_of_max_value
FROM (
  -- Compute Metrics via Expressions
  SELECT
    subq_10.metric_time__day
    , CAST(subq_10.average_booking_value AS FLOAT64) / CAST(NULLIF(subq_10.max_booking_value, 0) AS FLOAT64) AS instant_booking_fraction_of_max_value
  FROM (
    ...
    FROM (
      ...
      FROM (
        ...
        SELECT
          ...
          , AVG(subq_3.__average_booking_value) AS __average_booking_value
        FROM (
    ...
    FULL OUTER JOIN (
      ...
      SELECT
        ...
        , subq_8.__max_booking_value AS max_booking_value
      FROM (
        -- Aggregate Inputs for Simple Metrics
        SELECT
          subq_7.metric_time__day
          , MAX(subq_7.__max_booking_value) AS __max_booking_value
        FROM (
