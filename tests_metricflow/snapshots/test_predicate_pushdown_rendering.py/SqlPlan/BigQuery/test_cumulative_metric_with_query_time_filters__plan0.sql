...
SELECT
  ...
  , nr_subq_9.bookers AS every_two_days_bookers
FROM (
  -- Aggregate Measures
  SELECT
    nr_subq_8.metric_time__day
    , nr_subq_8.listing__country_latest
    , COUNT(DISTINCT nr_subq_8.bookers) AS bookers
  FROM (
    -- Pass Only Elements: ['bookers', 'listing__country_latest', 'metric_time__day']
    SELECT
      nr_subq_7.metric_time__day
      , nr_subq_7.listing__country_latest
      , nr_subq_7.bookers
    FROM (
      ...
      SELECT
        ...
        , nr_subq_6.ds_partitioned__day
        , nr_subq_6.ds_partitioned__week
        , nr_subq_6.ds_partitioned__month
        , nr_subq_6.ds_partitioned__quarter
        , nr_subq_6.ds_partitioned__year
        , nr_subq_6.ds_partitioned__extract_year
        , nr_subq_6.ds_partitioned__extract_quarter
        , nr_subq_6.ds_partitioned__extract_month
        , nr_subq_6.ds_partitioned__extract_day
        , nr_subq_6.ds_partitioned__extract_dow
        , nr_subq_6.ds_partitioned__extract_doy
        , nr_subq_6.paid_at__day
        , nr_subq_6.paid_at__week
        , nr_subq_6.paid_at__month
        , nr_subq_6.paid_at__quarter
        , nr_subq_6.paid_at__year
        , nr_subq_6.paid_at__extract_year
        , nr_subq_6.paid_at__extract_quarter
        , nr_subq_6.paid_at__extract_month
        , nr_subq_6.paid_at__extract_day
        , nr_subq_6.paid_at__extract_dow
        , nr_subq_6.paid_at__extract_doy
        , nr_subq_6.booking__ds__day
        , nr_subq_6.booking__ds__week
        , nr_subq_6.booking__ds__month
        , nr_subq_6.booking__ds__quarter
        , nr_subq_6.booking__ds__year
        , nr_subq_6.booking__ds__extract_year
        , nr_subq_6.booking__ds__extract_quarter
        , nr_subq_6.booking__ds__extract_month
        , nr_subq_6.booking__ds__extract_day
        , nr_subq_6.booking__ds__extract_dow
        , nr_subq_6.booking__ds__extract_doy
        , nr_subq_6.booking__ds_partitioned__day
        , nr_subq_6.booking__ds_partitioned__week
        , nr_subq_6.booking__ds_partitioned__month
        , nr_subq_6.booking__ds_partitioned__quarter
        , nr_subq_6.booking__ds_partitioned__year
        , nr_subq_6.booking__ds_partitioned__extract_year
        , nr_subq_6.booking__ds_partitioned__extract_quarter
        , nr_subq_6.booking__ds_partitioned__extract_month
        , nr_subq_6.booking__ds_partitioned__extract_day
        , nr_subq_6.booking__ds_partitioned__extract_dow
        , nr_subq_6.booking__ds_partitioned__extract_doy
        , nr_subq_6.booking__paid_at__day
        , nr_subq_6.booking__paid_at__week
        , nr_subq_6.booking__paid_at__month
        , nr_subq_6.booking__paid_at__quarter
        , nr_subq_6.booking__paid_at__year
        , nr_subq_6.booking__paid_at__extract_year
        , nr_subq_6.booking__paid_at__extract_quarter
        , nr_subq_6.booking__paid_at__extract_month
        , nr_subq_6.booking__paid_at__extract_day
        , nr_subq_6.booking__paid_at__extract_dow
        , nr_subq_6.booking__paid_at__extract_doy
        ...
        , nr_subq_6.guest
        , nr_subq_6.host
        , nr_subq_6.booking__listing
        , nr_subq_6.booking__guest
        , nr_subq_6.booking__host
        , nr_subq_6.is_instant
        , nr_subq_6.booking__is_instant
        , nr_subq_6.listing__country_latest
        , nr_subq_6.bookings
        , nr_subq_6.instant_bookings
        , nr_subq_6.booking_value
        , nr_subq_6.max_booking_value
        , nr_subq_6.min_booking_value
        , nr_subq_6.bookers
        , nr_subq_6.average_booking_value
        , nr_subq_6.referred_bookings
        , nr_subq_6.median_booking_value
        , nr_subq_6.booking_value_p99
        , nr_subq_6.discrete_booking_value_p99
        , nr_subq_6.approximate_continuous_booking_value_p99
        , nr_subq_6.approximate_discrete_booking_value_p99
      FROM (
        -- Join Standard Outputs
        SELECT
          nr_subq_5.country_latest AS listing__country_latest
        ...
        FROM (
          ...
          ON
            (
              ...
              nr_subq_0.metric_time__day > DATE_SUB(CAST(nr_subq_1.metric_time__day AS DATETIME), INTERVAL 2 day)
            )
        ) nr_subq_3
        LEFT OUTER JOIN (
        ...
        ON
          nr_subq_3.listing = nr_subq_5.listing
      ) nr_subq_6
