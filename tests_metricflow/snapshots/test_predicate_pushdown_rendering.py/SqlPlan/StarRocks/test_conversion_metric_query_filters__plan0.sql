...
FROM (
  ...
  SELECT
    ...
    , CAST(subq_24.__buys AS DOUBLE) / CAST(NULLIF(subq_24.__visits, 0) AS DOUBLE) AS visit_buy_conversion_rate_7days
  FROM (
              ...
              LEFT OUTER JOIN (
                ...
                FROM (
                  ...
                  SELECT
                    ...
                    , CASE WHEN EXTRACT(DAYOFWEEK FROM users_latest_src_28000.ds) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM users_latest_src_28000.ds) - 1 END AS ds_latest__extract_dow
                    , DAYOFYEAR(users_latest_src_28000.ds) AS ds_latest__extract_doy
                    ...
                    , CASE WHEN EXTRACT(DAYOFWEEK FROM users_latest_src_28000.ds) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM users_latest_src_28000.ds) - 1 END AS user__ds_latest__extract_dow
                    , DAYOFYEAR(users_latest_src_28000.ds) AS user__ds_latest__extract_doy
              ...
              ON
                (
                  ...
                  (
                    ...
                    subq_15.metric_time__day > DATE_SUB(subq_18.metric_time__day, INTERVAL 7 DAY)
                  )
                )
            ) subq_19
          ) subq_20
