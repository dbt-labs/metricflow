              ...
              FROM (
                ...
                FROM (
                  ...
                  SELECT
                    ...
                    , CASE WHEN EXTRACT(DAYOFWEEK FROM bookings_source_src_28000.ds) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM bookings_source_src_28000.ds) - 1 END AS ds__extract_dow
                    , DAYOFYEAR(bookings_source_src_28000.ds) AS ds__extract_doy
                    ...
                    , CASE WHEN EXTRACT(DAYOFWEEK FROM bookings_source_src_28000.ds_partitioned) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM bookings_source_src_28000.ds_partitioned) - 1 END AS ds_partitioned__extract_dow
                    , DAYOFYEAR(bookings_source_src_28000.ds_partitioned) AS ds_partitioned__extract_doy
                    ...
                    , CASE WHEN EXTRACT(DAYOFWEEK FROM bookings_source_src_28000.paid_at) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM bookings_source_src_28000.paid_at) - 1 END AS paid_at__extract_dow
                    , DAYOFYEAR(bookings_source_src_28000.paid_at) AS paid_at__extract_doy
                    ...
                    , CASE WHEN EXTRACT(DAYOFWEEK FROM bookings_source_src_28000.ds) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM bookings_source_src_28000.ds) - 1 END AS booking__ds__extract_dow
                    , DAYOFYEAR(bookings_source_src_28000.ds) AS booking__ds__extract_doy
                    ...
                    , CASE WHEN EXTRACT(DAYOFWEEK FROM bookings_source_src_28000.ds_partitioned) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM bookings_source_src_28000.ds_partitioned) - 1 END AS booking__ds_partitioned__extract_dow
                    , DAYOFYEAR(bookings_source_src_28000.ds_partitioned) AS booking__ds_partitioned__extract_doy
                    ...
                    , CASE WHEN EXTRACT(DAYOFWEEK FROM bookings_source_src_28000.paid_at) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM bookings_source_src_28000.paid_at) - 1 END AS booking__paid_at__extract_dow
                    , DAYOFYEAR(bookings_source_src_28000.paid_at) AS booking__paid_at__extract_doy
                ...
                FROM (
                  ...
                  FROM (
                    ...
                    SELECT
                      ...
                      , CASE WHEN EXTRACT(DAYOFWEEK FROM listings_latest_src_28000.created_at) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM listings_latest_src_28000.created_at) - 1 END AS ds__extract_dow
                      ...
                      , CASE WHEN EXTRACT(DAYOFWEEK FROM listings_latest_src_28000.created_at) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM listings_latest_src_28000.created_at) - 1 END AS created_at__extract_dow
                      ...
                      , CASE WHEN EXTRACT(DAYOFWEEK FROM listings_latest_src_28000.created_at) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM listings_latest_src_28000.created_at) - 1 END AS listing__ds__extract_dow
                      ...
                      , CASE WHEN EXTRACT(DAYOFWEEK FROM listings_latest_src_28000.created_at) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM listings_latest_src_28000.created_at) - 1 END AS listing__created_at__extract_dow
              ...
              FROM (
                ...
                FROM (
                  ...
                  SELECT
                    ...
                    , CASE WHEN EXTRACT(DAYOFWEEK FROM views_source_src_28000.ds) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM views_source_src_28000.ds) - 1 END AS ds__extract_dow
                    , DAYOFYEAR(views_source_src_28000.ds) AS ds__extract_doy
                    ...
                    , CASE WHEN EXTRACT(DAYOFWEEK FROM views_source_src_28000.ds_partitioned) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM views_source_src_28000.ds_partitioned) - 1 END AS ds_partitioned__extract_dow
                    , DAYOFYEAR(views_source_src_28000.ds_partitioned) AS ds_partitioned__extract_doy
                    ...
                    , CASE WHEN EXTRACT(DAYOFWEEK FROM views_source_src_28000.ds) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM views_source_src_28000.ds) - 1 END AS view__ds__extract_dow
                    , DAYOFYEAR(views_source_src_28000.ds) AS view__ds__extract_doy
                    ...
                    , CASE WHEN EXTRACT(DAYOFWEEK FROM views_source_src_28000.ds_partitioned) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM views_source_src_28000.ds_partitioned) - 1 END AS view__ds_partitioned__extract_dow
                    , DAYOFYEAR(views_source_src_28000.ds_partitioned) AS view__ds_partitioned__extract_doy
