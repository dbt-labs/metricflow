...
FROM (
  ...
  SELECT
    ...
    , CAST(subq_21.__buys AS DOUBLE) / CAST(NULLIF(subq_21.__visits, 0) AS DOUBLE) AS visit_buy_conversion_rate_7days
  FROM (
            ...
            ON
              (
                ...
                (
                  ...
                  subq_13.metric_time__day > DATE_ADD('day', -7, subq_16.metric_time__day)
                )
              )
          ) subq_17
        ) subq_18
