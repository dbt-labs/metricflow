...
FROM (
  SELECT
    ...
    , CAST(subq_24.__buys AS Nullable(Float64)) / CAST(NULLIF(subq_24.__visits, 0) AS Nullable(Float64)) AS visit_buy_conversion_rate_7days
  FROM (
    SELECT
              ...
              ON
                (
                  ...
                  (
                    ...
                    subq_15.metric_time__day > addDays(subq_18.metric_time__day, -7)
                  )
                )
            ) subq_19
          ) subq_20
