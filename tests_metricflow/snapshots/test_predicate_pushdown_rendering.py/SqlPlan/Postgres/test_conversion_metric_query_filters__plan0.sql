...
SELECT
  ...
  , CAST(nr_subq_19.buys AS DOUBLE PRECISION) / CAST(NULLIF(nr_subq_19.visits, 0) AS DOUBLE PRECISION) AS visit_buy_conversion_rate_7days
FROM (
          ...
          ON
            (
              ...
              (
                ...
                nr_subq_12.metric_time__day > nr_subq_14.metric_time__day - MAKE_INTERVAL(days => 7)
              )
            )
        ) nr_subq_15
      ) nr_subq_16
