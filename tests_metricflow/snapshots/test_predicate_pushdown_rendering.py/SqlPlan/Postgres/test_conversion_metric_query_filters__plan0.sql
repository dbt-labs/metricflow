...
FROM (
  ...
  SELECT
    ...
    , CAST(subq_21.__buys AS DOUBLE PRECISION) / CAST(NULLIF(subq_21.__visits, 0) AS DOUBLE PRECISION) AS visit_buy_conversion_rate_7days
  FROM (
            ...
            ON
              (
                ...
                (
                  ...
                  subq_13.metric_time__day > subq_16.metric_time__day - MAKE_INTERVAL(days => 7)
                )
              )
          ) subq_17
        ) subq_18
