...
FROM (
  ...
  SELECT
    COALESCE(nr_subq_7.metric_time__day, nr_subq_19.metric_time__day) AS metric_time__day
    , COALESCE(nr_subq_7.listing__country_latest, nr_subq_19.listing__country_latest) AS listing__country_latest
    , MAX(nr_subq_7.bookings) AS bookings
    , MAX(nr_subq_19.bookings_2_weeks_ago) AS bookings_2_weeks_ago
  FROM (
    -- Compute Metrics via Expressions
    SELECT
  ...
  FULL OUTER JOIN (
    ...
    SELECT
      ...
      , nr_subq_18.listing__country_latest
      , nr_subq_18.bookings AS bookings_2_weeks_ago
    FROM (
      -- Aggregate Measures
      SELECT
        nr_subq_17.metric_time__day
        , nr_subq_17.listing__country_latest
        , SUM(nr_subq_17.bookings) AS bookings
      FROM (
        -- Pass Only Elements: ['bookings', 'listing__country_latest', 'metric_time__day']
        SELECT
          nr_subq_16.metric_time__day
          , nr_subq_16.listing__country_latest
          , nr_subq_16.bookings
        FROM (
          -- Constrain Output with WHERE
          SELECT
            ...
            , nr_subq_15.ds_partitioned__day
            , nr_subq_15.ds_partitioned__week
            , nr_subq_15.ds_partitioned__month
            , nr_subq_15.ds_partitioned__quarter
            , nr_subq_15.ds_partitioned__year
            , nr_subq_15.ds_partitioned__extract_year
            , nr_subq_15.ds_partitioned__extract_quarter
            , nr_subq_15.ds_partitioned__extract_month
            , nr_subq_15.ds_partitioned__extract_day
            , nr_subq_15.ds_partitioned__extract_dow
            , nr_subq_15.ds_partitioned__extract_doy
            , nr_subq_15.paid_at__day
            , nr_subq_15.paid_at__week
            , nr_subq_15.paid_at__month
            , nr_subq_15.paid_at__quarter
            , nr_subq_15.paid_at__year
            , nr_subq_15.paid_at__extract_year
            , nr_subq_15.paid_at__extract_quarter
            , nr_subq_15.paid_at__extract_month
            , nr_subq_15.paid_at__extract_day
            , nr_subq_15.paid_at__extract_dow
            , nr_subq_15.paid_at__extract_doy
            , nr_subq_15.booking__ds__day
            , nr_subq_15.booking__ds__week
            , nr_subq_15.booking__ds__month
            , nr_subq_15.booking__ds__quarter
            , nr_subq_15.booking__ds__year
            , nr_subq_15.booking__ds__extract_year
            , nr_subq_15.booking__ds__extract_quarter
            , nr_subq_15.booking__ds__extract_month
            , nr_subq_15.booking__ds__extract_day
            , nr_subq_15.booking__ds__extract_dow
            , nr_subq_15.booking__ds__extract_doy
            , nr_subq_15.booking__ds_partitioned__day
            , nr_subq_15.booking__ds_partitioned__week
            , nr_subq_15.booking__ds_partitioned__month
            , nr_subq_15.booking__ds_partitioned__quarter
            , nr_subq_15.booking__ds_partitioned__year
            , nr_subq_15.booking__ds_partitioned__extract_year
            , nr_subq_15.booking__ds_partitioned__extract_quarter
            , nr_subq_15.booking__ds_partitioned__extract_month
            , nr_subq_15.booking__ds_partitioned__extract_day
            , nr_subq_15.booking__ds_partitioned__extract_dow
            , nr_subq_15.booking__ds_partitioned__extract_doy
            , nr_subq_15.booking__paid_at__day
            , nr_subq_15.booking__paid_at__week
            , nr_subq_15.booking__paid_at__month
            , nr_subq_15.booking__paid_at__quarter
            , nr_subq_15.booking__paid_at__year
            , nr_subq_15.booking__paid_at__extract_year
            , nr_subq_15.booking__paid_at__extract_quarter
            , nr_subq_15.booking__paid_at__extract_month
            , nr_subq_15.booking__paid_at__extract_day
            , nr_subq_15.booking__paid_at__extract_dow
            , nr_subq_15.booking__paid_at__extract_doy
            ...
            , nr_subq_15.guest
            , nr_subq_15.host
            , nr_subq_15.booking__listing
            , nr_subq_15.booking__guest
            , nr_subq_15.booking__host
            , nr_subq_15.is_instant
            , nr_subq_15.booking__is_instant
            , nr_subq_15.listing__country_latest
            , nr_subq_15.bookings
            , nr_subq_15.instant_bookings
            , nr_subq_15.booking_value
            , nr_subq_15.max_booking_value
            , nr_subq_15.min_booking_value
            , nr_subq_15.bookers
            , nr_subq_15.average_booking_value
            , nr_subq_15.referred_bookings
            , nr_subq_15.median_booking_value
            , nr_subq_15.booking_value_p99
            , nr_subq_15.discrete_booking_value_p99
            , nr_subq_15.approximate_continuous_booking_value_p99
            , nr_subq_15.approximate_discrete_booking_value_p99
          FROM (
            -- Join Standard Outputs
            SELECT
              nr_subq_14.country_latest AS listing__country_latest
            ...
            FROM (
              ...
              ON
                nr_subq_11.metric_time__day - MAKE_INTERVAL(days => 14) = nr_subq_8.metric_time__day
            ) nr_subq_12
            LEFT OUTER JOIN (
              -- Pass Only Elements: ['country_latest', 'listing']
              SELECT
                nr_subq_13.listing
                , nr_subq_13.country_latest
              FROM (
                -- Metric Time Dimension 'ds'
                SELECT
                  nr_subq_28007.ds__day
  ...
  ON
    (
      nr_subq_7.listing__country_latest = nr_subq_19.listing__country_latest
    ) AND (
      nr_subq_7.metric_time__day = nr_subq_19.metric_time__day
    )
  GROUP BY
    COALESCE(nr_subq_7.metric_time__day, nr_subq_19.metric_time__day)
    , COALESCE(nr_subq_7.listing__country_latest, nr_subq_19.listing__country_latest)
) nr_subq_20
