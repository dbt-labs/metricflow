        ...
        LEFT OUTER JOIN (
          ...
          FROM (
            ...
            FROM (
              ...
              SELECT
                subq_17.__bookings
                , subq_17.__average_booking_value
                , subq_17.__instant_bookings
                , subq_17.__booking_value
                , subq_17.__max_booking_value
                , subq_17.__min_booking_value
                , subq_17.__instant_booking_value
                , subq_17.__average_instant_booking_value
                , subq_17.__booking_value_for_non_null_listing_id
                , subq_17.__bookers
                , subq_17.__referred_bookings
                , subq_17.__median_booking_value
                , subq_17.__booking_value_p99
                , subq_17.__discrete_booking_value_p99
                , subq_17.__approximate_continuous_booking_value_p99
                , subq_17.__approximate_discrete_booking_value_p99
                , subq_17.__bookings_join_to_time_spine
                , subq_17.__bookings_fill_nulls_with_0_without_time_spine
                , subq_17.bookings_fill_nulls_with_0 AS __bookings_fill_nulls_with_0
                , subq_17.__instant_bookings_with_measure_filter
                , subq_17.__bookings_join_to_time_spine_with_tiered_filters
                , subq_17.__bookers_fill_nulls_with_0_join_to_timespine
                , subq_17.is_instant
              ...
              FROM (
                ...
                SELECT
                  ...
                  , subq_14.__average_booking_value AS __average_booking_value
                  , subq_14.__instant_bookings AS __instant_bookings
                  , subq_14.__booking_value AS __booking_value
                  , subq_14.__max_booking_value AS __max_booking_value
                  , subq_14.__min_booking_value AS __min_booking_value
                  , subq_14.__instant_booking_value AS __instant_booking_value
                  , subq_14.__average_instant_booking_value AS __average_instant_booking_value
                  , subq_14.__booking_value_for_non_null_listing_id AS __booking_value_for_non_null_listing_id
                  , subq_14.__bookers AS __bookers
                  , subq_14.__referred_bookings AS __referred_bookings
                  , subq_14.__median_booking_value AS __median_booking_value
                  , subq_14.__booking_value_p99 AS __booking_value_p99
                  , subq_14.__discrete_booking_value_p99 AS __discrete_booking_value_p99
                  , subq_14.__approximate_continuous_booking_value_p99 AS __approximate_continuous_booking_value_p99
                  , subq_14.__approximate_discrete_booking_value_p99 AS __approximate_discrete_booking_value_p99
                  , subq_14.__bookings_join_to_time_spine AS __bookings_join_to_time_spine
                  , subq_14.__bookings_fill_nulls_with_0_without_time_spine AS __bookings_fill_nulls_with_0_without_time_spine
                  , subq_14.__bookings_fill_nulls_with_0 AS bookings_fill_nulls_with_0
                  , subq_14.__instant_bookings_with_measure_filter AS __instant_bookings_with_measure_filter
                  , subq_14.__bookings_join_to_time_spine_with_tiered_filters AS __bookings_join_to_time_spine_with_tiered_filters
                  , subq_14.__bookers_fill_nulls_with_0_join_to_timespine AS __bookers_fill_nulls_with_0_join_to_timespine
                FROM (
                  -- Metric Time Dimension 'ds'
                  SELECT
                    subq_0.ds__day
