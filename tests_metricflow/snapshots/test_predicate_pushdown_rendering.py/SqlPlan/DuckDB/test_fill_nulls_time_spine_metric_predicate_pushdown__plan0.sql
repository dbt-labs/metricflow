...
SELECT
  ...
  , subq_23.bookings_growth_2_weeks_fill_nulls_with_0
FROM (
  ...
  FROM (
    ...
    SELECT
      ...
      , MAX(subq_9.bookings_fill_nulls_with_0) AS bookings_fill_nulls_with_0
    ...
    FROM (
      ...
      SELECT
        ...
        , subq_8.bookings AS bookings_fill_nulls_with_0
      FROM (
        -- Aggregate Measures
        SELECT
    ...
    FULL OUTER JOIN (
      ...
      FROM (
        ...
        ON
          subq_19.metric_time__day - INTERVAL 14 day = subq_16.metric_time__day
      ) subq_20
    ) subq_21
    ON
      (
