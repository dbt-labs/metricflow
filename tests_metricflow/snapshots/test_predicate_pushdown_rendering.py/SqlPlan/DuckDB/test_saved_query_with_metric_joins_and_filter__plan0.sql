...
FROM (
  ...
  FROM (
    ...
    SELECT
      COALESCE(subq_10.listing__capacity_latest, subq_20.listing__capacity_latest) AS listing__capacity_latest
    ...
    GROUP BY
      COALESCE(subq_10.listing__capacity_latest, subq_20.listing__capacity_latest)
  ) subq_21
) subq_22
