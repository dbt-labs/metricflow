...
SELECT
  CAST(subq_28.west_coast_balance_first_day AS DOUBLE) / CAST(NULLIF(subq_28.east_coast_balance_first_dat, 0) AS DOUBLE) AS regional_starting_balance_ratios
FROM (
                  ...
                  FROM (
                    ...
                    FROM (
                      ...
                      SELECT
                        ...
                        , EXTRACT(DAYOFWEEK_ISO FROM accounts_source_src_28000.ds) AS ds__extract_dow
                        ...
                        , EXTRACT(DAYOFWEEK_ISO FROM accounts_source_src_28000.ds) AS account__ds__extract_dow
