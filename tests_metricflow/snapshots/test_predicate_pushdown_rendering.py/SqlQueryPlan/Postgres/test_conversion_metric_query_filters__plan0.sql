...
SELECT
  ...
  , CAST(subq_22.buys AS DOUBLE PRECISION) / CAST(NULLIF(subq_22.visits, 0) AS DOUBLE PRECISION) AS visit_buy_conversion_rate_7days
FROM (
          ...
          ON
            (
              ...
              (
                ...
                subq_14.metric_time__day > subq_17.metric_time__day - MAKE_INTERVAL(days => 7)
              )
            )
        ) subq_18
      ) subq_19
