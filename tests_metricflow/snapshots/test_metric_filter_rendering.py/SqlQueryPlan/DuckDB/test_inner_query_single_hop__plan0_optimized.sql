...
FROM (
  ...
  SELECT
    subq_39.customer_id__customer_third_hop_id__paraguayan_customers AS customer_third_hop_id__customer_id__customer_third_hop_id__paraguayan_customers
  ...
  ON
    third_hop_table_src_22000.customer_third_hop_id = subq_39.customer_id__customer_third_hop_id
) subq_41
