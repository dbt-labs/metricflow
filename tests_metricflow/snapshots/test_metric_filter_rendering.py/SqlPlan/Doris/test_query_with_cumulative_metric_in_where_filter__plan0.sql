                        ...
                        FROM (
                          ...
                          FROM (
                            ...
                            SELECT
                              ...
                              , IF(EXTRACT(DOW FROM revenue_src_28000.created_at) = 1, 7, EXTRACT(DOW FROM revenue_src_28000.created_at) - 1) AS ds__extract_dow
                              ...
                              , IF(EXTRACT(DOW FROM revenue_src_28000.created_at) = 1, 7, EXTRACT(DOW FROM revenue_src_28000.created_at) - 1) AS revenue_instance__ds__extract_dow
