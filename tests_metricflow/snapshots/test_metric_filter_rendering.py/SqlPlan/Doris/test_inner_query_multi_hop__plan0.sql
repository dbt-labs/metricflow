            ...
            FROM (
              ...
              FROM (
                ...
                SELECT
                  ...
                  , IF(EXTRACT(DOW FROM third_hop_table_src_22000.third_hop_ds) = 1, 7, EXTRACT(DOW FROM third_hop_table_src_22000.third_hop_ds) - 1) AS third_hop_ds__extract_dow
                  ...
                  , IF(EXTRACT(DOW FROM third_hop_table_src_22000.third_hop_ds) = 1, 7, EXTRACT(DOW FROM third_hop_table_src_22000.third_hop_ds) - 1) AS customer_third_hop_id__third_hop_ds__extract_dow
                        ...
                        FROM (
                          ...
                          FROM (
                            ...
                            SELECT
                              ...
                              , IF(EXTRACT(DOW FROM account_month_txns_src_22000.ds_partitioned) = 1, 7, EXTRACT(DOW FROM account_month_txns_src_22000.ds_partitioned) - 1) AS ds_partitioned__extract_dow
                              ...
                              , IF(EXTRACT(DOW FROM account_month_txns_src_22000.ds) = 1, 7, EXTRACT(DOW FROM account_month_txns_src_22000.ds) - 1) AS ds__extract_dow
                              ...
                              , IF(EXTRACT(DOW FROM account_month_txns_src_22000.ds_partitioned) = 1, 7, EXTRACT(DOW FROM account_month_txns_src_22000.ds_partitioned) - 1) AS account_id__ds_partitioned__extract_dow
                              ...
                              , IF(EXTRACT(DOW FROM account_month_txns_src_22000.ds) = 1, 7, EXTRACT(DOW FROM account_month_txns_src_22000.ds) - 1) AS account_id__ds__extract_dow
                            ...
                            FROM (
                              ...
                              FROM (
                                ...
                                SELECT
                                  ...
                                  , IF(EXTRACT(DOW FROM bridge_table_src_22000.ds_partitioned) = 1, 7, EXTRACT(DOW FROM bridge_table_src_22000.ds_partitioned) - 1) AS ds_partitioned__extract_dow
                                  ...
                                  , IF(EXTRACT(DOW FROM bridge_table_src_22000.ds_partitioned) = 1, 7, EXTRACT(DOW FROM bridge_table_src_22000.ds_partitioned) - 1) AS account_id__ds_partitioned__extract_dow
                                  ...
                                  , IF(EXTRACT(DOW FROM bridge_table_src_22000.ds_partitioned) = 1, 7, EXTRACT(DOW FROM bridge_table_src_22000.ds_partitioned) - 1) AS bridge_account__ds_partitioned__extract_dow
                              ...
                              FROM (
                                ...
                                FROM (
                                  ...
                                  SELECT
                                    ...
                                    , IF(EXTRACT(DOW FROM customer_other_data_src_22000.acquired_ds) = 1, 7, EXTRACT(DOW FROM customer_other_data_src_22000.acquired_ds) - 1) AS acquired_ds__extract_dow
                                    ...
                                    , IF(EXTRACT(DOW FROM customer_other_data_src_22000.acquired_ds) = 1, 7, EXTRACT(DOW FROM customer_other_data_src_22000.acquired_ds) - 1) AS customer_id__acquired_ds__extract_dow
                                    ...
                                    , IF(EXTRACT(DOW FROM customer_other_data_src_22000.acquired_ds) = 1, 7, EXTRACT(DOW FROM customer_other_data_src_22000.acquired_ds) - 1) AS customer_third_hop_id__acquired_ds__extract_dow
