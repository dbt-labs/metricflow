                        ...
                        FROM (
                          ...
                          FROM (
                            ...
                            SELECT
                              ...
                              , IF(EXTRACT(DOW FROM visits_source_src_28000.ds) = 1, 7, EXTRACT(DOW FROM visits_source_src_28000.ds) - 1) AS ds__extract_dow
                              ...
                              , IF(EXTRACT(DOW FROM visits_source_src_28000.ds) = 1, 7, EXTRACT(DOW FROM visits_source_src_28000.ds) - 1) AS visit__ds__extract_dow
                              ...
                              FROM (
                                ...
                                FROM (
                                  ...
                                  SELECT
                                    ...
                                    , IF(EXTRACT(DOW FROM buys_source_src_28000.ds) = 1, 7, EXTRACT(DOW FROM buys_source_src_28000.ds) - 1) AS ds__extract_dow
                                    ...
                                    , IF(EXTRACT(DOW FROM buys_source_src_28000.ds) = 1, 7, EXTRACT(DOW FROM buys_source_src_28000.ds) - 1) AS buy__ds__extract_dow
