...
FROM (
  -- Aggregate Measures
  SELECT
    SUM(nr_subq_23.listings) AS listings
  FROM (
    ...
    FROM (
      ...
      SELECT
        nr_subq_21.ds__day
        , nr_subq_21.ds__week
        , nr_subq_21.ds__month
        , nr_subq_21.ds__quarter
        , nr_subq_21.ds__year
        , nr_subq_21.ds__extract_year
        , nr_subq_21.ds__extract_quarter
        , nr_subq_21.ds__extract_month
        , nr_subq_21.ds__extract_day
        , nr_subq_21.ds__extract_dow
        , nr_subq_21.ds__extract_doy
        , nr_subq_21.created_at__day
        , nr_subq_21.created_at__week
        , nr_subq_21.created_at__month
        , nr_subq_21.created_at__quarter
        , nr_subq_21.created_at__year
        , nr_subq_21.created_at__extract_year
        , nr_subq_21.created_at__extract_quarter
        , nr_subq_21.created_at__extract_month
        , nr_subq_21.created_at__extract_day
        , nr_subq_21.created_at__extract_dow
        , nr_subq_21.created_at__extract_doy
        , nr_subq_21.listing__ds__day
        , nr_subq_21.listing__ds__week
        , nr_subq_21.listing__ds__month
        , nr_subq_21.listing__ds__quarter
        , nr_subq_21.listing__ds__year
        , nr_subq_21.listing__ds__extract_year
        , nr_subq_21.listing__ds__extract_quarter
        , nr_subq_21.listing__ds__extract_month
        , nr_subq_21.listing__ds__extract_day
        , nr_subq_21.listing__ds__extract_dow
        , nr_subq_21.listing__ds__extract_doy
        , nr_subq_21.listing__created_at__day
        , nr_subq_21.listing__created_at__week
        , nr_subq_21.listing__created_at__month
        , nr_subq_21.listing__created_at__quarter
        , nr_subq_21.listing__created_at__year
        , nr_subq_21.listing__created_at__extract_year
        , nr_subq_21.listing__created_at__extract_quarter
        , nr_subq_21.listing__created_at__extract_month
        , nr_subq_21.listing__created_at__extract_day
        , nr_subq_21.listing__created_at__extract_dow
        , nr_subq_21.listing__created_at__extract_doy
        ...
        , nr_subq_21.listing
        , nr_subq_21.user
        , nr_subq_21.listing__user
        , nr_subq_21.country_latest
        , nr_subq_21.is_lux_latest
        , nr_subq_21.capacity_latest
        , nr_subq_21.listing__country_latest
        , nr_subq_21.listing__is_lux_latest
        , nr_subq_21.listing__capacity_latest
        , nr_subq_21.listing__bookings_per_booker
        , nr_subq_21.listings
        , nr_subq_21.largest_listing
        , nr_subq_21.smallest_listing
      FROM (
        -- Join Standard Outputs
        SELECT
          nr_subq_20.listing__bookings_per_booker AS listing__bookings_per_booker
          ...
          , nr_subq_9.created_at__day AS created_at__day
          , nr_subq_9.created_at__week AS created_at__week
          , nr_subq_9.created_at__month AS created_at__month
          , nr_subq_9.created_at__quarter AS created_at__quarter
          , nr_subq_9.created_at__year AS created_at__year
          , nr_subq_9.created_at__extract_year AS created_at__extract_year
          , nr_subq_9.created_at__extract_quarter AS created_at__extract_quarter
          , nr_subq_9.created_at__extract_month AS created_at__extract_month
          , nr_subq_9.created_at__extract_day AS created_at__extract_day
          , nr_subq_9.created_at__extract_dow AS created_at__extract_dow
          , nr_subq_9.created_at__extract_doy AS created_at__extract_doy
          , nr_subq_9.listing__ds__day AS listing__ds__day
          , nr_subq_9.listing__ds__week AS listing__ds__week
          , nr_subq_9.listing__ds__month AS listing__ds__month
          , nr_subq_9.listing__ds__quarter AS listing__ds__quarter
          , nr_subq_9.listing__ds__year AS listing__ds__year
          , nr_subq_9.listing__ds__extract_year AS listing__ds__extract_year
          , nr_subq_9.listing__ds__extract_quarter AS listing__ds__extract_quarter
          , nr_subq_9.listing__ds__extract_month AS listing__ds__extract_month
          , nr_subq_9.listing__ds__extract_day AS listing__ds__extract_day
          , nr_subq_9.listing__ds__extract_dow AS listing__ds__extract_dow
          , nr_subq_9.listing__ds__extract_doy AS listing__ds__extract_doy
          , nr_subq_9.listing__created_at__day AS listing__created_at__day
          , nr_subq_9.listing__created_at__week AS listing__created_at__week
          , nr_subq_9.listing__created_at__month AS listing__created_at__month
          , nr_subq_9.listing__created_at__quarter AS listing__created_at__quarter
          , nr_subq_9.listing__created_at__year AS listing__created_at__year
          , nr_subq_9.listing__created_at__extract_year AS listing__created_at__extract_year
          , nr_subq_9.listing__created_at__extract_quarter AS listing__created_at__extract_quarter
          , nr_subq_9.listing__created_at__extract_month AS listing__created_at__extract_month
          , nr_subq_9.listing__created_at__extract_day AS listing__created_at__extract_day
          , nr_subq_9.listing__created_at__extract_dow AS listing__created_at__extract_dow
          , nr_subq_9.listing__created_at__extract_doy AS listing__created_at__extract_doy
          ...
          , nr_subq_9.listing__user AS listing__user
          , nr_subq_9.country_latest AS country_latest
          , nr_subq_9.is_lux_latest AS is_lux_latest
          , nr_subq_9.capacity_latest AS capacity_latest
          , nr_subq_9.listing__country_latest AS listing__country_latest
          , nr_subq_9.listing__is_lux_latest AS listing__is_lux_latest
          , nr_subq_9.listing__capacity_latest AS listing__capacity_latest
          , nr_subq_9.listings AS listings
          , nr_subq_9.largest_listing AS largest_listing
          , nr_subq_9.smallest_listing AS smallest_listing
        FROM (
        ...
        LEFT OUTER JOIN (
          ...
          SELECT
            nr_subq_19.listing
            , nr_subq_19.listing__bookings_per_booker
          FROM (
            -- Compute Metrics via Expressions
            SELECT
              nr_subq_18.listing
              , CAST(nr_subq_18.bookings AS DOUBLE PRECISION) / CAST(NULLIF(nr_subq_18.bookers, 0) AS DOUBLE PRECISION) AS listing__bookings_per_booker
            FROM (
              -- Combine Aggregated Outputs
              SELECT
                COALESCE(nr_subq_13.listing, nr_subq_17.listing) AS listing
                , MAX(nr_subq_13.bookings) AS bookings
                , MAX(nr_subq_17.bookers) AS bookers
              FROM (
                -- Compute Metrics via Expressions
                SELECT
                  nr_subq_12.listing
              ...
              FULL OUTER JOIN (
                ...
                FROM (
                  ...
                  SELECT
                    nr_subq_15.listing
                    , COUNT(DISTINCT nr_subq_15.bookers) AS bookers
                  FROM (
              ...
              ON
                nr_subq_13.listing = nr_subq_17.listing
              GROUP BY
                COALESCE(nr_subq_13.listing, nr_subq_17.listing)
            ) nr_subq_18
          ) nr_subq_19
        ) nr_subq_20
        ON
          nr_subq_9.listing = nr_subq_20.listing
      ) nr_subq_21
