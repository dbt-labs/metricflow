            ...
            FROM (
              ...
              FROM (
                ...
                SELECT
                  ...
                  , CASE WHEN EXTRACT(DAYOFWEEK FROM third_hop_table_src_22000.third_hop_ds) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM third_hop_table_src_22000.third_hop_ds) - 1 END AS third_hop_ds__extract_dow
                  , DAYOFYEAR(third_hop_table_src_22000.third_hop_ds) AS third_hop_ds__extract_doy
                  ...
                  , CASE WHEN EXTRACT(DAYOFWEEK FROM third_hop_table_src_22000.third_hop_ds) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM third_hop_table_src_22000.third_hop_ds) - 1 END AS customer_third_hop_id__third_hop_ds__extract_dow
                  , DAYOFYEAR(third_hop_table_src_22000.third_hop_ds) AS customer_third_hop_id__third_hop_ds__extract_doy
                        ...
                        FROM (
                          ...
                          FROM (
                            ...
                            SELECT
                              ...
                              , CASE WHEN EXTRACT(DAYOFWEEK FROM account_month_txns_src_22000.ds_partitioned) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM account_month_txns_src_22000.ds_partitioned) - 1 END AS ds_partitioned__extract_dow
                              , DAYOFYEAR(account_month_txns_src_22000.ds_partitioned) AS ds_partitioned__extract_doy
                              ...
                              , CASE WHEN EXTRACT(DAYOFWEEK FROM account_month_txns_src_22000.ds) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM account_month_txns_src_22000.ds) - 1 END AS ds__extract_dow
                              , DAYOFYEAR(account_month_txns_src_22000.ds) AS ds__extract_doy
                              ...
                              , CASE WHEN EXTRACT(DAYOFWEEK FROM account_month_txns_src_22000.ds_partitioned) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM account_month_txns_src_22000.ds_partitioned) - 1 END AS account_id__ds_partitioned__extract_dow
                              , DAYOFYEAR(account_month_txns_src_22000.ds_partitioned) AS account_id__ds_partitioned__extract_doy
                              ...
                              , CASE WHEN EXTRACT(DAYOFWEEK FROM account_month_txns_src_22000.ds) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM account_month_txns_src_22000.ds) - 1 END AS account_id__ds__extract_dow
                              , DAYOFYEAR(account_month_txns_src_22000.ds) AS account_id__ds__extract_doy
                            ...
                            FROM (
                              ...
                              FROM (
                                ...
                                SELECT
                                  ...
                                  , CASE WHEN EXTRACT(DAYOFWEEK FROM bridge_table_src_22000.ds_partitioned) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM bridge_table_src_22000.ds_partitioned) - 1 END AS ds_partitioned__extract_dow
                                  , DAYOFYEAR(bridge_table_src_22000.ds_partitioned) AS ds_partitioned__extract_doy
                                  ...
                                  , CASE WHEN EXTRACT(DAYOFWEEK FROM bridge_table_src_22000.ds_partitioned) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM bridge_table_src_22000.ds_partitioned) - 1 END AS account_id__ds_partitioned__extract_dow
                                  , DAYOFYEAR(bridge_table_src_22000.ds_partitioned) AS account_id__ds_partitioned__extract_doy
                                  ...
                                  , CASE WHEN EXTRACT(DAYOFWEEK FROM bridge_table_src_22000.ds_partitioned) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM bridge_table_src_22000.ds_partitioned) - 1 END AS bridge_account__ds_partitioned__extract_dow
                                  , DAYOFYEAR(bridge_table_src_22000.ds_partitioned) AS bridge_account__ds_partitioned__extract_doy
                              ...
                              FROM (
                                ...
                                FROM (
                                  ...
                                  SELECT
                                    ...
                                    , CASE WHEN EXTRACT(DAYOFWEEK FROM customer_other_data_src_22000.acquired_ds) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM customer_other_data_src_22000.acquired_ds) - 1 END AS acquired_ds__extract_dow
                                    , DAYOFYEAR(customer_other_data_src_22000.acquired_ds) AS acquired_ds__extract_doy
                                    ...
                                    , CASE WHEN EXTRACT(DAYOFWEEK FROM customer_other_data_src_22000.acquired_ds) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM customer_other_data_src_22000.acquired_ds) - 1 END AS customer_id__acquired_ds__extract_dow
                                    , DAYOFYEAR(customer_other_data_src_22000.acquired_ds) AS customer_id__acquired_ds__extract_doy
                                    ...
                                    , CASE WHEN EXTRACT(DAYOFWEEK FROM customer_other_data_src_22000.acquired_ds) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM customer_other_data_src_22000.acquired_ds) - 1 END AS customer_third_hop_id__acquired_ds__extract_dow
                                    , DAYOFYEAR(customer_other_data_src_22000.acquired_ds) AS customer_third_hop_id__acquired_ds__extract_doy
