          ...
          FROM (
            ...
            LEFT OUTER JOIN (
              ...
              FROM (
                ...
                SELECT
                  subq_33.user
                  , CAST(subq_33.__buys AS DOUBLE) / CAST(NULLIF(subq_33.__visits, 0) AS DOUBLE) AS user__visit_buy_conversion_rate
                FROM (
                        ...
                        FROM (
                          ...
                          FROM (
                            ...
                            SELECT
                              ...
                              , CASE WHEN EXTRACT(DAYOFWEEK FROM visits_source_src_28000.ds) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM visits_source_src_28000.ds) - 1 END AS ds__extract_dow
                              , DAYOFYEAR(visits_source_src_28000.ds) AS ds__extract_doy
                              ...
                              , CASE WHEN EXTRACT(DAYOFWEEK FROM visits_source_src_28000.ds) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM visits_source_src_28000.ds) - 1 END AS visit__ds__extract_dow
                              , DAYOFYEAR(visits_source_src_28000.ds) AS visit__ds__extract_doy
                              ...
                              FROM (
                                ...
                                FROM (
                                  ...
                                  SELECT
                                    ...
                                    , CASE WHEN EXTRACT(DAYOFWEEK FROM buys_source_src_28000.ds) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM buys_source_src_28000.ds) - 1 END AS ds__extract_dow
                                    , DAYOFYEAR(buys_source_src_28000.ds) AS ds__extract_doy
                                    ...
                                    , CASE WHEN EXTRACT(DAYOFWEEK FROM buys_source_src_28000.ds) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM buys_source_src_28000.ds) - 1 END AS buy__ds__extract_dow
                                    , DAYOFYEAR(buys_source_src_28000.ds) AS buy__ds__extract_doy
