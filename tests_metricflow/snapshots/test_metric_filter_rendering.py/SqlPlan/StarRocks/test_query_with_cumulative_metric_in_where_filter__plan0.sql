                        ...
                        FROM (
                          ...
                          FROM (
                            ...
                            SELECT
                              ...
                              , CASE WHEN EXTRACT(DAYOFWEEK FROM revenue_src_28000.created_at) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM revenue_src_28000.created_at) - 1 END AS ds__extract_dow
                              , DAYOFYEAR(revenue_src_28000.created_at) AS ds__extract_doy
                              ...
                              , CASE WHEN EXTRACT(DAYOFWEEK FROM revenue_src_28000.created_at) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM revenue_src_28000.created_at) - 1 END AS revenue_instance__ds__extract_dow
                              , DAYOFYEAR(revenue_src_28000.created_at) AS revenue_instance__ds__extract_doy
