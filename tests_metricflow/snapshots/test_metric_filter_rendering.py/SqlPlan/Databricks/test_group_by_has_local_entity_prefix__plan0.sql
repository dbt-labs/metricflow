...
FROM (
  ...
  FROM (
    ...
    SELECT
      SUM(subq_19.__listings) AS __listings
    FROM (
          ...
          LEFT OUTER JOIN (
            ...
            FROM (
              ...
              SELECT
                ...
                , subq_14.__average_booking_value AS listing__user__average_booking_value
              FROM (
                -- Aggregate Inputs for Simple Metrics
                SELECT
                  subq_13.listing__user
                  , AVG(subq_13.__average_booking_value) AS __average_booking_value
                FROM (
