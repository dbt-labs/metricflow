...
SELECT
  ...
  , subq_15.active_listings
FROM (
  -- Compute Metrics via Expressions
  SELECT
    subq_14.metric_time__day
    , subq_14.__active_listings AS active_listings
  FROM (
    -- Aggregate Inputs for Simple Metrics
    SELECT
      subq_13.metric_time__day
      , SUM(subq_13.__active_listings) AS __active_listings
    FROM (
      ...
      FROM (
        ...
        SELECT
          subq_11.listings AS __listings
          , subq_11.lux_listings AS __lux_listings
          , subq_11.smallest_listing AS __smallest_listing
          , subq_11.largest_listing AS __largest_listing
          , subq_11.active_listings AS __active_listings
        ...
        FROM (
          ...
          SELECT
            ...
            , subq_4.__lux_listings AS lux_listings
            , subq_4.__smallest_listing AS smallest_listing
            , subq_4.__largest_listing AS largest_listing
            , subq_4.__active_listings AS active_listings
          FROM (
            ...
            SELECT
              ...
              , subq_3.__listings
              , subq_3.__lux_listings
              , subq_3.__smallest_listing
              , subq_3.__largest_listing
              , subq_3.__active_listings
            FROM (
          ...
          LEFT OUTER JOIN (
            ...
            FROM (
              ...
              SELECT
                subq_8.listing
                , subq_8.__bookings AS listing__bookings
              FROM (
                -- Aggregate Inputs for Simple Metrics
                SELECT
                  subq_7.listing
