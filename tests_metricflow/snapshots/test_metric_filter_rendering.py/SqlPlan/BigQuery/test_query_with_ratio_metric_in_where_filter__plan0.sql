...
FROM (
  ...
  SELECT
    subq_26.__listings AS listings
  FROM (
    -- Aggregate Inputs for Simple Metrics
    SELECT
      SUM(subq_25.__listings) AS __listings
    FROM (
      ...
      FROM (
        ...
        SELECT
          subq_23.listings AS __listings
          , subq_23.lux_listings AS __lux_listings
          , subq_23.smallest_listing AS __smallest_listing
          , subq_23.largest_listing AS __largest_listing
          , subq_23.active_listings AS __active_listings
        ...
        FROM (
          ...
          SELECT
            ...
            , subq_10.__lux_listings AS lux_listings
            , subq_10.__smallest_listing AS smallest_listing
            , subq_10.__largest_listing AS largest_listing
            , subq_10.__active_listings AS active_listings
          FROM (
          ...
          LEFT OUTER JOIN (
            ...
            FROM (
              ...
              SELECT
                subq_20.listing
                , CAST(subq_20.bookings AS FLOAT64) / CAST(NULLIF(subq_20.bookers, 0) AS FLOAT64) AS listing__bookings_per_booker
              FROM (
                    ...
                    FROM (
                      ...
                      FROM (
                        ...
                        SELECT
                          ...
                          , subq_11.__bookings
                          , subq_11.__average_booking_value
                          , subq_11.__instant_bookings
                          , subq_11.__booking_value
                          , subq_11.__max_booking_value
                          , subq_11.__min_booking_value
                          , subq_11.__instant_booking_value
                          , subq_11.__average_instant_booking_value
                          , subq_11.__booking_value_for_non_null_listing_id
                          , subq_11.__bookers
                          , subq_11.__referred_bookings
                          , subq_11.__median_booking_value
                          , subq_11.__booking_value_p99
                          , subq_11.__discrete_booking_value_p99
                          , subq_11.__approximate_continuous_booking_value_p99
                          , subq_11.__approximate_discrete_booking_value_p99
                          , subq_11.__bookings_join_to_time_spine
                          , subq_11.__bookings_fill_nulls_with_0_without_time_spine
                          , subq_11.__bookings_fill_nulls_with_0
                          , subq_11.__instant_bookings_with_measure_filter
                          , subq_11.__bookings_join_to_time_spine_with_tiered_filters
                          , subq_11.__bookers_fill_nulls_with_0_join_to_timespine
                        FROM (
                ...
                FULL OUTER JOIN (
                  ...
                  FROM (
                    ...
                    SELECT
                      subq_17.listing
                      , COUNT(DISTINCT subq_17.__bookers) AS __bookers
                    FROM (
