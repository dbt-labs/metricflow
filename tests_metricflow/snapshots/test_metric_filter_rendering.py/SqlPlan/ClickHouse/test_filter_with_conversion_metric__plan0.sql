          ...
          FROM (
            ...
            LEFT OUTER JOIN (
              ...
              FROM (
                SELECT
                  subq_33.user
                  , CAST(subq_33.__buys AS Nullable(Float64)) / CAST(NULLIF(subq_33.__visits, 0) AS Nullable(Float64)) AS user__visit_buy_conversion_rate
                FROM (
                  SELECT
