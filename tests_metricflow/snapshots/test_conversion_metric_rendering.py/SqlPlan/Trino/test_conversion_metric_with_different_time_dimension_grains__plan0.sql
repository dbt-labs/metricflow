...
FROM (
  ...
  SELECT
    CAST(subq_13.__buys_month AS DOUBLE) / CAST(NULLIF(subq_13.__visits, 0) AS DOUBLE) AS visit_buy_conversion_rate_with_monthly_conversion
  FROM (
            ...
            ON
              (
                ...
                (
                  ...
                  subq_5.metric_time__month > DATE_ADD('month', -1, subq_8.metric_time__month)
                )
              )
          ) subq_9
        ) subq_10
