...
SELECT
  ...
  , subq_16.visit_buy_conversion_rate
FROM (
  -- Compute Metrics via Expressions
  SELECT
    subq_15.metric_time__day
    , CAST(subq_15.__buys AS DOUBLE PRECISION) / CAST(NULLIF(subq_15.__visits, 0) AS DOUBLE PRECISION) AS visit_buy_conversion_rate
  FROM (
