...
SELECT
  ...
  , CAST(nr_subq_13.buys AS FLOAT64) / CAST(NULLIF(nr_subq_13.visits, 0) AS FLOAT64) AS visit_buy_conversion_rate_7days
FROM (
          ...
          ON
            (
              ...
              (
                ...
                nr_subq_6.metric_time__day > DATE_SUB(CAST(nr_subq_8.metric_time__day AS DATETIME), INTERVAL 7 day)
              )
            )
        ) nr_subq_9
      ) nr_subq_10
