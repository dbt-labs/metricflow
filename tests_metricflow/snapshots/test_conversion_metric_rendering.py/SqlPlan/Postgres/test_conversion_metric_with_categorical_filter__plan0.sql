...
SELECT
  ...
  , CAST(nr_subq_13.buys AS DOUBLE PRECISION) / CAST(NULLIF(nr_subq_13.visits, 0) AS DOUBLE PRECISION) AS visit_buy_conversion_rate
FROM (
  ...
  GROUP BY
    ...
    , COALESCE(nr_subq_3.visit__referrer_id, nr_subq_12.visit__referrer_id)
) nr_subq_13
