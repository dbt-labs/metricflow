...
SELECT
  ...
  , CAST(nr_subq_13.buys AS DOUBLE PRECISION) / CAST(NULLIF(nr_subq_13.visits, 0) AS DOUBLE PRECISION) AS visit_buy_conversion_rate_7days
FROM (
          ...
          ON
            (
              ...
              (
                ...
                nr_subq_6.metric_time__day > nr_subq_8.metric_time__day - MAKE_INTERVAL(days => 7)
              )
            )
        ) nr_subq_9
      ) nr_subq_10
