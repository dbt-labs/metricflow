...
FROM (
  ...
  SELECT
    CAST(subq_13.__buys_month AS DOUBLE PRECISION) / CAST(NULLIF(subq_13.__visits, 0) AS DOUBLE PRECISION) AS visit_buy_conversion_rate_with_monthly_conversion
  FROM (
            ...
            ON
              (
                ...
                (
                  ...
                  subq_5.metric_time__month > subq_8.metric_time__month - MAKE_INTERVAL(months => 1)
                )
              )
          ) subq_9
        ) subq_10
