...
FROM (
  ...
  SELECT
    CAST(subq_16.__buys_month AS DOUBLE PRECISION) / CAST(NULLIF(subq_16.__visits, 0) AS DOUBLE PRECISION) AS visit_buy_conversion_rate_with_monthly_conversion
  FROM (
              ...
              ON
                (
                  ...
                  (
                    ...
                    subq_7.metric_time__month > TIMESTAMPADD(month, -1, subq_10.metric_time__month)
                  )
                )
            ) subq_11
          ) subq_12
