...
FROM (
  ...
  SELECT
    ...
    , CAST(subq_20.__buys AS DOUBLE PRECISION) / CAST(NULLIF(subq_20.__visits, 0) AS DOUBLE PRECISION) AS visit_buy_conversion_rate_7days
  FROM (
              ...
              ON
                (
                  ...
                  (
                    ...
                    subq_11.metric_time__day > TIMESTAMPADD(day, -7, subq_14.metric_time__day)
                  )
                )
            ) subq_15
          ) subq_16
