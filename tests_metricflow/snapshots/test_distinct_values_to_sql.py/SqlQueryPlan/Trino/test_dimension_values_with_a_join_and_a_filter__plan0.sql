  ...
  FROM (
    ...
    FULL OUTER JOIN (
      ...
      FROM (
        -- Constrain Output with WHERE
        SELECT
          subq_3.ds_latest__day
          , subq_3.ds_latest__week
          , subq_3.ds_latest__month
          , subq_3.ds_latest__quarter
          , subq_3.ds_latest__year
          , subq_3.ds_latest__extract_year
          , subq_3.ds_latest__extract_quarter
          , subq_3.ds_latest__extract_month
          , subq_3.ds_latest__extract_day
          , subq_3.ds_latest__extract_dow
          , subq_3.ds_latest__extract_doy
          , subq_3.user__ds_latest__day
          , subq_3.user__ds_latest__week
          , subq_3.user__ds_latest__month
          , subq_3.user__ds_latest__quarter
          , subq_3.user__ds_latest__year
          , subq_3.user__ds_latest__extract_year
          , subq_3.user__ds_latest__extract_quarter
          , subq_3.user__ds_latest__extract_month
          , subq_3.user__ds_latest__extract_day
          , subq_3.user__ds_latest__extract_dow
          , subq_3.user__ds_latest__extract_doy
          , subq_3.user
