...
FROM (
  ...
  FROM (
    ...
    SELECT
      COALESCE(subq_9.ds__day, subq_18.ds__day) AS ds__day
    ...
    ON
      (
        ...
        subq_9.ds__day = subq_18.ds__day
      )
    GROUP BY
      COALESCE(subq_9.ds__day, subq_18.ds__day)
