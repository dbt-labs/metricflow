...
FROM (
  ...
  FROM (
    ...
    SELECT
      subq_3.listings AS __listings
      , subq_3.lux_listings AS __lux_listings
      , subq_3.smallest_listing AS __smallest_listing
      , subq_3.largest_listing AS __largest_listing
      , subq_3.active_listings AS __active_listings
