...
FROM (
  ...
  SELECT
    ...
    , EXTRACT(toYear FROM ds_month) AS ds_month__extract_year
    , EXTRACT(toQuarter FROM ds_month) AS ds_month__extract_quarter
    , EXTRACT(toMonth FROM ds_month) AS ds_month__extract_month
    , account_type
    ...
    , EXTRACT(toYear FROM ds) AS account__ds__extract_year
    , EXTRACT(toQuarter FROM ds) AS account__ds__extract_quarter
    , EXTRACT(toMonth FROM ds) AS account__ds__extract_month
    , EXTRACT(toDayOfMonth FROM ds) AS account__ds__extract_day
    , EXTRACT(toDayOfWeek FROM ds) AS account__ds__extract_dow
    , EXTRACT(toDayOfYear FROM ds) AS account__ds__extract_doy
    ...
    , EXTRACT(toYear FROM ds_month) AS account__ds_month__extract_year
    , EXTRACT(toQuarter FROM ds_month) AS account__ds_month__extract_quarter
    , EXTRACT(toMonth FROM ds_month) AS account__ds_month__extract_month
