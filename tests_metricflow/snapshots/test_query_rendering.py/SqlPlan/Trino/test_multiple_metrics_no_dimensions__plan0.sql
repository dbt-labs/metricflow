...
SELECT
  ...
  , MAX(nr_subq_11.listings) AS listings
FROM (
  ...
  FROM (
    ...
    FROM (
      ...
      FROM (
        ...
        WHERE nr_subq_2.metric_time__day BETWEEN timestamp '2020-01-01' AND timestamp '2020-01-01'
      ) nr_subq_3
    ) nr_subq_4
  ) nr_subq_5
) nr_subq_6
CROSS JOIN (
  ...
  FROM (
    -- Aggregate Measures
    SELECT
      SUM(nr_subq_9.listings) AS listings
    FROM (
      ...
      FROM (
        ...
        SELECT
          ...
          , nr_subq_7.created_at__day
          , nr_subq_7.created_at__week
          , nr_subq_7.created_at__month
          , nr_subq_7.created_at__quarter
          , nr_subq_7.created_at__year
          , nr_subq_7.created_at__extract_year
          , nr_subq_7.created_at__extract_quarter
          , nr_subq_7.created_at__extract_month
          , nr_subq_7.created_at__extract_day
          , nr_subq_7.created_at__extract_dow
          , nr_subq_7.created_at__extract_doy
          , nr_subq_7.listing__ds__day
          , nr_subq_7.listing__ds__week
          , nr_subq_7.listing__ds__month
          , nr_subq_7.listing__ds__quarter
          , nr_subq_7.listing__ds__year
          , nr_subq_7.listing__ds__extract_year
          , nr_subq_7.listing__ds__extract_quarter
          , nr_subq_7.listing__ds__extract_month
          , nr_subq_7.listing__ds__extract_day
          , nr_subq_7.listing__ds__extract_dow
          , nr_subq_7.listing__ds__extract_doy
          , nr_subq_7.listing__created_at__day
          , nr_subq_7.listing__created_at__week
          , nr_subq_7.listing__created_at__month
          , nr_subq_7.listing__created_at__quarter
          , nr_subq_7.listing__created_at__year
          , nr_subq_7.listing__created_at__extract_year
          , nr_subq_7.listing__created_at__extract_quarter
          , nr_subq_7.listing__created_at__extract_month
          , nr_subq_7.listing__created_at__extract_day
          , nr_subq_7.listing__created_at__extract_dow
          , nr_subq_7.listing__created_at__extract_doy
          ...
          , nr_subq_7.listing
          , nr_subq_7.user
          , nr_subq_7.listing__user
          , nr_subq_7.country_latest
          , nr_subq_7.is_lux_latest
          , nr_subq_7.capacity_latest
          , nr_subq_7.listing__country_latest
          , nr_subq_7.listing__is_lux_latest
          , nr_subq_7.listing__capacity_latest
          , nr_subq_7.listings
          , nr_subq_7.largest_listing
          , nr_subq_7.smallest_listing
        FROM (
          -- Metric Time Dimension 'ds'
          SELECT
        ...
        WHERE nr_subq_7.metric_time__day BETWEEN timestamp '2020-01-01' AND timestamp '2020-01-01'
      ) nr_subq_8
    ) nr_subq_9
  ) nr_subq_10
) nr_subq_11
