    ...
    FROM (
      ...
      FROM (
        ...
        FROM (
          ...
          WHERE subq_3.metric_time__day BETWEEN timestamp '2020-01-01' AND timestamp '2020-01-01'
        ) subq_4
      ) subq_5
    ) subq_6
  ) subq_7
    ...
    FROM (
      ...
      FROM (
        ...
        FROM (
          ...
          WHERE subq_9.metric_time__day BETWEEN timestamp '2020-01-01' AND timestamp '2020-01-01'
        ) subq_10
      ) subq_11
    ) subq_12
  ) subq_13
