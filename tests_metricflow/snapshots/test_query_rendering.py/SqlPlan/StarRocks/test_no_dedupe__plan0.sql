          ...
          FROM (
            ...
            FROM (
              ...
              SELECT
                ...
                , CASE WHEN EXTRACT(DAYOFWEEK FROM time_spine_src_26006.ds) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM time_spine_src_26006.ds) - 1 END AS ds__extract_dow
                , DAYOFYEAR(time_spine_src_26006.ds) AS ds__extract_doy
