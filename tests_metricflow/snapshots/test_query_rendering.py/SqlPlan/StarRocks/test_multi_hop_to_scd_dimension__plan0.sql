              ...
              LEFT OUTER JOIN (
                ...
                FROM (
                  ...
                  SELECT
                    ...
                    , CASE WHEN EXTRACT(DAYOFWEEK FROM lux_listings_src_26000.valid_from) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM lux_listings_src_26000.valid_from) - 1 END AS window_start__extract_dow
                    , DAYOFYEAR(lux_listings_src_26000.valid_from) AS window_start__extract_doy
                    ...
                    , CASE WHEN EXTRACT(DAYOFWEEK FROM lux_listings_src_26000.valid_to) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM lux_listings_src_26000.valid_to) - 1 END AS window_end__extract_dow
                    , DAYOFYEAR(lux_listings_src_26000.valid_to) AS window_end__extract_doy
                    ...
                    , CASE WHEN EXTRACT(DAYOFWEEK FROM lux_listings_src_26000.valid_from) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM lux_listings_src_26000.valid_from) - 1 END AS lux_listing__window_start__extract_dow
                    , DAYOFYEAR(lux_listings_src_26000.valid_from) AS lux_listing__window_start__extract_doy
                    ...
                    , CASE WHEN EXTRACT(DAYOFWEEK FROM lux_listings_src_26000.valid_to) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM lux_listings_src_26000.valid_to) - 1 END AS lux_listing__window_end__extract_dow
                    , DAYOFYEAR(lux_listings_src_26000.valid_to) AS lux_listing__window_end__extract_doy
