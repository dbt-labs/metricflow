            ...
            FROM (
              ...
              FROM (
                ...
                SELECT
                  ...
                  , CASE WHEN EXTRACT(DAYOFWEEK FROM accounts_source_src_28000.ds) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM accounts_source_src_28000.ds) - 1 END AS ds__extract_dow
                  , DAYOFYEAR(accounts_source_src_28000.ds) AS ds__extract_doy
                  ...
                  , CASE WHEN EXTRACT(DAYOFWEEK FROM accounts_source_src_28000.ds) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM accounts_source_src_28000.ds) - 1 END AS account__ds__extract_dow
                  , DAYOFYEAR(accounts_source_src_28000.ds) AS account__ds__extract_doy
