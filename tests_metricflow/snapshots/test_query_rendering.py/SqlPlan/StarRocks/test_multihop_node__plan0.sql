                ...
                FROM (
                  ...
                  FROM (
                    ...
                    SELECT
                      ...
                      , CASE WHEN EXTRACT(DAYOFWEEK FROM customer_table_src_22000.ds_partitioned) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM customer_table_src_22000.ds_partitioned) - 1 END AS ds_partitioned__extract_dow
                      , DAYOFYEAR(customer_table_src_22000.ds_partitioned) AS ds_partitioned__extract_doy
                      ...
                      , CASE WHEN EXTRACT(DAYOFWEEK FROM customer_table_src_22000.ds_partitioned) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM customer_table_src_22000.ds_partitioned) - 1 END AS customer_id__ds_partitioned__extract_dow
                      , DAYOFYEAR(customer_table_src_22000.ds_partitioned) AS customer_id__ds_partitioned__extract_doy
