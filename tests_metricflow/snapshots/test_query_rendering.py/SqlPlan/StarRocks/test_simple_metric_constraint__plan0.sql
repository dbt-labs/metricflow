...
SELECT
  ...
  , subq_26.lux_booking_value_rate_expr
FROM (
  ...
  FROM (
    ...
    SELECT
      COALESCE(subq_10.metric_time__day, subq_19.metric_time__day, subq_24.metric_time__day) AS metric_time__day
      , MAX(subq_10.average_booking_value) AS average_booking_value
    ...
    FROM (
      ...
      SELECT
        ...
        , subq_9.__average_booking_value AS average_booking_value
      FROM (
        ...
        FROM (
          ...
          FROM (
            ...
            SELECT
              subq_6.average_booking_value AS __average_booking_value
              , subq_6.listing__is_lux_latest
              , subq_6.metric_time__day
            FROM (
              -- Select: ['__average_booking_value', 'listing__is_lux_latest', 'metric_time__day']
              SELECT
      ...
      FROM (
        ...
        FROM (
          ...
          FROM (
            -- Constrain Output with WHERE
            SELECT
              subq_15.bookings AS __bookings
              , subq_15.listing__is_lux_latest
              , subq_15.metric_time__day
            FROM (
              -- Select: ['__bookings', 'listing__is_lux_latest', 'metric_time__day']
              SELECT
              ...
              FROM (
                ...
                SELECT
                  ...
                  , subq_11.__average_booking_value AS __average_booking_value
                  , subq_11.__instant_bookings AS __instant_bookings
                  , subq_11.__booking_value AS __booking_value
                  , subq_11.__max_booking_value AS __max_booking_value
                  , subq_11.__min_booking_value AS __min_booking_value
                  , subq_11.__instant_booking_value AS __instant_booking_value
                  , subq_11.__average_instant_booking_value AS __average_instant_booking_value
                  , subq_11.__booking_value_for_non_null_listing_id AS __booking_value_for_non_null_listing_id
                  , subq_11.__bookers AS __bookers
                  , subq_11.__referred_bookings AS __referred_bookings
                  , subq_11.__median_booking_value AS __median_booking_value
                  , subq_11.__booking_value_p99 AS __booking_value_p99
                  , subq_11.__discrete_booking_value_p99 AS __discrete_booking_value_p99
                  , subq_11.__approximate_continuous_booking_value_p99 AS __approximate_continuous_booking_value_p99
                  , subq_11.__approximate_discrete_booking_value_p99 AS __approximate_discrete_booking_value_p99
                  , subq_11.__bookings_join_to_time_spine AS __bookings_join_to_time_spine
                  , subq_11.__bookings_fill_nulls_with_0_without_time_spine AS __bookings_fill_nulls_with_0_without_time_spine
                  , subq_11.__bookings_fill_nulls_with_0 AS __bookings_fill_nulls_with_0
                  , subq_11.__instant_bookings_with_measure_filter AS __instant_bookings_with_measure_filter
    ...
    ON
      subq_10.metric_time__day = subq_19.metric_time__day
    FULL OUTER JOIN (
      -- Compute Metrics via Expressions
      SELECT
        subq_23.metric_time__day
        , subq_23.__booking_value AS booking_value
      FROM (
        -- Aggregate Inputs for Simple Metrics
        SELECT
          subq_22.metric_time__day
          , SUM(subq_22.__booking_value) AS __booking_value
        FROM (
          -- Select: ['__booking_value', 'metric_time__day']
          SELECT
            subq_21.metric_time__day
            , subq_21.__booking_value
          FROM (
            -- Select: ['__booking_value', 'metric_time__day']
            SELECT
              subq_20.metric_time__day
              , subq_20.__booking_value
            FROM (
              -- Metric Time Dimension 'ds'
              SELECT
                subq_0.ds__day
    ...
    ON
      COALESCE(subq_10.metric_time__day, subq_19.metric_time__day) = subq_24.metric_time__day
    GROUP BY
      COALESCE(subq_10.metric_time__day, subq_19.metric_time__day, subq_24.metric_time__day)
  ) subq_25
) subq_26
