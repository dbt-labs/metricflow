          ...
          FROM (
            ...
            FROM (
              ...
              SELECT
                ...
                , CASE WHEN EXTRACT(DAYOFWEEK FROM bookings_source_src_26000.ds) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM bookings_source_src_26000.ds) - 1 END AS ds__extract_dow
                , DAYOFYEAR(bookings_source_src_26000.ds) AS ds__extract_doy
                ...
                , CASE WHEN EXTRACT(DAYOFWEEK FROM bookings_source_src_26000.ds_partitioned) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM bookings_source_src_26000.ds_partitioned) - 1 END AS ds_partitioned__extract_dow
                , DAYOFYEAR(bookings_source_src_26000.ds_partitioned) AS ds_partitioned__extract_doy
                ...
                , CASE WHEN EXTRACT(DAYOFWEEK FROM bookings_source_src_26000.paid_at) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM bookings_source_src_26000.paid_at) - 1 END AS paid_at__extract_dow
                , DAYOFYEAR(bookings_source_src_26000.paid_at) AS paid_at__extract_doy
                ...
                , CASE WHEN EXTRACT(DAYOFWEEK FROM bookings_source_src_26000.ds) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM bookings_source_src_26000.ds) - 1 END AS booking__ds__extract_dow
                , DAYOFYEAR(bookings_source_src_26000.ds) AS booking__ds__extract_doy
                ...
                , CASE WHEN EXTRACT(DAYOFWEEK FROM bookings_source_src_26000.ds_partitioned) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM bookings_source_src_26000.ds_partitioned) - 1 END AS booking__ds_partitioned__extract_dow
                , DAYOFYEAR(bookings_source_src_26000.ds_partitioned) AS booking__ds_partitioned__extract_doy
                ...
                , CASE WHEN EXTRACT(DAYOFWEEK FROM bookings_source_src_26000.paid_at) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM bookings_source_src_26000.paid_at) - 1 END AS booking__paid_at__extract_dow
                , DAYOFYEAR(bookings_source_src_26000.paid_at) AS booking__paid_at__extract_doy
            ...
            FROM (
              ...
              FROM (
                ...
                SELECT
                  ...
                  , CASE WHEN EXTRACT(DAYOFWEEK FROM listings_src_26000.active_from) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM listings_src_26000.active_from) - 1 END AS window_start__extract_dow
                  , DAYOFYEAR(listings_src_26000.active_from) AS window_start__extract_doy
                  ...
                  , CASE WHEN EXTRACT(DAYOFWEEK FROM listings_src_26000.active_to) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM listings_src_26000.active_to) - 1 END AS window_end__extract_dow
                  , DAYOFYEAR(listings_src_26000.active_to) AS window_end__extract_doy
                  ...
                  , CASE WHEN EXTRACT(DAYOFWEEK FROM listings_src_26000.active_from) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM listings_src_26000.active_from) - 1 END AS listing__window_start__extract_dow
                  , DAYOFYEAR(listings_src_26000.active_from) AS listing__window_start__extract_doy
                  ...
                  , CASE WHEN EXTRACT(DAYOFWEEK FROM listings_src_26000.active_to) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM listings_src_26000.active_to) - 1 END AS listing__window_end__extract_dow
                  , DAYOFYEAR(listings_src_26000.active_to) AS listing__window_end__extract_doy
              ...
              LEFT OUTER JOIN (
                ...
                FROM (
                  ...
                  SELECT
                    ...
                    , CASE WHEN EXTRACT(DAYOFWEEK FROM users_latest_src_26000.ds) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM users_latest_src_26000.ds) - 1 END AS ds__extract_dow
                    , DAYOFYEAR(users_latest_src_26000.ds) AS ds__extract_doy
                    ...
                    , CASE WHEN EXTRACT(DAYOFWEEK FROM users_latest_src_26000.ds) = 1 THEN 7 ELSE EXTRACT(DAYOFWEEK FROM users_latest_src_26000.ds) - 1 END AS user__ds__extract_dow
                    , DAYOFYEAR(users_latest_src_26000.ds) AS user__ds__extract_doy
