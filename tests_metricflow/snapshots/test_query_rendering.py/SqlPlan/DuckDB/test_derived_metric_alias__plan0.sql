    ...
    FROM (
      ...
      FROM (
        ...
        SELECT
          ...
          , subq_15.__booking_value AS booking_value
        FROM (
          ...
          FROM (
            ...
            FROM (
              ...
              SELECT
                subq_12.bookings AS __bookings
                , subq_12.average_booking_value AS __average_booking_value
                , subq_12.instant_bookings AS __instant_bookings
                , subq_12.booking_value AS __booking_value
                , subq_12.max_booking_value AS __max_booking_value
                , subq_12.min_booking_value AS __min_booking_value
                , subq_12.instant_booking_value AS __instant_booking_value
                , subq_12.average_instant_booking_value AS __average_instant_booking_value
                , subq_12.booking_value_for_non_null_listing_id AS __booking_value_for_non_null_listing_id
                , subq_12.bookers AS __bookers
                , subq_12.referred_bookings AS __referred_bookings
                , subq_12.median_booking_value AS __median_booking_value
                , subq_12.booking_value_p99 AS __booking_value_p99
                , subq_12.discrete_booking_value_p99 AS __discrete_booking_value_p99
                , subq_12.approximate_continuous_booking_value_p99 AS __approximate_continuous_booking_value_p99
                , subq_12.approximate_discrete_booking_value_p99 AS __approximate_discrete_booking_value_p99
                , subq_12.bookings_join_to_time_spine AS __bookings_join_to_time_spine
                , subq_12.bookings_fill_nulls_with_0_without_time_spine AS __bookings_fill_nulls_with_0_without_time_spine
                , subq_12.bookings_fill_nulls_with_0 AS __bookings_fill_nulls_with_0
                , subq_12.instant_bookings_with_measure_filter AS __instant_bookings_with_measure_filter
                , subq_12.bookings_join_to_time_spine_with_tiered_filters AS __bookings_join_to_time_spine_with_tiered_filters
                , subq_12.bookers_fill_nulls_with_0_join_to_timespine AS __bookers_fill_nulls_with_0_join_to_timespine
                , subq_12.is_instant
              ...
              FROM (
                ...
                SELECT
                  ...
                  , subq_5.__instant_bookings AS instant_bookings
                  , subq_5.__booking_value AS booking_value
                  , subq_5.__max_booking_value AS max_booking_value
                  , subq_5.__min_booking_value AS min_booking_value
                  , subq_5.__instant_booking_value AS instant_booking_value
                  , subq_5.__average_instant_booking_value AS average_instant_booking_value
                  , subq_5.__booking_value_for_non_null_listing_id AS booking_value_for_non_null_listing_id
                  , subq_5.__bookers AS bookers
                  , subq_5.__referred_bookings AS referred_bookings
                  , subq_5.__median_booking_value AS median_booking_value
                  , subq_5.__booking_value_p99 AS booking_value_p99
                  , subq_5.__discrete_booking_value_p99 AS discrete_booking_value_p99
                  , subq_5.__approximate_continuous_booking_value_p99 AS approximate_continuous_booking_value_p99
                  , subq_5.__approximate_discrete_booking_value_p99 AS approximate_discrete_booking_value_p99
                  , subq_5.__bookings_join_to_time_spine AS bookings_join_to_time_spine
                  , subq_5.__bookings_fill_nulls_with_0_without_time_spine AS bookings_fill_nulls_with_0_without_time_spine
                  , subq_5.__bookings_fill_nulls_with_0 AS bookings_fill_nulls_with_0
                  , subq_5.__instant_bookings_with_measure_filter AS instant_bookings_with_measure_filter
                  , subq_5.__bookings_join_to_time_spine_with_tiered_filters AS bookings_join_to_time_spine_with_tiered_filters
                  , subq_5.__bookers_fill_nulls_with_0_join_to_timespine AS bookers_fill_nulls_with_0_join_to_timespine
                FROM (
                ...
                LEFT OUTER JOIN (
                  ...
                  FROM (
                    ...
                    FROM (
                      ...
                      SELECT
                        subq_8.listing
                        , subq_8.__booking_value AS booking_value
                      FROM (
                        -- Aggregate Inputs for Simple Metrics
                        SELECT
                          subq_7.listing
                          , SUM(subq_7.__booking_value) AS __booking_value
                        FROM (
