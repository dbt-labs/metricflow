...
SELECT
  ...
  , nr_subq_17.booking_fees AS bookings_alias
FROM (
  -- Order By ['booking_fees']
  SELECT
    nr_subq_16.metric_time__day
    , nr_subq_16.booking_fees
  FROM (
    ...
    FROM (
      ...
      SELECT
        ...
        , nr_subq_14.booking_value
      FROM (
        -- Aggregate Measures
        SELECT
          nr_subq_13.metric_time__day
          , SUM(nr_subq_13.booking_value) AS booking_value
        FROM (
          ...
          FROM (
            ...
            SELECT
              ...
              , nr_subq_11.listing__booking_fees
              , nr_subq_11.bookings
            ...
            FROM (
              ...
              SELECT
                nr_subq_10.listing__booking_fees AS listing__booking_fees
              ...
              LEFT OUTER JOIN (
                ...
                SELECT
                  nr_subq_9.listing
                  , nr_subq_9.listing__booking_fees
                FROM (
                  -- Compute Metrics via Expressions
                  SELECT
                    nr_subq_8.listing
              ...
              ON
                nr_subq_4.listing = nr_subq_10.listing
            ) nr_subq_11
  ...
  ORDER BY nr_subq_16.booking_fees
) nr_subq_17
