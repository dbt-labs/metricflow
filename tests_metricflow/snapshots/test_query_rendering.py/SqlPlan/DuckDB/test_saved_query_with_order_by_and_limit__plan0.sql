...
FROM (
  ...
  FROM (
    ...
    SELECT
      ...
      , COALESCE(subq_8.listing__capacity_latest, subq_16.listing__capacity_latest) AS listing__capacity_latest
    ...
    FULL OUTER JOIN (
      ...
      FROM (
        ...
        SELECT
          ...
          , SUM(subq_14.__views) AS __views
        FROM (
          ...
          FROM (
            -- Join Standard Outputs
            SELECT
              subq_12.capacity_latest AS listing__capacity_latest
    ...
    ON
      (
        subq_8.listing__capacity_latest = subq_16.listing__capacity_latest
      ) AND (
        subq_8.metric_time__day = subq_16.metric_time__day
      )
    GROUP BY
      COALESCE(subq_8.metric_time__day, subq_16.metric_time__day)
      , COALESCE(subq_8.listing__capacity_latest, subq_16.listing__capacity_latest)
  ) subq_17
  ORDER BY subq_17.metric_time__day DESC, subq_17.listing__capacity_latest, subq_17.bookings DESC, subq_17.views
  LIMIT 10
) subq_18
