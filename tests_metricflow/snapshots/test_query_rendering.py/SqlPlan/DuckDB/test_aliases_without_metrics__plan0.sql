...
SELECT
  subq_5.listing_id
  , subq_5.listing_capacity
FROM (
  -- Change Column Aliases
  SELECT
    subq_4.listing__capacity_latest AS listing_capacity
    , subq_4.listing AS listing_id
  FROM (
    ...
    ORDER BY subq_3.listing__capacity_latest, subq_3.listing
  ) subq_4
) subq_5
