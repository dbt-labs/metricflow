...
SELECT
  ...
  , CAST(nr_subq_9.booking_value_with_is_instant_constraint AS DOUBLE PRECISION) / CAST(NULLIF(nr_subq_9.booking_value, 0) AS DOUBLE PRECISION) AS instant_booking_value_ratio
FROM (
