          ...
          FROM (
            ...
            FROM (
              SELECT
                ...
                , toStartOfWeek(time_spine_src_26006.ds, 1) AS ds__week
                , toStartOfMonth(time_spine_src_26006.ds) AS ds__month
                , toStartOfQuarter(time_spine_src_26006.ds) AS ds__quarter
                , toStartOfYear(time_spine_src_26006.ds) AS ds__year
                , toYear(time_spine_src_26006.ds) AS ds__extract_year
