          ...
          FROM (
            ...
            FROM (
              SELECT
                ...
                , toDayOfWeek(id_verifications_src_28000.ds, 0) AS ds__extract_dow
                ...
                , toDayOfWeek(id_verifications_src_28000.ds_partitioned, 0) AS ds_partitioned__extract_dow
                ...
                , toDayOfWeek(id_verifications_src_28000.ds, 0) AS verification__ds__extract_dow
                ...
                , toDayOfWeek(id_verifications_src_28000.ds_partitioned, 0) AS verification__ds_partitioned__extract_dow
