...
FROM (
  SELECT
    ...
    , CAST(subq_12.booking_value_with_is_instant_constraint AS Nullable(Float64)) / CAST(NULLIF(subq_12.booking_value, 0) AS Nullable(Float64)) AS instant_booking_value_ratio
  FROM (
    SELECT
