          ...
          FROM (
            ...
            FROM (
              ...
              SELECT
                ...
                , IF(EXTRACT(DOW FROM id_verifications_src_28000.ds) = 1, 7, EXTRACT(DOW FROM id_verifications_src_28000.ds) - 1) AS ds__extract_dow
                ...
                , IF(EXTRACT(DOW FROM id_verifications_src_28000.ds_partitioned) = 1, 7, EXTRACT(DOW FROM id_verifications_src_28000.ds_partitioned) - 1) AS ds_partitioned__extract_dow
                ...
                , IF(EXTRACT(DOW FROM id_verifications_src_28000.ds) = 1, 7, EXTRACT(DOW FROM id_verifications_src_28000.ds) - 1) AS verification__ds__extract_dow
                ...
                , IF(EXTRACT(DOW FROM id_verifications_src_28000.ds_partitioned) = 1, 7, EXTRACT(DOW FROM id_verifications_src_28000.ds_partitioned) - 1) AS verification__ds_partitioned__extract_dow
