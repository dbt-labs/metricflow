                ...
                FROM (
                  ...
                  FROM (
                    ...
                    SELECT
                      ...
                      , IF(EXTRACT(DOW FROM customer_table_src_22000.ds_partitioned) = 1, 7, EXTRACT(DOW FROM customer_table_src_22000.ds_partitioned) - 1) AS ds_partitioned__extract_dow
                      ...
                      , IF(EXTRACT(DOW FROM customer_table_src_22000.ds_partitioned) = 1, 7, EXTRACT(DOW FROM customer_table_src_22000.ds_partitioned) - 1) AS customer_id__ds_partitioned__extract_dow
