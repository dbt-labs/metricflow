              ...
              LEFT OUTER JOIN (
                ...
                FROM (
                  ...
                  SELECT
                    ...
                    , IF(EXTRACT(DOW FROM lux_listings_src_26000.valid_from) = 1, 7, EXTRACT(DOW FROM lux_listings_src_26000.valid_from) - 1) AS window_start__extract_dow
                    ...
                    , IF(EXTRACT(DOW FROM lux_listings_src_26000.valid_to) = 1, 7, EXTRACT(DOW FROM lux_listings_src_26000.valid_to) - 1) AS window_end__extract_dow
                    ...
                    , IF(EXTRACT(DOW FROM lux_listings_src_26000.valid_from) = 1, 7, EXTRACT(DOW FROM lux_listings_src_26000.valid_from) - 1) AS lux_listing__window_start__extract_dow
                    ...
                    , IF(EXTRACT(DOW FROM lux_listings_src_26000.valid_to) = 1, 7, EXTRACT(DOW FROM lux_listings_src_26000.valid_to) - 1) AS lux_listing__window_end__extract_dow
