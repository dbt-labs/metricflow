        ...
        FULL OUTER JOIN (
          ...
          FROM (
            ...
            SELECT
              ...
              , IF(EXTRACT(DOW FROM users_latest_src_28000.ds) = 1, 7, EXTRACT(DOW FROM users_latest_src_28000.ds) - 1) AS ds_latest__extract_dow
              ...
              , IF(EXTRACT(DOW FROM users_latest_src_28000.ds) = 1, 7, EXTRACT(DOW FROM users_latest_src_28000.ds) - 1) AS user__ds_latest__extract_dow
