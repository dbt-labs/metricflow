            ...
            FROM (
              ...
              FROM (
                ...
                SELECT
                  ...
                  , IF(EXTRACT(DOW FROM accounts_source_src_28000.ds) = 1, 7, EXTRACT(DOW FROM accounts_source_src_28000.ds) - 1) AS ds__extract_dow
                  ...
                  , IF(EXTRACT(DOW FROM accounts_source_src_28000.ds) = 1, 7, EXTRACT(DOW FROM accounts_source_src_28000.ds) - 1) AS account__ds__extract_dow
