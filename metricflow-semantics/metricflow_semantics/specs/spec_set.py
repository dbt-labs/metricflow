...
class _GroupSpecByTypeVisitor(InstanceSpecVisitor[None]):
    ...
    measure_specs: List[SimpleMetricInputSpec] = dataclasses.field(default_factory=list)
    ...
    @override
    def visit_measure_spec(self, measure_spec: SimpleMetricInputSpec) -> None:
...
def group_specs_by_type(specs: Iterable[InstanceSpec]) -> InstanceSpecSet:
    ...
    return InstanceSpecSet(
        ...
        simple_metric_input_specs=tuple(grouper.measure_specs),
