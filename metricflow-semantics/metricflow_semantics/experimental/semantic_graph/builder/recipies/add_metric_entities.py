...
# from metricflow_semantics.experimental.semantic_graph.builder.recipies.metric_adjacency import \
#     MetricAdjacencyLookup, MetricAdjacencyResult
# from metricflow_semantics.experimental.semantic_graph.graph_nodes import EntityNode, SpecialNodeEnum, QueryEntityNode, \
#     CompositeEntityNode
# from metricflow_semantics.experimental.semantic_graph.graph_path.path_property import AppendLeftSource
# from metricflow_semantics.experimental.semantic_graph.ids.attribute_ids import MetricAttributeId
# from metricflow_semantics.experimental.semantic_graph.ids.entity_ids import CompositeEntityId
...
#             semantic_graph.add_entity_node_for_semantic_manifest_entity(
#                 entity_id=entity_id,
#                 node=entity_node,
#             )
...
#             return
#
#         metric_time_node = semantic_graph.get_by_node_id(SpecialNodeEnum.METRIC_TIME.value.):
...
#             entity_node = EntityNode.get_instance(entity_id)
#             semantic_graph.add_entity_node_for_semantic_manifest_entity(entity_id, entity_node)
#             semantic_graph.add_edge(
#                 tail_node=metric_attribute_node,
#                 head_node=entity_node,
#                 join_operations=tuple(
...
#
#         composite_entity_node = semantic_graph.get_by_node_id(composite_entity_id)
#         if composite_entity_node is None:
#             composite_entity_node = EntityNode.get_instance(composite_entity_id)
#             semantic_graph.add_composite_entity_node(
