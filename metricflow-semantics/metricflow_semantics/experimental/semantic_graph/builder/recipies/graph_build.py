...
# from metricflow_semantics.experimental.semantic_graph.graph_nodes import SemanticGraphNode, AttributeNode
#
#
...
#
#     def __init__(self, semantic_graph: InProgressSemanticGraph, path_requirement: SemanticGraphPathRequirement) -> None:
