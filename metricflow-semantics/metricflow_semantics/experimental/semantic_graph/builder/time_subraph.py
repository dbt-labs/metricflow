...
#     EntityAttributeEdge,
# )
# from metricflow_semantics.experimental.semantic_graph.nodes.entity_node import TimeDimensionNode
...
#     def _generate_edges_for_time_dimension(self, time_dimension_node: TimeDimensionNode) -> Sequence[SemanticGraphEdge]:
#         edges_to_add = []
#         node_time_grain = TimeGranularity(time_dimension_node.time_grain_name)
#
...
#             attribute_node = SemanticGraphNodeFactory.get_time_grain_attribute_node(time_grain)
#             edges_to_add.append(
...
#                 attribute_node = SemanticGraphNodeFactory.get_attribute_node_for_expanded_time_grain(
#                     expanded_time_grain
#                 )
#                 edges_to_add.append(
#                     EntityAttributeEdge.get_instance(
