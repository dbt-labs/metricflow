...
class DsiEntityNode(SemanticGraphNode):
    ...
    def as_dot_node(self, include_graphical_attributes: bool) -> DotNodeAttributeSet:
        return (
            super(DsiEntityNode, self)
            .as_dot_node(include_graphical_attributes)
            .merge(
                DotNodeAttributeSet.create(name=self.node_descriptor.node_name, color=DotColor.CORNFLOWER_BLUE),
            )
        )
    ...
    def attribute_computation_update(self) -> AttributeComputationUpdate:
        return AttributeComputationUpdate(
            dundered_name_element_addition=self.entity_name,
        )
...
class JoinToModelNode(SemanticGraphNode):
    ...
    @cached_property
    def attribute_computation_update(self) -> AttributeComputationUpdate:
        return AttributeComputationUpdate(derived_from_model_id_addition=self.model_id)
...
class MetricTimeDimensionNode(TimeDimensionNode):
    ...
    def attribute_computation_update(self) -> AttributeComputationUpdate:
        return AttributeComputationUpdate(
            dundered_name_element_addition=self.dimension_name,
            linkable_element_property_additions=FrozenOrderedSet((LinkableElementProperty.METRIC_TIME,)),
        )
...
class GroupByAttributeRootNode(SemanticGraphNode):
    ...
    def as_dot_node(self, include_graphical_attributes: bool) -> DotNodeAttributeSet:
        return (
            super(GroupByAttributeRootNode, self)
            .as_dot_node(include_graphical_attributes)
            .merge(
                DotNodeAttributeSet.create(name=self.node_descriptor.node_name, color=DotColor.GOLD),
            )
        )
