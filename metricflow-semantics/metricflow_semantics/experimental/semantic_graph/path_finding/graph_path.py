...
from typing import Generic, Optional, Sequence, override
...
@dataclass
class MutableMetricflowGraphPath(Generic[NodeT, EdgeT], MetricflowGraphPath[NodeT, EdgeT]):
    _nodes: list[NodeT]
    _edges: list[EdgeT]
    ...
    @classmethod
    def create(cls) -> MutableMetricflowGraphPath:
    ...
    @property
    def current_path(self) -> MetricflowGraphPath[NodeT, EdgeT]:
        return self
