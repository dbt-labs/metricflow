...
class MutablePathFinderStat(PathFinderStat):
    ...
    def increment_node_visit_count(self) -> None:
        self._visited_nodes_count += 1

    def increment_edge_examined_count(self) -> None:
        self._examined_edges_count += 1

    def increment_generated_paths_count(self) -> None:
        self._generated_paths_count += 1
