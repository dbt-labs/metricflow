...
class DsiEntityKeyQueryGroup:
    ...
    def intersection(key_query_groups: Sequence[DsiEntityKeyQueryGroup]) -> DsiEntityKeyQueryGroup:
        ...
        for key_query_grouping in key_query_groups:
            if common_key_queries is None:
                ...
                common_key_queries.intersection_update(
                    set(
                        key_query_set
                        for _, key_query_set in key_query_grouping.pairs_of_model_id_tuple_and_key_query_tuple
                    )
                )
        ...
        return DsiEntityKeyQueryGroup.create(model_id_set_by_key_query)
    ...
    def filter_by_key_name(self, key_name: str) -> DsiEntityKeyQueryGroup:
        ...
        return DsiEntityKeyQueryGroup(pairs_of_model_id_tuple_and_key_query_tuple=pairs_with_empty_key_queries_removed)
