...
class GroupByMetricTrieResolver(DunderNameTrieResolver):
    ...
    def _resolve_trie(
        ...
        entity_key_trie: DunderNameTrie = MutableDunderNameTrie.intersection_merge(
            tuple(
...
class _MetricNameToEntityKeyTrieGenerator:
    ...
    def _get_entity_key_trie_for_metric_node(
        ...
        dunder_name_trie = MutableDunderNameTrie.intersection_merge(key_query_sets_to_intersect)
    ...
    def generate(self) -> Mapping[str, MutableDunderNameTrie]:
        ...
        for base_metric_node in base_metric_nodes:
            ...
            dunder_name_trie = MutableDunderNameTrie.intersection_merge(entity_key_trie_intersection_list)
