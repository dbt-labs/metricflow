...
class DunderNameDescriptor:
    ...
    def union(self, other: DunderNameDescriptor) -> DunderNameDescriptor:
        ...
        # with the construction of the trie. I hesitated on adding those checks due to potential performance
        # considerations, but it seems useful to run those when the  `__debug__` flag is set.
