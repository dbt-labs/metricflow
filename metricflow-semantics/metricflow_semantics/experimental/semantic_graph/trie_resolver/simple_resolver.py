...
class SimpleTrieResolver(DunderNameTrieResolver):
    ...
    def _resolve_trie_for_source_nodes(
        ...
        result_trie = MutableDunderNameTrie.intersection(
            tuple(
    ...
    def _resolve_trie_from_node(
        ...
        # separately for each successor edge.
            ...
            union_result = MutableDunderNameTrie.union((result_from_local_model_node, result_from_metric_time))
            ...
            return MutableDunderNameTrie.union((result_from_local_model_node, result_from_metric_time))
        else:
            raise MetricflowInternalError(
                LazyFormat(
