...
#     EntityNode,
# )
# from metricflow_semantics.experimental.semantic_graph_old.time_nodes import TimeEntityNodeEnum2, TimeEntityNodeEnum
#
...
#         )
#
#         semantic_graph_old.nodes.add(dimension_entity_node)
#
...
#         semantic_graph_old.nodes.add(dimension_attribute_node)
#         semantic_model_reference = semantic_model.reference
#         for entity_reference in cardinality_one_entity_references:
#             semantic_graph_old.add_edge(
#                 tail_node=EntityNode(entity_reference),
