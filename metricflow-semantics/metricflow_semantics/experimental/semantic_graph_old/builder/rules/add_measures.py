...
#     SemanticGraphRecipe,
# )
# from metricflow_semantics.experimental.semantic_graph_old.computation_method import (
...
# )
# from metricflow_semantics.experimental.semantic_graph_old.graph_nodes import (
#     EntityNode,
#     MeasureNode,
# )
# from metricflow_semantics.experimental.semantic_graph_old.time_nodes import TimeEntityNodeEnum2
#
...
#                 aggregation_dimension_reference = self._semantic_model_lookup.get_agg_time_dimension_for_measure(
#                     measure.reference
#                 ).dimension_reference
#
#                 measure_node = MeasureNode(measure.reference)
#                 computation_method = CoLocatedComputationMethod(
#                     semantic_model_reference=semantic_model.reference,
#                     element_reference=aggregation_dimension_reference,
#                 )
#
...
#                     edge_type=SemanticGraphEdgeType.MEASURE_ATTRIBUTE,
#                     head_node=measure_node,
#                     computation_method=computation_method,
#                     required_tags=RequiredTagSet.empty_set(),
#                     provided_tags=ProvidedEdgeTagSet.empty_set(),
#                 )
...
#                     tail_node=measure_node,
#                     edge_type=SemanticGraphEdgeType.ATTRIBUTE_SOURCE,
#                     head_node=TimeEntityNodeEnum2.METRIC_TIME_ENTITY_NODE.value,
#                     computation_method=computation_method,
#                     required_tags=RequiredTagSet.empty_set(),
