...
class SemanticManifestLookup:
    ...
    def __init__(self, semantic_manifest: SemanticManifest) -> None:  # noqa: D107
        ...
        self.time_spine_sources = TimeSpineSource.build_standard_time_spine_sources(semantic_manifest)
        self.custom_granularities = TimeSpineSource.build_custom_granularities(list(self.time_spine_sources.values()))
