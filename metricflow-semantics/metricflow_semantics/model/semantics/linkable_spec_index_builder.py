...
class LinkableSpecIndexBuilder:
    """Builds a `LinkableSpecIndex` - see associated docstring."""
    ...
    def __init__(
        ...
        Args:
            ...
            manifest_object_lookup: Retrieves semantic manifest objects.
        ...
        self._linkable_spec_index = LinkableSpecIndex(
            metric_to_linkable_element_sets=defaultdict(list),
            no_metric_linkable_element_set=LinkableElementSet(),
            joinable_metrics_for_entities=defaultdict(set),
            semantic_model_reference_to_joined_elements={},
            semantic_model_reference_to_local_elements={},
            measure_to_metric_time_elements={},
        )
    ...
    def build_index(self) -> LinkableSpecIndex:  # noqa: D102
        ...
        for metric in self._semantic_manifest.metrics:
            ...
            self._linkable_spec_index.metric_to_linkable_element_sets[metric.name] = linkable_sets_for_measure
        ...
        for metric in self._semantic_manifest.metrics:
            ...
            for linkable_entities in linkable_element_set_for_metric.path_key_to_linkable_entities.values():
                for linkable_entity in linkable_entities:
                    ...
                    self._linkable_spec_index.joinable_metrics_for_entities[linkable_entity.reference].add(
    ...
    def _get_elements_in_semantic_model(self, semantic_model: SemanticModel) -> LinkableElementSet:
        ...
        result = self._linkable_spec_index.semantic_model_reference_to_local_elements.get(semantic_model_reference)
        ...
        self._linkable_spec_index.semantic_model_reference_to_local_elements[semantic_model.reference] = result
        return result
    ...
    def _get_semantic_models_with_joinable_entity(
        ...
        semantic_models = self._manifest_object_lookup.get_semantic_models_containing_entity(entity_reference)
    ...
    def _get_metric_time_elements(self, measure_reference: Optional[MeasureReference] = None) -> LinkableElementSet:
        ...
        """
        result = self._linkable_spec_index.measure_to_metric_time_elements.get(measure_reference)
        if result is not None:
            return result
    ...
    def _get_joined_elements(self, measure_semantic_model_reference: SemanticModelReference) -> LinkableElementSet:
        ...
        self._linkable_spec_index.semantic_model_reference_to_joined_elements[measure_semantic_model_reference] = result
        return result
    ...
    def _get_joined_elements_without_cache(
        ...
        measure_semantic_model = self._manifest_object_lookup.get_semantic_model_by_reference(
            measure_semantic_model_reference
        )
            ...
            if not element_sets:
                raise UnknownMetricLinkingError(
                    LazyFormat(
                        ...
                        metric_reference=metric_reference,
                        known_metrics=[key for key in self._linkable_spec_index.metric_to_linkable_element_sets.keys()],
