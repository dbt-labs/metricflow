...
class ValidLinkableSpecResolver:
    ...
    def _generate_linkable_time_dimensions(
        ...
        # Build linkable dimensions for all compatible standard granularities.
        linkable_dimensions = []
        ...
        # Build linkable dimensions for all compatible date parts granularities.
        for date_part in DatePart:
            if defined_time_granularity.to_int() <= date_part.to_int():
                expanded_granularity = ExpandedTimeGranularity.from_time_granularity(defined_time_granularity)
