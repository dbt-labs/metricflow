...
from metricflow_semantics.helpers.performance_helpers import ExecutionTime, ExecutionTimer
...
from tests_metricflow_semantics.experimental.semantic_graph.table_helpers import TextTableComparisonHelper
...
class SemanticGraphTester:
    ...
    def assert_linkable_element_sets_equal(  # noqa: D102
        ...
        comparison_helper = TextTableComparisonHelper()
    ...
    def assert_initialization_performance_factor(self, min_performance_factor: float) -> None:  # noqa: D102
...
class _ResolutionTimePair:
    ...
    time_for_legacy_resolver: ExecutionTime
    time_for_sg_resolver: ExecutionTime

    @staticmethod
    def sum(resolution_times: Iterable[_ResolutionTimePair]) -> _ResolutionTimePair:  # noqa: D102
        return _ResolutionTimePair(
            time_for_legacy_resolver=ExecutionTime.sum(t.time_for_legacy_resolver for t in resolution_times),
            time_for_sg_resolver=ExecutionTime.sum(t.time_for_sg_resolver for t in resolution_times),
        )
