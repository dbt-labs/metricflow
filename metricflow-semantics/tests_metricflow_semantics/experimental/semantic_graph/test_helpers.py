...
class SemanticGraphTestFixture:
    ...
    @property
    def snapshot_configuration(self) -> SnapshotConfiguration:
    ...
    @cached_property
    def manifest_object_lookup(self) -> ManifestObjectLookup:
        return ManifestObjectLookup(self._semantic_manifest)

    def create_path_finder(self) -> RecipeWriterPathfinder:
        return MetricflowPathfinder()

    @cached_property
    def _path_finder(self) -> RecipeWriterPathfinder:
        return self.create_path_finder()
    ...
    def create_sg_resolver(self) -> SemanticGraphLinkableSpecResolver:
    ...
    @cached_property
    def legacy_resolver(self) -> LegacyLinkableSpecResolver:
        return self.create_legacy_resolver()

    def create_legacy_resolver(self) -> LegacyLinkableSpecResolver:
    ...
    @property
    def path_finder(self) -> MetricflowPathfinder[SemanticGraphNode, SemanticGraphEdge, AttributeRecipeWriterPath]:
...
class SemanticGraphTester:
    ...
    @property
    def _path_finder(self) -> RecipeWriterPathfinder:
        return self._fixture.path_finder
