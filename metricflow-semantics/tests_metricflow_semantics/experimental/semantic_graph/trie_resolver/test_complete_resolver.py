...
def test_measure(
    ...
    resolver = CompleteTrieResolver(semantic_graph=semantic_graph, path_finder=fixture.path_finder)
...
def test_metric(
    ...
    semantic_graph = fixture.semantic_graph
    resolver = SimpleTrieResolver(semantic_graph=semantic_graph, path_finder=fixture.path_finder)
