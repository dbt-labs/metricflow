...
def test_create() -> None:  # noqa: D103
    example_set = MutableOrderedSet.create_from_items(1, 2, 3, 2, 1)
...
def test_equality() -> None:  # noqa: D103
    a = MutableOrderedSet.create_from_items(1, 2, 3)
    b = MutableOrderedSet.create_from_items(3, 2, 1)
    assert a == b
...
def test_intersection() -> None:  # noqa: D103
    left = MutableOrderedSet.create_from_items(1, 2, 3)
    right = {1, 2}
...
def test_union() -> None:  # noqa: D103
    left = MutableOrderedSet.create_from_items(1, 2)
    right = [3, 2]
...
def test_operators() -> None:  # noqa: D103
    left = MutableOrderedSet.create_from_items(1, 2, 3)
    right = MutableOrderedSet.create_from_items(1, 3, 4)
...
def test_eq() -> None:  # noqa: D103
    assert MutableOrderedSet.create_from_items(1) == FrozenOrderedSet.create_from_items(1)
