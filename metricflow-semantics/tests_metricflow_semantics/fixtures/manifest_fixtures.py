...
@pytest.fixture(scope="session")
def sg_00_minimal_manifest_lookup(
    sg_00_minimal_manifest: PydanticSemanticManifest,
) -> ManifestObjectLookup:  # noqa: D103
    return ManifestObjectLookup(sg_00_minimal_manifest)
...
@pytest.fixture(scope="session")
def sg_01_primary_entity_defined_lookup(
    sg_01_primary_entity_defined: PydanticSemanticManifest,
) -> ManifestObjectLookup:  # noqa: D103
    return ManifestObjectLookup(sg_01_primary_entity_defined)
