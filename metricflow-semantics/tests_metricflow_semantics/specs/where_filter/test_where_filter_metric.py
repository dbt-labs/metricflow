...
class TestWhereFilterMetric:
    def test_metric_time_inheritance(self) -> None:
        """Test that WhereFilterMetric correctly inherits time granularity when metric_time is in group_by."""
        # Create mocks
        ...
        column_association_resolver.resolve_spec.return_value = ColumnAssociation(
            column_name="bookings__month_column"
        )
        ...
        # Create the WhereFilterMetric with metric_time in group_by
