...
class FileSlice(Protocol):
    ...
    @property
    @abstractmethod
    def start_line_number(self) -> int:  # noqa: D102
        pass

    @property
    @abstractmethod
    def end_line_number(self) -> int:  # noqa: D102
        pass
...
class Metadata(Protocol):
    ...
    @property
    @abstractmethod
    def repo_file_path(self) -> str:  # noqa: D102
        pass

    @property
    @abstractmethod
    def file_slice(self) -> FileSlice:  # noqa: D102
        pass
