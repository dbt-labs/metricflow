...
class DataflowToSqlQueryPlanConverter(Generic[SqlDataSetT], DataflowPlanNodeVisitor[SqlDataSetT, SqlDataSet]):
    ...
    def visit_compute_metrics_node(self, node: ComputeMetricsNode) -> SqlDataSet:
        ...
        for metric_spec in node.metric_specs:
            ...
            if metric.type is MetricType.RATIO:
                ...
                base_measure = metric.conversion_type_params.base_measure
                conversion_measure = metric.conversion_type_params.conversion_measure
                assert (
                ...
                calculation_type = metric.conversion_type_params.calculation
    ...
    def visit_add_generated_uuid_column_node(self, node: AddGeneratedUuidColumnNode) -> SqlDataSet:
        ...
        output_column_association = self._column_association_resolver.resolve_metadata_spec(gen_uuid_spec)
