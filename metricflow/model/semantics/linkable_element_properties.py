...
class LinkableElementProperties(Enum):
    ...
    Local means an element that is defined within the same entity as the measure. This definition is used
    ...
    # An element that was joined to the measure entity by an identifier.
    JOINED = "joined"
    # An element that was joined to the measure entity by joining multiple entities.
    MULTI_HOP = "multi_hop"
    # A time dimension that is a version of a time dimension in a entity, but at a different granularity.
