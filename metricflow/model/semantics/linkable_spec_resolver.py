...
class LinkableMetric:
    ...
    def __post_init__(self) -> None:  # noqa: D105
        assert {LinkableElementProperties.METRIC, LinkableElementProperties.JOINED}.issubset(self.properties)
...
class SemanticModelJoinPathElement:
    """Describes joining to a semantic model by the given entity."""
...
class MetricSubqueryJoinPathElement:
    """Describes joining to a metric subquery by the given entity."""
...
class ValidLinkableSpecResolver:
    ...
    def get_joinable_metrics_for_semantic_model(
        ...
        if using_join_path:
            ...
            properties = properties.union(frozenset({LinkableElementProperties.MULTI_HOP}))
    ...
    def get_joinable_metrics_for_entity(self, entity_reference: EntityReference) -> Set[MetricReference]:
        ...
        return self._joinable_metrics_for_entities[entity_reference]
