...
class MaxWidthTracker:
    """Helps the number columns remaining as the DAG is formatted to text recursively.

    This is needed as the parents of a given node are formatted with an indent.
    """
    ...
    def update_max_width_for_indented_section(self, indent_prefix: str) -> Iterator[None]:
        """Context manager used to wrap formatting of indented sections."""
