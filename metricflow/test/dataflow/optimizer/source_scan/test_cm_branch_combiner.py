...
def test_read_sql_source_combination(  # noqa: D
    ...
    source0 = mf_engine_test_fixture_mapping[SemanticManifestName.SIMPLE_MANIFEST].read_node_mapping["bookings_source"]
    source1 = mf_engine_test_fixture_mapping[SemanticManifestName.SIMPLE_MANIFEST].read_node_mapping["bookings_source"]
