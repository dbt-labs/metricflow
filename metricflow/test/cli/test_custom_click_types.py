...
def test_check_min_length():
    ...
    ltype = SequenceParamType(min_length=2)
...
def test_check_max_length():
    ...
    ltype = SequenceParamType(max_length=2)
    ltype.convert("1,2", None, None)
    with pytest.raises(click.BadParameter):
...
def test_use_value_converter():
    ...
    ltype = SequenceParamType(value_converter=lambda x_str: int(x_str))
...
def test_use_separator():
    ...
    ltype = SequenceParamType(separator=":")
