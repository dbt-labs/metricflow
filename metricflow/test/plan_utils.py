...
def replace_dataset_id_hash(text: str) -> str:
    """Replaces data set ID hashes for primed entities.

    The data set ID hash changes from run to run because it's based on the DW schema in the entity, which changes
    run to run.
    """
