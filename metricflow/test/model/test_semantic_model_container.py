...
@pytest.fixture
def semantic_model_semantics(simple_user_configured_model: SemanticManifest) -> SemanticModelSemantics:  # Noqa: D
...
def metric_semantics(  # Noqa: D
    simple_user_configured_model: SemanticManifest, semantic_model_semantics: SemanticModelSemantics
) -> MetricSemantics:
