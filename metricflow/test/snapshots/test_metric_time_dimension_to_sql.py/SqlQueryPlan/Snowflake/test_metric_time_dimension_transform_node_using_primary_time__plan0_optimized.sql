...
SELECT
  ...
  , EXTRACT(dayofweekiso FROM ds) AS ds__extract_dow
  ...
  , EXTRACT(dayofweekiso FROM ds_partitioned) AS ds_partitioned__extract_dow
  ...
  , EXTRACT(dayofweekiso FROM ds) AS booking__ds__extract_dow
  ...
  , EXTRACT(dayofweekiso FROM ds_partitioned) AS booking__ds_partitioned__extract_dow
  ...
  , EXTRACT(dayofweekiso FROM paid_at) AS booking__paid_at__extract_dow
