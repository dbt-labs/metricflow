...
FROM (
      ...
      FROM (
        ...
        FROM (
          ...
          SELECT
            ...
            , EXTRACT(DAY_OF_WEEK FROM time_spine_src_10000.ds) AS ds__extract_dow
  ...
  WHERE subq_6.metric_time__day BETWEEN timestamp '2020-01-01' AND timestamp '2020-01-03'
) subq_7
GROUP BY
  subq_7.metric_time__day
  , subq_7.listing__is_lux_latest
