...
SELECT
  ...
  , subq_0.booking_paid_at AS __ts
  , subq_0.booking_paid_at__week AS __ts__week
  , subq_0.booking_paid_at__month AS __ts__month
  , subq_0.booking_paid_at__quarter AS __ts__quarter
  , subq_0.booking_paid_at__year AS __ts__year
  , subq_0.listing
  , subq_0.guest
  , subq_0.host
