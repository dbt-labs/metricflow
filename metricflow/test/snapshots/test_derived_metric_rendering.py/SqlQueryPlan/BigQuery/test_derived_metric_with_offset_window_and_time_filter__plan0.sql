        ...
        FROM (
          ...
          FROM (
            ...
            SELECT
              ...
              , DATE_TRUNC(subq_8.metric_time__day, isoweek) AS metric_time__week
              , DATE_TRUNC(subq_8.metric_time__day, month) AS metric_time__month
              , DATE_TRUNC(subq_8.metric_time__day, quarter) AS metric_time__quarter
              , DATE_TRUNC(subq_8.metric_time__day, year) AS metric_time__year
              , EXTRACT(year FROM DATE_TRUNC(subq_8.metric_time__day, day)) AS metric_time__extract_year
              ...
              , IF(EXTRACT(dayofweek FROM subq_8.metric_time__day) = 1, 7, EXTRACT(dayofweek FROM subq_8.metric_time__day) - 1) AS metric_time__extract_dow
              , EXTRACT(dayofyear FROM subq_8.metric_time__day) AS metric_time__extract_doy
