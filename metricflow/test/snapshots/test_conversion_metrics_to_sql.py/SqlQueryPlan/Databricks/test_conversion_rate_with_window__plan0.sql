      ...
      FROM (
        ...
        FROM (
          ...
          SELECT
            ...
            , EXTRACT(DAYOFWEEK_ISO FROM visits_source_src_10011.ds) AS ds__extract_dow
            ...
            , EXTRACT(DAYOFWEEK_ISO FROM visits_source_src_10011.ds) AS visit__ds__extract_dow
            ...
            FROM (
              ...
              FROM (
                ...
                SELECT
                  ...
                  , EXTRACT(DAYOFWEEK_ISO FROM buys_source_src_10002.ds) AS ds__extract_dow
                  ...
                  , EXTRACT(DAYOFWEEK_ISO FROM buys_source_src_10002.ds) AS buy__ds__extract_dow
