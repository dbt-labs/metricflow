      ...
      FROM (
        ...
        FROM (
          ...
          SELECT
            ...
            , EXTRACT(dayofweekiso FROM visits_source_src_10011.ds) AS ds__extract_dow
            ...
            , EXTRACT(dayofweekiso FROM visits_source_src_10011.ds) AS visit__ds__extract_dow
            ...
            FROM (
              ...
              FROM (
                ...
                SELECT
                  ...
                  , EXTRACT(dayofweekiso FROM buys_source_src_10002.ds) AS ds__extract_dow
                  ...
                  , EXTRACT(dayofweekiso FROM buys_source_src_10002.ds) AS buy__ds__extract_dow
