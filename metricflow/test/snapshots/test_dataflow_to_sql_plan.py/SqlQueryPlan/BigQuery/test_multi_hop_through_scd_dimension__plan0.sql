  ...
  FROM (
    ...
    FROM (
      ...
      SELECT
        ...
        , subq_7.window_end__extract_week AS listing__window_end__extract_week
      ...
      LEFT OUTER JOIN (
        ...
        SELECT
          ...
          , subq_6.window_end__extract_week
          , subq_6.listing
      ...
      ON
        (
          ...
          (
            ...
            (
              subq_2.metric_time__day < subq_7.window_end__extract_week
            ) OR (
              subq_7.window_end__extract_week IS NULL
            )
          )
        )
    ) subq_8
