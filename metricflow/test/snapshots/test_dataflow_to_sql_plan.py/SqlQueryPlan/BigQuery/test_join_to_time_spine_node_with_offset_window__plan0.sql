...
FROM (
  ...
  WHERE subq_6.ds BETWEEN CAST('2020-01-01' AS DATETIME) AND CAST('2021-01-01' AS DATETIME)
) subq_5
INNER JOIN (
...
ON
  DATE_SUB(CAST(subq_5.metric_time__day AS DATETIME), INTERVAL 10 day) = subq_4.metric_time__day
