        ...
        FROM (
          ...
          FROM (
            ...
            SELECT
              ...
              , EXTRACT(DAYOFYEAR FROM account_month_txns_src_10010.ds) AS ds__extract_dayofyear
              ...
              , EXTRACT(DAYOFYEAR FROM account_month_txns_src_10010.ds_partitioned) AS account_id__ds_partitioned__extract_dayofyear
              ...
              , EXTRACT(DAYOFYEAR FROM account_month_txns_src_10010.ds) AS account_id__ds__extract_dayofyear
        ...
        FROM (
          ...
          FROM (
            ...
            SELECT
              ...
              , EXTRACT(DAYOFYEAR FROM bridge_table_src_10011.ds_partitioned) AS ds_partitioned__extract_dayofyear
              ...
              , EXTRACT(DAYOFYEAR FROM bridge_table_src_10011.ds_partitioned) AS account_id__ds_partitioned__extract_dayofyear
          ...
          LEFT OUTER JOIN (
            ...
            FROM (
              ...
              SELECT
                ...
                , EXTRACT(DAYOFYEAR FROM customer_table_src_10013.ds_partitioned) AS customer_id__ds_partitioned__extract_dayofyear
