      ...
      FROM (
        ...
        FROM (
          ...
          LEFT OUTER JOIN (
            ...
            SELECT
              subq_3.window_start__extract_dayofyear
          ...
          ON
            (
              ...
              (
                subq_2.metric_time__day >= subq_4.window_start__extract_dayofyear
              ) AND (
                (
                  subq_2.metric_time__day < subq_4.window_end__extract_quarter
                ) OR (
                  subq_4.window_end__extract_quarter IS NULL
                )
              )
            )
        ) subq_5
