      ...
      FROM (
        ...
        FROM (
          ...
          SELECT
            ...
            , subq_4.window_start__extract_week AS listing__window_start__extract_week
          ...
          LEFT OUTER JOIN (
            ...
            SELECT
              subq_3.window_start__extract_week
          ...
          ON
            (
              ...
              (
                subq_2.metric_time__day >= subq_4.window_start__extract_week
              ) AND (
                (
