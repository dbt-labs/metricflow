...
FROM (
  ...
  SELECT
    ...
    , EXTRACT(dayofweekiso FROM accounts_source_src_10000.ds) AS ds__extract_dow
    ...
    , EXTRACT(dayofweekiso FROM accounts_source_src_10000.ds) AS account__ds__extract_dow
