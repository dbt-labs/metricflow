        ...
        FROM (
          ...
          FROM (
            ...
            SELECT
              ...
              , DATE_TRUNC(messages_source_src_10014.ds, isoweek) AS ds__week
              , DATE_TRUNC(messages_source_src_10014.ds, month) AS ds__month
              , DATE_TRUNC(messages_source_src_10014.ds, quarter) AS ds__quarter
              , DATE_TRUNC(messages_source_src_10014.ds, isoyear) AS ds__year
              , messages_source_src_10014.team_id
              , messages_source_src_10014.ds AS user_id__ds
              , DATE_TRUNC(messages_source_src_10014.ds, isoweek) AS user_id__ds__week
              , DATE_TRUNC(messages_source_src_10014.ds, month) AS user_id__ds__month
              , DATE_TRUNC(messages_source_src_10014.ds, quarter) AS user_id__ds__quarter
              , DATE_TRUNC(messages_source_src_10014.ds, isoyear) AS user_id__ds__year
      ...
      LEFT OUTER JOIN (
        ...
        FROM (
          ...
          SELECT
            ...
            , DATE_TRUNC(users_source_src_10016.created_at, isoweek) AS ds__week
            , DATE_TRUNC(users_source_src_10016.created_at, month) AS ds__month
            , DATE_TRUNC(users_source_src_10016.created_at, quarter) AS ds__quarter
            , DATE_TRUNC(users_source_src_10016.created_at, isoyear) AS ds__year
            , users_source_src_10016.team_id
            , users_source_src_10016.country
            , users_source_src_10016.created_at AS user_id__ds
            , DATE_TRUNC(users_source_src_10016.created_at, isoweek) AS user_id__ds__week
            , DATE_TRUNC(users_source_src_10016.created_at, month) AS user_id__ds__month
            , DATE_TRUNC(users_source_src_10016.created_at, quarter) AS user_id__ds__quarter
            , DATE_TRUNC(users_source_src_10016.created_at, isoyear) AS user_id__ds__year
            ...
            , DATE_TRUNC(users_source_src_10016.created_at, isoweek) AS user_composite_ident_2__ds__week
            , DATE_TRUNC(users_source_src_10016.created_at, month) AS user_composite_ident_2__ds__month
            , DATE_TRUNC(users_source_src_10016.created_at, quarter) AS user_composite_ident_2__ds__quarter
            , DATE_TRUNC(users_source_src_10016.created_at, isoyear) AS user_composite_ident_2__ds__year
            ...
            , DATE_TRUNC(users_source_src_10016.created_at, isoweek) AS user_team__ds__week
            , DATE_TRUNC(users_source_src_10016.created_at, month) AS user_team__ds__month
            , DATE_TRUNC(users_source_src_10016.created_at, quarter) AS user_team__ds__quarter
            , DATE_TRUNC(users_source_src_10016.created_at, isoyear) AS user_team__ds__year
