      ...
      FROM (
        ...
        FROM (
          ...
          SELECT
            ...
            , DATE_TRUNC(account_month_txns_src_0.ds_partitioned, isoweek) AS ds_partitioned__week
            , DATE_TRUNC(account_month_txns_src_0.ds_partitioned, month) AS ds_partitioned__month
            , DATE_TRUNC(account_month_txns_src_0.ds_partitioned, quarter) AS ds_partitioned__quarter
            , DATE_TRUNC(account_month_txns_src_0.ds_partitioned, isoyear) AS ds_partitioned__year
            , account_month_txns_src_0.ds
            , DATE_TRUNC(account_month_txns_src_0.ds, isoweek) AS ds__week
            , DATE_TRUNC(account_month_txns_src_0.ds, month) AS ds__month
            , DATE_TRUNC(account_month_txns_src_0.ds, quarter) AS ds__quarter
            , DATE_TRUNC(account_month_txns_src_0.ds, isoyear) AS ds__year
            , account_month_txns_src_0.account_month
            , account_month_txns_src_0.ds_partitioned AS account_id__ds_partitioned
            , DATE_TRUNC(account_month_txns_src_0.ds_partitioned, isoweek) AS account_id__ds_partitioned__week
            , DATE_TRUNC(account_month_txns_src_0.ds_partitioned, month) AS account_id__ds_partitioned__month
            , DATE_TRUNC(account_month_txns_src_0.ds_partitioned, quarter) AS account_id__ds_partitioned__quarter
            , DATE_TRUNC(account_month_txns_src_0.ds_partitioned, isoyear) AS account_id__ds_partitioned__year
            , account_month_txns_src_0.ds AS account_id__ds
            , DATE_TRUNC(account_month_txns_src_0.ds, isoweek) AS account_id__ds__week
            , DATE_TRUNC(account_month_txns_src_0.ds, month) AS account_id__ds__month
            , DATE_TRUNC(account_month_txns_src_0.ds, quarter) AS account_id__ds__quarter
            , DATE_TRUNC(account_month_txns_src_0.ds, isoyear) AS account_id__ds__year
        ...
        FROM (
          ...
          FROM (
            ...
            SELECT
              ...
              , DATE_TRUNC(bridge_table_src_1.ds_partitioned, isoweek) AS ds_partitioned__week
              , DATE_TRUNC(bridge_table_src_1.ds_partitioned, month) AS ds_partitioned__month
              , DATE_TRUNC(bridge_table_src_1.ds_partitioned, quarter) AS ds_partitioned__quarter
              , DATE_TRUNC(bridge_table_src_1.ds_partitioned, isoyear) AS ds_partitioned__year
              , bridge_table_src_1.extra_dim AS account_id__extra_dim
              , bridge_table_src_1.ds_partitioned AS account_id__ds_partitioned
              , DATE_TRUNC(bridge_table_src_1.ds_partitioned, isoweek) AS account_id__ds_partitioned__week
              , DATE_TRUNC(bridge_table_src_1.ds_partitioned, month) AS account_id__ds_partitioned__month
              , DATE_TRUNC(bridge_table_src_1.ds_partitioned, quarter) AS account_id__ds_partitioned__quarter
              , DATE_TRUNC(bridge_table_src_1.ds_partitioned, isoyear) AS account_id__ds_partitioned__year
          ...
          LEFT OUTER JOIN (
            ...
            FROM (
              ...
              SELECT
                ...
                , DATE_TRUNC(customer_table_src_3.ds_partitioned, isoweek) AS ds_partitioned__week
                , DATE_TRUNC(customer_table_src_3.ds_partitioned, month) AS ds_partitioned__month
                , DATE_TRUNC(customer_table_src_3.ds_partitioned, quarter) AS ds_partitioned__quarter
                , DATE_TRUNC(customer_table_src_3.ds_partitioned, isoyear) AS ds_partitioned__year
                ...
                , DATE_TRUNC(customer_table_src_3.ds_partitioned, isoweek) AS customer_id__ds_partitioned__week
                , DATE_TRUNC(customer_table_src_3.ds_partitioned, month) AS customer_id__ds_partitioned__month
                , DATE_TRUNC(customer_table_src_3.ds_partitioned, quarter) AS customer_id__ds_partitioned__quarter
                , DATE_TRUNC(customer_table_src_3.ds_partitioned, isoyear) AS customer_id__ds_partitioned__year
