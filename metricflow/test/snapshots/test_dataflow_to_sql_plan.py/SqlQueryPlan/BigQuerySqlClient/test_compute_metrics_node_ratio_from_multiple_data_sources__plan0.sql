...
SELECT
  CAST(subq_15.bookings AS FLOAT64) / CAST(NULLIF(subq_15.views, 0) AS FLOAT64) AS bookings_per_view
          ...
          FROM (
            ...
            FROM (
              ...
              SELECT
                ...
                , DATE_TRUNC(views_source_src_10008.ds, isoweek) AS ds__week
                , DATE_TRUNC(views_source_src_10008.ds, month) AS ds__month
                , DATE_TRUNC(views_source_src_10008.ds, quarter) AS ds__quarter
                , DATE_TRUNC(views_source_src_10008.ds, isoyear) AS ds__year
                , views_source_src_10008.ds_partitioned
                , DATE_TRUNC(views_source_src_10008.ds_partitioned, isoweek) AS ds_partitioned__week
                , DATE_TRUNC(views_source_src_10008.ds_partitioned, month) AS ds_partitioned__month
                , DATE_TRUNC(views_source_src_10008.ds_partitioned, quarter) AS ds_partitioned__quarter
                , DATE_TRUNC(views_source_src_10008.ds_partitioned, isoyear) AS ds_partitioned__year
                , views_source_src_10008.ds AS create_a_cycle_in_the_join_graph__ds
                , DATE_TRUNC(views_source_src_10008.ds, isoweek) AS create_a_cycle_in_the_join_graph__ds__week
                , DATE_TRUNC(views_source_src_10008.ds, month) AS create_a_cycle_in_the_join_graph__ds__month
                , DATE_TRUNC(views_source_src_10008.ds, quarter) AS create_a_cycle_in_the_join_graph__ds__quarter
                , DATE_TRUNC(views_source_src_10008.ds, isoyear) AS create_a_cycle_in_the_join_graph__ds__year
                , views_source_src_10008.ds_partitioned AS create_a_cycle_in_the_join_graph__ds_partitioned
                , DATE_TRUNC(views_source_src_10008.ds_partitioned, isoweek) AS create_a_cycle_in_the_join_graph__ds_partitioned__week
                , DATE_TRUNC(views_source_src_10008.ds_partitioned, month) AS create_a_cycle_in_the_join_graph__ds_partitioned__month
                , DATE_TRUNC(views_source_src_10008.ds_partitioned, quarter) AS create_a_cycle_in_the_join_graph__ds_partitioned__quarter
                , DATE_TRUNC(views_source_src_10008.ds_partitioned, isoyear) AS create_a_cycle_in_the_join_graph__ds_partitioned__year
