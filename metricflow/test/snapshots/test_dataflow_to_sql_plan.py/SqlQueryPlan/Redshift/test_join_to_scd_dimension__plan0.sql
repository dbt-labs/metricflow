      ...
      FROM (
        ...
        FROM (
          ...
          SELECT
            ...
            , subq_4.window_start__extract_year AS listing__window_start__extract_year
            , subq_4.window_end__extract_year AS listing__window_end__extract_year
          ...
          ON
            (
              ...
              (
                subq_2.metric_time__day >= subq_4.window_start__extract_year
              ) AND (
                (
                  subq_2.metric_time__day < subq_4.window_end__extract_year
                ) OR (
                  subq_4.window_end__extract_year IS NULL
                )
              )
            )
        ) subq_5
