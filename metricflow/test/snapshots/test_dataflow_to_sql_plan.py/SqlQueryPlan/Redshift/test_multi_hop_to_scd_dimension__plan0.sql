  ...
  FROM (
    ...
    FROM (
      ...
      SELECT
        ...
        , subq_7.lux_listing__window_start__extract_quarter AS listing__lux_listing__window_start__extract_quarter
        , subq_7.lux_listing__window_end__extract_dayofweek AS listing__lux_listing__window_end__extract_dayofweek
      ...
      LEFT OUTER JOIN (
        ...
        SELECT
          ...
          , subq_6.lux_listing__window_end__extract_dayofweek
          , subq_6.listing
      ...
      ON
        (
          ...
          (
            subq_2.metric_time__day >= subq_7.lux_listing__window_start__extract_quarter
          ) AND (
            (
              subq_2.metric_time__day < subq_7.lux_listing__window_end__extract_dayofweek
            ) OR (
              subq_7.lux_listing__window_end__extract_dayofweek IS NULL
            )
          )
        )
    ) subq_8
