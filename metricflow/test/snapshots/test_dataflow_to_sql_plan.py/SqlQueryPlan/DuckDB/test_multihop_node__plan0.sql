        ...
        FROM (
          ...
          FROM (
            ...
            SELECT
              ...
              , EXTRACT(isodow FROM account_month_txns_src_10010.ds_partitioned) AS ds_partitioned__extract_dow
              ...
              , EXTRACT(isodow FROM account_month_txns_src_10010.ds) AS ds__extract_dow
              ...
              , EXTRACT(isodow FROM account_month_txns_src_10010.ds_partitioned) AS account_id__ds_partitioned__extract_dow
              ...
              , EXTRACT(isodow FROM account_month_txns_src_10010.ds) AS account_id__ds__extract_dow
        ...
        FROM (
          ...
          FROM (
            ...
            SELECT
              ...
              , EXTRACT(isodow FROM bridge_table_src_10011.ds_partitioned) AS ds_partitioned__extract_dow
              ...
              , EXTRACT(isodow FROM bridge_table_src_10011.ds_partitioned) AS account_id__ds_partitioned__extract_dow
              ...
              , EXTRACT(isodow FROM bridge_table_src_10011.ds_partitioned) AS bridge_account__ds_partitioned__extract_dow
          ...
          LEFT OUTER JOIN (
            ...
            FROM (
              ...
              SELECT
                ...
                , EXTRACT(isodow FROM customer_table_src_10013.ds_partitioned) AS ds_partitioned__extract_dow
                ...
                , EXTRACT(isodow FROM customer_table_src_10013.ds_partitioned) AS customer_id__ds_partitioned__extract_dow
