  ...
  FROM (
    ...
    FROM (
      ...
      SELECT
        ...
        , subq_7.window_end__extract_quarter AS listing__window_end__extract_quarter
      ...
      ON
        (
          ...
          (
            ...
            (
              subq_2.metric_time__day < subq_7.window_end__extract_quarter
            ) OR (
              subq_7.window_end__extract_quarter IS NULL
            )
          )
        )
    ) subq_8
