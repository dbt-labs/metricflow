  ...
  FROM (
    ...
    FROM (
      ...
      SELECT
        ...
        , subq_7.window_start__extract_week AS listing__window_start__extract_week
        , subq_7.window_end__extract_dayofyear AS listing__window_end__extract_dayofyear
        ...
        FROM (
          ...
          FROM (
            ...
            SELECT
              ...
              , EXTRACT(DOY FROM bookings_source_src_10015.ds) AS ds__extract_dayofyear
              ...
              , EXTRACT(DOY FROM bookings_source_src_10015.ds_partitioned) AS ds_partitioned__extract_dayofyear
              ...
              , EXTRACT(DOY FROM bookings_source_src_10015.paid_at) AS paid_at__extract_dayofyear
              ...
              , EXTRACT(DOY FROM bookings_source_src_10015.ds) AS booking__ds__extract_dayofyear
              ...
              , EXTRACT(DOY FROM bookings_source_src_10015.ds_partitioned) AS booking__ds_partitioned__extract_dayofyear
              ...
              , EXTRACT(DOY FROM bookings_source_src_10015.paid_at) AS booking__paid_at__extract_dayofyear
      ...
      LEFT OUTER JOIN (
        ...
        SELECT
          subq_6.window_start__extract_week
          , subq_6.window_end__extract_dayofyear
          , subq_6.listing
        ...
        FROM (
          ...
          FROM (
            ...
            SELECT
              ...
              , EXTRACT(DOY FROM listings_src_10017.active_from) AS window_start__extract_dayofyear
              ...
              , EXTRACT(DOY FROM listings_src_10017.active_to) AS window_end__extract_dayofyear
              ...
              , EXTRACT(DOY FROM listings_src_10017.active_from) AS listing__window_start__extract_dayofyear
              ...
              , EXTRACT(DOY FROM listings_src_10017.active_to) AS listing__window_end__extract_dayofyear
          ...
          LEFT OUTER JOIN (
            ...
            FROM (
              ...
              SELECT
                ...
                , EXTRACT(DOY FROM users_latest_src_10021.ds) AS ds__extract_dayofyear
                ...
                , EXTRACT(DOY FROM users_latest_src_10021.ds) AS user__ds__extract_dayofyear
      ...
      ON
        (
          ...
          (
            subq_2.metric_time__day >= subq_7.window_start__extract_week
          ) AND (
            (
              subq_2.metric_time__day < subq_7.window_end__extract_dayofyear
            ) OR (
              subq_7.window_end__extract_dayofyear IS NULL
            )
          )
        )
    ) subq_8
