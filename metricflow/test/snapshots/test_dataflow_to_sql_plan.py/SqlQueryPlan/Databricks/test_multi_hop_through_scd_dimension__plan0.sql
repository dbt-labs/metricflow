  ...
  FROM (
    ...
    FROM (
      ...
      SELECT
        ...
        , subq_7.window_end__extract_dayofweek AS listing__window_end__extract_dayofweek
      ...
      LEFT OUTER JOIN (
        ...
        SELECT
          ...
          , subq_6.window_end__extract_dayofweek
          , subq_6.listing
      ...
      ON
        (
          ...
          (
            ...
            (
              subq_2.metric_time__day < subq_7.window_end__extract_dayofweek
            ) OR (
              subq_7.window_end__extract_dayofweek IS NULL
            )
          )
        )
    ) subq_8
