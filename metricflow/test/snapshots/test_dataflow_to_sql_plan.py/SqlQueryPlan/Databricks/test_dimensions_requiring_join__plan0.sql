  ...
  FULL OUTER JOIN (
    ...
    FROM (
      ...
      SELECT
        ...
        , EXTRACT(DAYOFWEEK_ISO FROM users_latest_src_10009.ds) AS ds_latest__extract_dow
        ...
        , EXTRACT(DAYOFWEEK_ISO FROM users_latest_src_10009.ds) AS user__ds_latest__extract_dow
