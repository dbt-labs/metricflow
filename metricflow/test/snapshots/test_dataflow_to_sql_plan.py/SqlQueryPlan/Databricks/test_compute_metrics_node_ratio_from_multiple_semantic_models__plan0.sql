            ...
            FROM (
              ...
              FROM (
                ...
                SELECT
                  ...
                  , EXTRACT(DOY FROM bookings_source_src_10001.ds) AS ds__extract_dayofyear
                  ...
                  , EXTRACT(DOY FROM bookings_source_src_10001.paid_at) AS paid_at__extract_dayofyear
                  ...
                  , EXTRACT(DOY FROM bookings_source_src_10001.ds) AS booking__ds__extract_dayofyear
                  ...
                  , EXTRACT(DOY FROM bookings_source_src_10001.ds_partitioned) AS booking__ds_partitioned__extract_dayofyear
                  ...
                  , EXTRACT(DOY FROM bookings_source_src_10001.paid_at) AS booking__paid_at__extract_dayofyear
          ...
          LEFT OUTER JOIN (
            ...
            FROM (
              ...
              SELECT
                ...
                , subq_3.ds__extract_dayofweek
                , subq_3.ds__extract_dayofyear
                ...
                , subq_3.created_at__extract_dayofweek
                , subq_3.created_at__extract_dayofyear
                ...
                , subq_3.listing__ds__extract_dayofweek
                , subq_3.listing__ds__extract_dayofyear
                ...
                , subq_3.listing__created_at__extract_dayofweek
                , subq_3.listing__created_at__extract_dayofyear
                ...
                , subq_3.ds__extract_dayofweek AS metric_time__extract_dayofweek
              ...
              FROM (
                ...
                SELECT
                  ...
                  , EXTRACT(DOY FROM listings_latest_src_10004.created_at) AS ds__extract_dayofyear
                  ...
                  , EXTRACT(DOY FROM listings_latest_src_10004.created_at) AS created_at__extract_dayofyear
                  ...
                  , EXTRACT(DOY FROM listings_latest_src_10004.created_at) AS listing__ds__extract_dayofyear
                  ...
                  , EXTRACT(DOY FROM listings_latest_src_10004.created_at) AS listing__created_at__extract_dayofyear
          ...
          FROM (
            ...
            FROM (
              ...
              SELECT
                ...
                , subq_10.ds__extract_week
                , subq_10.ds__extract_day
                , subq_10.ds__extract_dayofweek
                , subq_10.ds__extract_dayofyear
                ...
                , subq_10.ds_partitioned__extract_week
                , subq_10.ds_partitioned__extract_day
                , subq_10.ds_partitioned__extract_dayofweek
                , subq_10.ds_partitioned__extract_dayofyear
                ...
                , subq_10.view__ds__extract_week
                , subq_10.view__ds__extract_day
                , subq_10.view__ds__extract_dayofweek
                , subq_10.view__ds__extract_dayofyear
                ...
                , subq_10.view__ds_partitioned__extract_week
                , subq_10.view__ds_partitioned__extract_day
                , subq_10.view__ds_partitioned__extract_dayofweek
                , subq_10.view__ds_partitioned__extract_dayofyear
                ...
                , subq_10.ds__extract_week AS metric_time__extract_week
                , subq_10.ds__extract_day AS metric_time__extract_day
                , subq_10.ds__extract_dayofweek AS metric_time__extract_dayofweek
              ...
              FROM (
                ...
                SELECT
                  ...
                  , EXTRACT(YEAR FROM views_source_src_10009.ds) AS ds__extract_year
                  , EXTRACT(QUARTER FROM views_source_src_10009.ds) AS ds__extract_quarter
                  , EXTRACT(MONTH FROM views_source_src_10009.ds) AS ds__extract_month
                  , EXTRACT(WEEK FROM views_source_src_10009.ds) AS ds__extract_week
                  , EXTRACT(DAY FROM views_source_src_10009.ds) AS ds__extract_day
                  , EXTRACT(DAYOFWEEK FROM views_source_src_10009.ds) AS ds__extract_dayofweek
                  , EXTRACT(DOY FROM views_source_src_10009.ds) AS ds__extract_dayofyear
                  ...
                  , EXTRACT(YEAR FROM views_source_src_10009.ds_partitioned) AS ds_partitioned__extract_year
                  , EXTRACT(QUARTER FROM views_source_src_10009.ds_partitioned) AS ds_partitioned__extract_quarter
                  , EXTRACT(MONTH FROM views_source_src_10009.ds_partitioned) AS ds_partitioned__extract_month
                  , EXTRACT(WEEK FROM views_source_src_10009.ds_partitioned) AS ds_partitioned__extract_week
                  , EXTRACT(DAY FROM views_source_src_10009.ds_partitioned) AS ds_partitioned__extract_day
                  , EXTRACT(DAYOFWEEK FROM views_source_src_10009.ds_partitioned) AS ds_partitioned__extract_dayofweek
                  , EXTRACT(DOY FROM views_source_src_10009.ds_partitioned) AS ds_partitioned__extract_dayofyear
                  ...
                  , EXTRACT(YEAR FROM views_source_src_10009.ds) AS view__ds__extract_year
                  , EXTRACT(QUARTER FROM views_source_src_10009.ds) AS view__ds__extract_quarter
                  , EXTRACT(MONTH FROM views_source_src_10009.ds) AS view__ds__extract_month
                  , EXTRACT(WEEK FROM views_source_src_10009.ds) AS view__ds__extract_week
                  , EXTRACT(DAY FROM views_source_src_10009.ds) AS view__ds__extract_day
                  , EXTRACT(DAYOFWEEK FROM views_source_src_10009.ds) AS view__ds__extract_dayofweek
                  , EXTRACT(DOY FROM views_source_src_10009.ds) AS view__ds__extract_dayofyear
                  ...
                  , EXTRACT(YEAR FROM views_source_src_10009.ds_partitioned) AS view__ds_partitioned__extract_year
                  , EXTRACT(QUARTER FROM views_source_src_10009.ds_partitioned) AS view__ds_partitioned__extract_quarter
                  , EXTRACT(MONTH FROM views_source_src_10009.ds_partitioned) AS view__ds_partitioned__extract_month
                  , EXTRACT(WEEK FROM views_source_src_10009.ds_partitioned) AS view__ds_partitioned__extract_week
                  , EXTRACT(DAY FROM views_source_src_10009.ds_partitioned) AS view__ds_partitioned__extract_day
                  , EXTRACT(DAYOFWEEK FROM views_source_src_10009.ds_partitioned) AS view__ds_partitioned__extract_dayofweek
                  , EXTRACT(DOY FROM views_source_src_10009.ds_partitioned) AS view__ds_partitioned__extract_dayofyear
          ...
          LEFT OUTER JOIN (
            ...
            FROM (
              ...
              SELECT
                ...
                , subq_13.ds__extract_week
                , subq_13.ds__extract_day
                , subq_13.ds__extract_dayofweek
                , subq_13.ds__extract_dayofyear
                ...
                , subq_13.created_at__extract_week
                , subq_13.created_at__extract_day
                , subq_13.created_at__extract_dayofweek
                , subq_13.created_at__extract_dayofyear
                ...
                , subq_13.listing__ds__extract_week
                , subq_13.listing__ds__extract_day
                , subq_13.listing__ds__extract_dayofweek
                , subq_13.listing__ds__extract_dayofyear
                ...
                , subq_13.listing__created_at__extract_week
                , subq_13.listing__created_at__extract_day
                , subq_13.listing__created_at__extract_dayofweek
                , subq_13.listing__created_at__extract_dayofyear
                ...
                , subq_13.ds__extract_week AS metric_time__extract_week
                , subq_13.ds__extract_day AS metric_time__extract_day
                , subq_13.ds__extract_dayofweek AS metric_time__extract_dayofweek
