            ...
            FROM (
              ...
              FROM (
                ...
                SELECT
                  ...
                  , EXTRACT(DAYOFWEEK_ISO FROM listings_latest_src_10004.created_at) AS ds__extract_dow
                  ...
                  , EXTRACT(DAYOFWEEK_ISO FROM listings_latest_src_10004.created_at) AS created_at__extract_dow
                  ...
                  , EXTRACT(DAYOFWEEK_ISO FROM listings_latest_src_10004.created_at) AS listing__ds__extract_dow
                  ...
                  , EXTRACT(DAYOFWEEK_ISO FROM listings_latest_src_10004.created_at) AS listing__created_at__extract_dow
            ...
            FROM (
              ...
              FROM (
                ...
                SELECT
                  ...
                  , EXTRACT(DAYOFWEEK_ISO FROM views_source_src_10009.ds) AS ds__extract_dow
                  ...
                  , EXTRACT(DAYOFWEEK_ISO FROM views_source_src_10009.ds_partitioned) AS ds_partitioned__extract_dow
                  ...
                  , EXTRACT(DAYOFWEEK_ISO FROM views_source_src_10009.ds) AS view__ds__extract_dow
                  ...
                  , EXTRACT(DAYOFWEEK_ISO FROM views_source_src_10009.ds_partitioned) AS view__ds_partitioned__extract_dow
