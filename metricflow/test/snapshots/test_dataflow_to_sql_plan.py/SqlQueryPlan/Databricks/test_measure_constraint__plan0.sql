              ...
              FROM (
                ...
                FROM (
                  ...
                  SELECT
                    ...
                    , subq_12.ds_partitioned__extract_dayofweek
                    , subq_12.ds_partitioned__extract_dayofyear
                    ...
                    , subq_12.paid_at__extract_dayofweek
                    , subq_12.paid_at__extract_dayofyear
                    ...
                    , subq_12.booking__ds__extract_dayofweek
                    , subq_12.booking__ds__extract_dayofyear
                    ...
                    , subq_12.booking__ds_partitioned__extract_dayofweek
                    , subq_12.booking__ds_partitioned__extract_dayofyear
                    ...
                    , subq_12.booking__paid_at__extract_dayofweek
                    , subq_12.booking__paid_at__extract_dayofyear
                    ...
                    , subq_12.ds__extract_dayofweek AS metric_time__extract_dayofweek
                    , subq_12.ds__extract_dayofyear AS metric_time__extract_dayofyear
                    , subq_12.listing
                    , subq_12.guest
                    , subq_12.host
              ...
              LEFT OUTER JOIN (
                ...
                FROM (
                  ...
                  SELECT
                    ...
                    , subq_15.ds__extract_week
                    , subq_15.ds__extract_day
                    , subq_15.ds__extract_dayofweek
                    , subq_15.ds__extract_dayofyear
                    ...
                    , subq_15.created_at__extract_week
                    , subq_15.created_at__extract_day
                    , subq_15.created_at__extract_dayofweek
                    , subq_15.created_at__extract_dayofyear
                    ...
                    , subq_15.listing__ds__extract_week
                    , subq_15.listing__ds__extract_day
                    , subq_15.listing__ds__extract_dayofweek
                    , subq_15.listing__ds__extract_dayofyear
                    ...
                    , subq_15.listing__created_at__extract_week
                    , subq_15.listing__created_at__extract_day
                    , subq_15.listing__created_at__extract_dayofweek
                    , subq_15.listing__created_at__extract_dayofyear
                    ...
                    , subq_15.ds__extract_week AS metric_time__extract_week
                    , subq_15.ds__extract_day AS metric_time__extract_day
                    , subq_15.ds__extract_dayofweek AS metric_time__extract_dayofweek
      ...
      FROM (
        ...
        FROM (
          ...
          SELECT
            ...
            , subq_24.ds__extract_week
            , subq_24.ds__extract_day
            , subq_24.ds__extract_dayofweek
            , subq_24.ds__extract_dayofyear
            ...
            , subq_24.ds_partitioned__extract_week
            , subq_24.ds_partitioned__extract_day
            , subq_24.ds_partitioned__extract_dayofweek
            , subq_24.ds_partitioned__extract_dayofyear
            ...
            , subq_24.paid_at__extract_week
            , subq_24.paid_at__extract_day
            , subq_24.paid_at__extract_dayofweek
            , subq_24.paid_at__extract_dayofyear
            ...
            , subq_24.booking__ds__extract_week
            , subq_24.booking__ds__extract_day
            , subq_24.booking__ds__extract_dayofweek
            , subq_24.booking__ds__extract_dayofyear
            ...
            , subq_24.booking__ds_partitioned__extract_week
            , subq_24.booking__ds_partitioned__extract_day
            , subq_24.booking__ds_partitioned__extract_dayofweek
            , subq_24.booking__ds_partitioned__extract_dayofyear
            ...
            , subq_24.booking__paid_at__extract_dayofweek
            , subq_24.booking__paid_at__extract_dayofyear
            ...
            , subq_24.ds__extract_week AS metric_time__extract_week
            , subq_24.ds__extract_day AS metric_time__extract_day
            , subq_24.ds__extract_dayofweek AS metric_time__extract_dayofweek
