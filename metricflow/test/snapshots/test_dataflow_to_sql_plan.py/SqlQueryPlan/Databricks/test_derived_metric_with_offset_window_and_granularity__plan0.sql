      ...
      FROM (
        ...
        FROM (
          ...
          SELECT
            ...
            , subq_6.ds__extract_dayofweek AS ds__extract_dayofweek
            , subq_6.ds__extract_dayofyear AS ds__extract_dayofyear
            ...
            , subq_6.ds_partitioned__extract_dayofweek AS ds_partitioned__extract_dayofweek
            ...
            , subq_6.paid_at__extract_dayofweek AS paid_at__extract_dayofweek
            , subq_6.paid_at__extract_dayofyear AS paid_at__extract_dayofyear
            ...
            , subq_6.booking__ds__extract_dayofweek AS booking__ds__extract_dayofweek
            , subq_6.booking__ds__extract_dayofyear AS booking__ds__extract_dayofyear
            ...
            , subq_6.booking__ds_partitioned__extract_dayofweek AS booking__ds_partitioned__extract_dayofweek
            , subq_6.booking__ds_partitioned__extract_dayofyear AS booking__ds_partitioned__extract_dayofyear
            ...
            , subq_6.booking__paid_at__extract_dayofweek AS booking__paid_at__extract_dayofweek
            , subq_6.booking__paid_at__extract_dayofyear AS booking__paid_at__extract_dayofyear
