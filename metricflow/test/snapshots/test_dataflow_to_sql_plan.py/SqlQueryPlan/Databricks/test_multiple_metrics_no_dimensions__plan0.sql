    ...
    FROM (
      ...
      FROM (
        ...
        SELECT
          ...
          , subq_1.ds__extract_dayofweek
          , subq_1.ds__extract_dayofyear
          ...
          , subq_1.ds_partitioned__extract_dayofweek
          , subq_1.ds_partitioned__extract_dayofyear
          , subq_1.paid_at__day
          ...
          , subq_1.paid_at__extract_dayofweek
          , subq_1.paid_at__extract_dayofyear
          ...
          , subq_1.booking__ds__extract_dayofweek
          , subq_1.booking__ds__extract_dayofyear
          ...
          , subq_1.booking__ds_partitioned__extract_dayofyear
          ...
          , subq_1.booking__paid_at__extract_dayofyear
    ...
    FROM (
      ...
      FROM (
        ...
        SELECT
          ...
          , subq_7.ds__extract_dayofweek
          , subq_7.ds__extract_dayofyear
          ...
          , subq_7.created_at__extract_dayofweek
          ...
          , subq_7.listing__ds__extract_dayofweek
          , subq_7.listing__ds__extract_dayofyear
          ...
          , subq_7.listing__created_at__extract_dayofweek
          , subq_7.listing__created_at__extract_dayofyear
        ...
        FROM (
          ...
          SELECT
            ...
            , subq_6.ds__extract_dayofweek
            , subq_6.ds__extract_dayofyear
            ...
            , subq_6.created_at__extract_dayofweek
            , subq_6.created_at__extract_dayofyear
            ...
            , subq_6.listing__ds__extract_dayofweek
            , subq_6.listing__ds__extract_dayofyear
            ...
            , subq_6.listing__created_at__extract_dayofweek
            , subq_6.listing__created_at__extract_dayofyear
