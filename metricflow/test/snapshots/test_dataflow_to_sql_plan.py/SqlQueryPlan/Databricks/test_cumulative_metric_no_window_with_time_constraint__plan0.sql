  ...
  FROM (
    ...
    FROM (
      ...
      SELECT
        ...
        , subq_1.company__ds__extract_dayofweek
        , subq_1.company__ds__extract_dayofyear
      ...
      FROM (
        ...
        FROM (
          ...
          SELECT
            ...
            , EXTRACT(DOY FROM revenue_src_10006.created_at) AS ds__extract_dayofyear
            ...
            , EXTRACT(DOY FROM revenue_src_10006.created_at) AS company__ds__extract_dayofyear
