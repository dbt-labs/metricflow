  ...
  FROM (
    ...
    FROM (
      ...
      SELECT
        ...
        , subq_7.lux_listing__window_start__extract_day AS listing__lux_listing__window_start__extract_day
        , subq_7.lux_listing__window_end__extract_month AS listing__lux_listing__window_end__extract_month
          ...
          LEFT OUTER JOIN (
            ...
            FROM (
              ...
              SELECT
                ...
                , EXTRACT(DOY FROM lux_listings_src_10019.valid_from) AS window_start__extract_dayofyear
                ...
                , EXTRACT(DOY FROM lux_listings_src_10019.valid_to) AS window_end__extract_dayofyear
                ...
                , EXTRACT(DOY FROM lux_listings_src_10019.valid_to) AS lux_listing__window_end__extract_dayofyear
      ...
      ON
        (
          ...
          (
            subq_2.metric_time__day >= subq_7.lux_listing__window_start__extract_day
          ) AND (
            (
              subq_2.metric_time__day < subq_7.lux_listing__window_end__extract_month
            ) OR (
              subq_7.lux_listing__window_end__extract_month IS NULL
            )
          )
        )
    ) subq_8
