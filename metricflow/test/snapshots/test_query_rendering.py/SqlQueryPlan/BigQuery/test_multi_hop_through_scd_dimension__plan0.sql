        ...
        FROM (
          ...
          FROM (
            ...
            SELECT
              ...
              , DATE_TRUNC(bookings_source_src_10017.ds, day) AS ds__day
              , DATE_TRUNC(bookings_source_src_10017.ds, isoweek) AS ds__week
              , DATE_TRUNC(bookings_source_src_10017.ds, month) AS ds__month
              , DATE_TRUNC(bookings_source_src_10017.ds, quarter) AS ds__quarter
              , DATE_TRUNC(bookings_source_src_10017.ds, year) AS ds__year
              ...
              , IF(EXTRACT(dayofweek FROM bookings_source_src_10017.ds) = 1, 7, EXTRACT(dayofweek FROM bookings_source_src_10017.ds) - 1) AS ds__extract_dow
              , EXTRACT(dayofyear FROM bookings_source_src_10017.ds) AS ds__extract_doy
              , DATE_TRUNC(bookings_source_src_10017.ds_partitioned, day) AS ds_partitioned__day
              , DATE_TRUNC(bookings_source_src_10017.ds_partitioned, isoweek) AS ds_partitioned__week
              , DATE_TRUNC(bookings_source_src_10017.ds_partitioned, month) AS ds_partitioned__month
              , DATE_TRUNC(bookings_source_src_10017.ds_partitioned, quarter) AS ds_partitioned__quarter
              , DATE_TRUNC(bookings_source_src_10017.ds_partitioned, year) AS ds_partitioned__year
              ...
              , IF(EXTRACT(dayofweek FROM bookings_source_src_10017.ds_partitioned) = 1, 7, EXTRACT(dayofweek FROM bookings_source_src_10017.ds_partitioned) - 1) AS ds_partitioned__extract_dow
              , EXTRACT(dayofyear FROM bookings_source_src_10017.ds_partitioned) AS ds_partitioned__extract_doy
              , DATE_TRUNC(bookings_source_src_10017.paid_at, day) AS paid_at__day
              , DATE_TRUNC(bookings_source_src_10017.paid_at, isoweek) AS paid_at__week
              , DATE_TRUNC(bookings_source_src_10017.paid_at, month) AS paid_at__month
              , DATE_TRUNC(bookings_source_src_10017.paid_at, quarter) AS paid_at__quarter
              , DATE_TRUNC(bookings_source_src_10017.paid_at, year) AS paid_at__year
              ...
              , IF(EXTRACT(dayofweek FROM bookings_source_src_10017.paid_at) = 1, 7, EXTRACT(dayofweek FROM bookings_source_src_10017.paid_at) - 1) AS paid_at__extract_dow
              , EXTRACT(dayofyear FROM bookings_source_src_10017.paid_at) AS paid_at__extract_doy
              , bookings_source_src_10017.is_instant AS booking__is_instant
              , DATE_TRUNC(bookings_source_src_10017.ds, day) AS booking__ds__day
              , DATE_TRUNC(bookings_source_src_10017.ds, isoweek) AS booking__ds__week
              , DATE_TRUNC(bookings_source_src_10017.ds, month) AS booking__ds__month
              , DATE_TRUNC(bookings_source_src_10017.ds, quarter) AS booking__ds__quarter
              , DATE_TRUNC(bookings_source_src_10017.ds, year) AS booking__ds__year
              ...
              , IF(EXTRACT(dayofweek FROM bookings_source_src_10017.ds) = 1, 7, EXTRACT(dayofweek FROM bookings_source_src_10017.ds) - 1) AS booking__ds__extract_dow
              , EXTRACT(dayofyear FROM bookings_source_src_10017.ds) AS booking__ds__extract_doy
              , DATE_TRUNC(bookings_source_src_10017.ds_partitioned, day) AS booking__ds_partitioned__day
              , DATE_TRUNC(bookings_source_src_10017.ds_partitioned, isoweek) AS booking__ds_partitioned__week
              , DATE_TRUNC(bookings_source_src_10017.ds_partitioned, month) AS booking__ds_partitioned__month
              , DATE_TRUNC(bookings_source_src_10017.ds_partitioned, quarter) AS booking__ds_partitioned__quarter
              , DATE_TRUNC(bookings_source_src_10017.ds_partitioned, year) AS booking__ds_partitioned__year
              ...
              , IF(EXTRACT(dayofweek FROM bookings_source_src_10017.ds_partitioned) = 1, 7, EXTRACT(dayofweek FROM bookings_source_src_10017.ds_partitioned) - 1) AS booking__ds_partitioned__extract_dow
              , EXTRACT(dayofyear FROM bookings_source_src_10017.ds_partitioned) AS booking__ds_partitioned__extract_doy
              , DATE_TRUNC(bookings_source_src_10017.paid_at, day) AS booking__paid_at__day
              , DATE_TRUNC(bookings_source_src_10017.paid_at, isoweek) AS booking__paid_at__week
              , DATE_TRUNC(bookings_source_src_10017.paid_at, month) AS booking__paid_at__month
              , DATE_TRUNC(bookings_source_src_10017.paid_at, quarter) AS booking__paid_at__quarter
              , DATE_TRUNC(bookings_source_src_10017.paid_at, year) AS booking__paid_at__year
              ...
              , IF(EXTRACT(dayofweek FROM bookings_source_src_10017.paid_at) = 1, 7, EXTRACT(dayofweek FROM bookings_source_src_10017.paid_at) - 1) AS booking__paid_at__extract_dow
              , EXTRACT(dayofyear FROM bookings_source_src_10017.paid_at) AS booking__paid_at__extract_doy
        ...
        FROM (
          ...
          FROM (
            ...
            SELECT
              ...
              , DATE_TRUNC(listings_src_10019.active_from, year) AS window_start__year
              ...
              , IF(EXTRACT(dayofweek FROM listings_src_10019.active_from) = 1, 7, EXTRACT(dayofweek FROM listings_src_10019.active_from) - 1) AS window_start__extract_dow
              , EXTRACT(dayofyear FROM listings_src_10019.active_from) AS window_start__extract_doy
              ...
              , DATE_TRUNC(listings_src_10019.active_to, year) AS window_end__year
              ...
              , IF(EXTRACT(dayofweek FROM listings_src_10019.active_to) = 1, 7, EXTRACT(dayofweek FROM listings_src_10019.active_to) - 1) AS window_end__extract_dow
              , EXTRACT(dayofyear FROM listings_src_10019.active_to) AS window_end__extract_doy
              ...
              , DATE_TRUNC(listings_src_10019.active_from, year) AS listing__window_start__year
              ...
              , IF(EXTRACT(dayofweek FROM listings_src_10019.active_from) = 1, 7, EXTRACT(dayofweek FROM listings_src_10019.active_from) - 1) AS listing__window_start__extract_dow
              , EXTRACT(dayofyear FROM listings_src_10019.active_from) AS listing__window_start__extract_doy
              ...
              , DATE_TRUNC(listings_src_10019.active_to, year) AS listing__window_end__year
              ...
              , IF(EXTRACT(dayofweek FROM listings_src_10019.active_to) = 1, 7, EXTRACT(dayofweek FROM listings_src_10019.active_to) - 1) AS listing__window_end__extract_dow
              , EXTRACT(dayofyear FROM listings_src_10019.active_to) AS listing__window_end__extract_doy
          ...
          LEFT OUTER JOIN (
            ...
            FROM (
              ...
              SELECT
                DATE_TRUNC(users_latest_src_10023.ds, day) AS ds__day
                ...
                , DATE_TRUNC(users_latest_src_10023.ds, year) AS ds__year
                ...
                , IF(EXTRACT(dayofweek FROM users_latest_src_10023.ds) = 1, 7, EXTRACT(dayofweek FROM users_latest_src_10023.ds) - 1) AS ds__extract_dow
                , EXTRACT(dayofyear FROM users_latest_src_10023.ds) AS ds__extract_doy
                , users_latest_src_10023.home_state_latest
                , DATE_TRUNC(users_latest_src_10023.ds, day) AS user__ds__day
                ...
                , DATE_TRUNC(users_latest_src_10023.ds, year) AS user__ds__year
                ...
                , IF(EXTRACT(dayofweek FROM users_latest_src_10023.ds) = 1, 7, EXTRACT(dayofweek FROM users_latest_src_10023.ds) - 1) AS user__ds__extract_dow
                , EXTRACT(dayofyear FROM users_latest_src_10023.ds) AS user__ds__extract_doy
