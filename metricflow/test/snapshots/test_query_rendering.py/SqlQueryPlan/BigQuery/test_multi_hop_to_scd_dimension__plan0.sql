          ...
          LEFT OUTER JOIN (
            ...
            FROM (
              ...
              SELECT
                ...
                , DATE_TRUNC(lux_listings_src_10021.valid_from, year) AS window_start__year
                ...
                , IF(EXTRACT(dayofweek FROM lux_listings_src_10021.valid_from) = 1, 7, EXTRACT(dayofweek FROM lux_listings_src_10021.valid_from) - 1) AS window_start__extract_dow
                , EXTRACT(dayofyear FROM lux_listings_src_10021.valid_from) AS window_start__extract_doy
                ...
                , DATE_TRUNC(lux_listings_src_10021.valid_to, year) AS window_end__year
                ...
                , IF(EXTRACT(dayofweek FROM lux_listings_src_10021.valid_to) = 1, 7, EXTRACT(dayofweek FROM lux_listings_src_10021.valid_to) - 1) AS window_end__extract_dow
                , EXTRACT(dayofyear FROM lux_listings_src_10021.valid_to) AS window_end__extract_doy
                ...
                , DATE_TRUNC(lux_listings_src_10021.valid_from, year) AS lux_listing__window_start__year
                ...
                , IF(EXTRACT(dayofweek FROM lux_listings_src_10021.valid_from) = 1, 7, EXTRACT(dayofweek FROM lux_listings_src_10021.valid_from) - 1) AS lux_listing__window_start__extract_dow
                , EXTRACT(dayofyear FROM lux_listings_src_10021.valid_from) AS lux_listing__window_start__extract_doy
                ...
                , DATE_TRUNC(lux_listings_src_10021.valid_to, year) AS lux_listing__window_end__year
                ...
                , IF(EXTRACT(dayofweek FROM lux_listings_src_10021.valid_to) = 1, 7, EXTRACT(dayofweek FROM lux_listings_src_10021.valid_to) - 1) AS lux_listing__window_end__extract_dow
                , EXTRACT(dayofyear FROM lux_listings_src_10021.valid_to) AS lux_listing__window_end__extract_doy
