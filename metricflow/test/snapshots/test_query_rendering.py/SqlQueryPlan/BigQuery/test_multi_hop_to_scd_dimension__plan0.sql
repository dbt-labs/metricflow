          ...
          LEFT OUTER JOIN (
            ...
            FROM (
              ...
              SELECT
                ...
                , DATE_TRUNC(lux_listings_src_26004.valid_from, isoweek) AS window_start__week
                , DATE_TRUNC(lux_listings_src_26004.valid_from, month) AS window_start__month
                , DATE_TRUNC(lux_listings_src_26004.valid_from, quarter) AS window_start__quarter
                , DATE_TRUNC(lux_listings_src_26004.valid_from, year) AS window_start__year
                ...
                , IF(EXTRACT(dayofweek FROM lux_listings_src_26004.valid_from) = 1, 7, EXTRACT(dayofweek FROM lux_listings_src_26004.valid_from) - 1) AS window_start__extract_dow
                , EXTRACT(dayofyear FROM lux_listings_src_26004.valid_from) AS window_start__extract_doy
                , lux_listings_src_26004.valid_to AS window_end__day
                , DATE_TRUNC(lux_listings_src_26004.valid_to, isoweek) AS window_end__week
                , DATE_TRUNC(lux_listings_src_26004.valid_to, month) AS window_end__month
                , DATE_TRUNC(lux_listings_src_26004.valid_to, quarter) AS window_end__quarter
                , DATE_TRUNC(lux_listings_src_26004.valid_to, year) AS window_end__year
                ...
                , IF(EXTRACT(dayofweek FROM lux_listings_src_26004.valid_to) = 1, 7, EXTRACT(dayofweek FROM lux_listings_src_26004.valid_to) - 1) AS window_end__extract_dow
                , EXTRACT(dayofyear FROM lux_listings_src_26004.valid_to) AS window_end__extract_doy
                , lux_listings_src_26004.is_confirmed_lux
                , lux_listings_src_26004.valid_from AS lux_listing__window_start__day
                , DATE_TRUNC(lux_listings_src_26004.valid_from, isoweek) AS lux_listing__window_start__week
                , DATE_TRUNC(lux_listings_src_26004.valid_from, month) AS lux_listing__window_start__month
                , DATE_TRUNC(lux_listings_src_26004.valid_from, quarter) AS lux_listing__window_start__quarter
                , DATE_TRUNC(lux_listings_src_26004.valid_from, year) AS lux_listing__window_start__year
                ...
                , IF(EXTRACT(dayofweek FROM lux_listings_src_26004.valid_from) = 1, 7, EXTRACT(dayofweek FROM lux_listings_src_26004.valid_from) - 1) AS lux_listing__window_start__extract_dow
                , EXTRACT(dayofyear FROM lux_listings_src_26004.valid_from) AS lux_listing__window_start__extract_doy
                , lux_listings_src_26004.valid_to AS lux_listing__window_end__day
                , DATE_TRUNC(lux_listings_src_26004.valid_to, isoweek) AS lux_listing__window_end__week
                , DATE_TRUNC(lux_listings_src_26004.valid_to, month) AS lux_listing__window_end__month
                , DATE_TRUNC(lux_listings_src_26004.valid_to, quarter) AS lux_listing__window_end__quarter
                , DATE_TRUNC(lux_listings_src_26004.valid_to, year) AS lux_listing__window_end__year
                ...
                , IF(EXTRACT(dayofweek FROM lux_listings_src_26004.valid_to) = 1, 7, EXTRACT(dayofweek FROM lux_listings_src_26004.valid_to) - 1) AS lux_listing__window_end__extract_dow
                , EXTRACT(dayofyear FROM lux_listings_src_26004.valid_to) AS lux_listing__window_end__extract_doy
