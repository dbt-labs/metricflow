...
LEFT OUTER JOIN (
  ...
  ON
    (
      ...
      DATE_TRUNC(bridge_table_src_10013.ds_partitioned, day) = DATE_TRUNC(customer_table_src_10015.ds_partitioned, day)
    )
) subq_18
ON
  (
    ...
    DATE_TRUNC(account_month_txns_src_10012.ds_partitioned, day) = subq_18.ds_partitioned__day
  )
GROUP BY
