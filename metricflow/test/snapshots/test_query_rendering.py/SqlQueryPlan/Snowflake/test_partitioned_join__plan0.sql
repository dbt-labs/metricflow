        ...
        FROM (
          ...
          FROM (
            ...
            SELECT
              ...
              , EXTRACT(dayofweekiso FROM id_verifications_src_10004.ds) AS ds__extract_dow
              ...
              , EXTRACT(dayofweekiso FROM id_verifications_src_10004.ds_partitioned) AS ds_partitioned__extract_dow
              ...
              , EXTRACT(dayofweekiso FROM id_verifications_src_10004.ds) AS verification__ds__extract_dow
              ...
              , EXTRACT(dayofweekiso FROM id_verifications_src_10004.ds_partitioned) AS verification__ds_partitioned__extract_dow
      ...
      LEFT OUTER JOIN (
        ...
        FROM (
          ...
          SELECT
            ...
            , EXTRACT(dayofweekiso FROM users_ds_source_src_10008.ds) AS ds__extract_dow
            ...
            , EXTRACT(dayofweekiso FROM users_ds_source_src_10008.created_at) AS created_at__extract_dow
            ...
            , EXTRACT(dayofweekiso FROM users_ds_source_src_10008.ds_partitioned) AS ds_partitioned__extract_dow
            ...
            , EXTRACT(dayofweekiso FROM users_ds_source_src_10008.ds) AS user__ds__extract_dow
            ...
            , EXTRACT(dayofweekiso FROM users_ds_source_src_10008.created_at) AS user__created_at__extract_dow
            ...
            , EXTRACT(dayofweekiso FROM users_ds_source_src_10008.ds_partitioned) AS user__ds_partitioned__extract_dow
