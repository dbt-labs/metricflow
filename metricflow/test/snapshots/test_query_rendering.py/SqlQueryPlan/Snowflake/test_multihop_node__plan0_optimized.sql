...
LEFT OUTER JOIN (
  ...
  ON
    (
      ...
      DATE_TRUNC('day', bridge_table_src_22001.ds_partitioned) = DATE_TRUNC('day', customer_table_src_22003.ds_partitioned)
    )
) subq_18
ON
  (
    ...
    DATE_TRUNC('day', account_month_txns_src_22000.ds_partitioned) = subq_18.ds_partitioned__day
  )
GROUP BY
