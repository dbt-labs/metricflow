        ...
        FROM (
          ...
          FROM (
            ...
            SELECT
              ...
              , EXTRACT(dayofweekiso FROM bridge_table_src_22001.ds_partitioned) AS ds_partitioned__extract_dow
              ...
              , EXTRACT(dayofweekiso FROM bridge_table_src_22001.ds_partitioned) AS account_id__ds_partitioned__extract_dow
              ...
              , EXTRACT(dayofweekiso FROM bridge_table_src_22001.ds_partitioned) AS bridge_account__ds_partitioned__extract_dow
          ...
          LEFT OUTER JOIN (
            ...
            FROM (
              ...
              SELECT
                ...
                , EXTRACT(dayofweekiso FROM customer_table_src_22003.ds_partitioned) AS ds_partitioned__extract_dow
                ...
                , EXTRACT(dayofweekiso FROM customer_table_src_22003.ds_partitioned) AS customer_id__ds_partitioned__extract_dow
