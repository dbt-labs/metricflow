        ...
        FROM (
          ...
          FROM (
            ...
            SELECT
              ...
              , lux_listing_mapping_src_26003.lux_listing_id AS lux_listing
              , lux_listing_mapping_src_26003.lux_listing_id AS listing__lux_listing
          ...
          LEFT OUTER JOIN (
            ...
            FROM (
              ...
              SELECT
                lux_listings_src_26004.valid_from AS window_start__day
                , DATE_TRUNC('week', lux_listings_src_26004.valid_from) AS window_start__week
                , DATE_TRUNC('month', lux_listings_src_26004.valid_from) AS window_start__month
                , DATE_TRUNC('quarter', lux_listings_src_26004.valid_from) AS window_start__quarter
                , DATE_TRUNC('year', lux_listings_src_26004.valid_from) AS window_start__year
                , EXTRACT(year FROM lux_listings_src_26004.valid_from) AS window_start__extract_year
                , EXTRACT(quarter FROM lux_listings_src_26004.valid_from) AS window_start__extract_quarter
                , EXTRACT(month FROM lux_listings_src_26004.valid_from) AS window_start__extract_month
                , EXTRACT(day FROM lux_listings_src_26004.valid_from) AS window_start__extract_day
                , CASE WHEN EXTRACT(dow FROM lux_listings_src_26004.valid_from) = 0 THEN EXTRACT(dow FROM lux_listings_src_26004.valid_from) + 7 ELSE EXTRACT(dow FROM lux_listings_src_26004.valid_from) END AS window_start__extract_dow
                , EXTRACT(doy FROM lux_listings_src_26004.valid_from) AS window_start__extract_doy
                , lux_listings_src_26004.valid_to AS window_end__day
                , DATE_TRUNC('week', lux_listings_src_26004.valid_to) AS window_end__week
                , DATE_TRUNC('month', lux_listings_src_26004.valid_to) AS window_end__month
                , DATE_TRUNC('quarter', lux_listings_src_26004.valid_to) AS window_end__quarter
                , DATE_TRUNC('year', lux_listings_src_26004.valid_to) AS window_end__year
                , EXTRACT(year FROM lux_listings_src_26004.valid_to) AS window_end__extract_year
                , EXTRACT(quarter FROM lux_listings_src_26004.valid_to) AS window_end__extract_quarter
                , EXTRACT(month FROM lux_listings_src_26004.valid_to) AS window_end__extract_month
                , EXTRACT(day FROM lux_listings_src_26004.valid_to) AS window_end__extract_day
                , CASE WHEN EXTRACT(dow FROM lux_listings_src_26004.valid_to) = 0 THEN EXTRACT(dow FROM lux_listings_src_26004.valid_to) + 7 ELSE EXTRACT(dow FROM lux_listings_src_26004.valid_to) END AS window_end__extract_dow
                , EXTRACT(doy FROM lux_listings_src_26004.valid_to) AS window_end__extract_doy
                , lux_listings_src_26004.is_confirmed_lux
                , lux_listings_src_26004.valid_from AS lux_listing__window_start__day
                , DATE_TRUNC('week', lux_listings_src_26004.valid_from) AS lux_listing__window_start__week
                , DATE_TRUNC('month', lux_listings_src_26004.valid_from) AS lux_listing__window_start__month
                , DATE_TRUNC('quarter', lux_listings_src_26004.valid_from) AS lux_listing__window_start__quarter
                , DATE_TRUNC('year', lux_listings_src_26004.valid_from) AS lux_listing__window_start__year
                , EXTRACT(year FROM lux_listings_src_26004.valid_from) AS lux_listing__window_start__extract_year
                , EXTRACT(quarter FROM lux_listings_src_26004.valid_from) AS lux_listing__window_start__extract_quarter
                , EXTRACT(month FROM lux_listings_src_26004.valid_from) AS lux_listing__window_start__extract_month
                , EXTRACT(day FROM lux_listings_src_26004.valid_from) AS lux_listing__window_start__extract_day
                , CASE WHEN EXTRACT(dow FROM lux_listings_src_26004.valid_from) = 0 THEN EXTRACT(dow FROM lux_listings_src_26004.valid_from) + 7 ELSE EXTRACT(dow FROM lux_listings_src_26004.valid_from) END AS lux_listing__window_start__extract_dow
                , EXTRACT(doy FROM lux_listings_src_26004.valid_from) AS lux_listing__window_start__extract_doy
                , lux_listings_src_26004.valid_to AS lux_listing__window_end__day
                , DATE_TRUNC('week', lux_listings_src_26004.valid_to) AS lux_listing__window_end__week
                , DATE_TRUNC('month', lux_listings_src_26004.valid_to) AS lux_listing__window_end__month
                , DATE_TRUNC('quarter', lux_listings_src_26004.valid_to) AS lux_listing__window_end__quarter
                , DATE_TRUNC('year', lux_listings_src_26004.valid_to) AS lux_listing__window_end__year
                , EXTRACT(year FROM lux_listings_src_26004.valid_to) AS lux_listing__window_end__extract_year
                , EXTRACT(quarter FROM lux_listings_src_26004.valid_to) AS lux_listing__window_end__extract_quarter
                , EXTRACT(month FROM lux_listings_src_26004.valid_to) AS lux_listing__window_end__extract_month
                , EXTRACT(day FROM lux_listings_src_26004.valid_to) AS lux_listing__window_end__extract_day
                , CASE WHEN EXTRACT(dow FROM lux_listings_src_26004.valid_to) = 0 THEN EXTRACT(dow FROM lux_listings_src_26004.valid_to) + 7 ELSE EXTRACT(dow FROM lux_listings_src_26004.valid_to) END AS lux_listing__window_end__extract_dow
                , EXTRACT(doy FROM lux_listings_src_26004.valid_to) AS lux_listing__window_end__extract_doy
                , lux_listings_src_26004.is_confirmed_lux AS lux_listing__is_confirmed_lux
                , lux_listings_src_26004.lux_listing_id AS lux_listing
              FROM ***************************.dim_lux_listings lux_listings_src_26004
            ) subq_4
          ) subq_5
          ON
