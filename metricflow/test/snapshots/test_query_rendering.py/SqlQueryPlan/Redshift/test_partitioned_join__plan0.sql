      ...
      LEFT OUTER JOIN (
        ...
        FROM (
          ...
          SELECT
            ...
            , CASE WHEN EXTRACT(dow FROM users_ds_source_src_10008.ds) = 0 THEN EXTRACT(dow FROM users_ds_source_src_10008.ds) + 7 ELSE EXTRACT(dow FROM users_ds_source_src_10008.ds) END AS ds__extract_dow
            ...
            , CASE WHEN EXTRACT(dow FROM users_ds_source_src_10008.created_at) = 0 THEN EXTRACT(dow FROM users_ds_source_src_10008.created_at) + 7 ELSE EXTRACT(dow FROM users_ds_source_src_10008.created_at) END AS created_at__extract_dow
            ...
            , CASE WHEN EXTRACT(dow FROM users_ds_source_src_10008.ds_partitioned) = 0 THEN EXTRACT(dow FROM users_ds_source_src_10008.ds_partitioned) + 7 ELSE EXTRACT(dow FROM users_ds_source_src_10008.ds_partitioned) END AS ds_partitioned__extract_dow
            ...
            , CASE WHEN EXTRACT(dow FROM users_ds_source_src_10008.ds) = 0 THEN EXTRACT(dow FROM users_ds_source_src_10008.ds) + 7 ELSE EXTRACT(dow FROM users_ds_source_src_10008.ds) END AS user__ds__extract_dow
            ...
            , CASE WHEN EXTRACT(dow FROM users_ds_source_src_10008.created_at) = 0 THEN EXTRACT(dow FROM users_ds_source_src_10008.created_at) + 7 ELSE EXTRACT(dow FROM users_ds_source_src_10008.created_at) END AS user__created_at__extract_dow
            ...
            , CASE WHEN EXTRACT(dow FROM users_ds_source_src_10008.ds_partitioned) = 0 THEN EXTRACT(dow FROM users_ds_source_src_10008.ds_partitioned) + 7 ELSE EXTRACT(dow FROM users_ds_source_src_10008.ds_partitioned) END AS user__ds_partitioned__extract_dow
