        ...
        FROM (
          ...
          FROM (
            ...
            SELECT
              ...
              , CASE WHEN EXTRACT(dow FROM account_month_txns_src_10012.ds_partitioned) = 0 THEN EXTRACT(dow FROM account_month_txns_src_10012.ds_partitioned) + 7 ELSE EXTRACT(dow FROM account_month_txns_src_10012.ds_partitioned) END AS ds_partitioned__extract_dow
              ...
              , CASE WHEN EXTRACT(dow FROM account_month_txns_src_10012.ds) = 0 THEN EXTRACT(dow FROM account_month_txns_src_10012.ds) + 7 ELSE EXTRACT(dow FROM account_month_txns_src_10012.ds) END AS ds__extract_dow
              ...
              , CASE WHEN EXTRACT(dow FROM account_month_txns_src_10012.ds_partitioned) = 0 THEN EXTRACT(dow FROM account_month_txns_src_10012.ds_partitioned) + 7 ELSE EXTRACT(dow FROM account_month_txns_src_10012.ds_partitioned) END AS account_id__ds_partitioned__extract_dow
              ...
              , CASE WHEN EXTRACT(dow FROM account_month_txns_src_10012.ds) = 0 THEN EXTRACT(dow FROM account_month_txns_src_10012.ds) + 7 ELSE EXTRACT(dow FROM account_month_txns_src_10012.ds) END AS account_id__ds__extract_dow
        ...
        FROM (
          ...
          FROM (
            ...
            SELECT
              ...
              , CASE WHEN EXTRACT(dow FROM bridge_table_src_10013.ds_partitioned) = 0 THEN EXTRACT(dow FROM bridge_table_src_10013.ds_partitioned) + 7 ELSE EXTRACT(dow FROM bridge_table_src_10013.ds_partitioned) END AS ds_partitioned__extract_dow
              ...
              , CASE WHEN EXTRACT(dow FROM bridge_table_src_10013.ds_partitioned) = 0 THEN EXTRACT(dow FROM bridge_table_src_10013.ds_partitioned) + 7 ELSE EXTRACT(dow FROM bridge_table_src_10013.ds_partitioned) END AS account_id__ds_partitioned__extract_dow
              ...
              , CASE WHEN EXTRACT(dow FROM bridge_table_src_10013.ds_partitioned) = 0 THEN EXTRACT(dow FROM bridge_table_src_10013.ds_partitioned) + 7 ELSE EXTRACT(dow FROM bridge_table_src_10013.ds_partitioned) END AS bridge_account__ds_partitioned__extract_dow
          ...
          LEFT OUTER JOIN (
            ...
            FROM (
              ...
              SELECT
                ...
                , CASE WHEN EXTRACT(dow FROM customer_table_src_10015.ds_partitioned) = 0 THEN EXTRACT(dow FROM customer_table_src_10015.ds_partitioned) + 7 ELSE EXTRACT(dow FROM customer_table_src_10015.ds_partitioned) END AS ds_partitioned__extract_dow
                ...
                , CASE WHEN EXTRACT(dow FROM customer_table_src_10015.ds_partitioned) = 0 THEN EXTRACT(dow FROM customer_table_src_10015.ds_partitioned) + 7 ELSE EXTRACT(dow FROM customer_table_src_10015.ds_partitioned) END AS customer_id__ds_partitioned__extract_dow
