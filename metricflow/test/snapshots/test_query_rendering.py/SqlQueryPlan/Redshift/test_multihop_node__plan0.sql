      ...
      LEFT OUTER JOIN (
        ...
        FROM (
          ...
          FROM (
            ...
            SELECT
              bridge_table_src_22001.extra_dim
              , DATE_TRUNC('day', bridge_table_src_22001.ds_partitioned) AS ds_partitioned__day
              , DATE_TRUNC('week', bridge_table_src_22001.ds_partitioned) AS ds_partitioned__week
              , DATE_TRUNC('month', bridge_table_src_22001.ds_partitioned) AS ds_partitioned__month
              , DATE_TRUNC('quarter', bridge_table_src_22001.ds_partitioned) AS ds_partitioned__quarter
              , DATE_TRUNC('year', bridge_table_src_22001.ds_partitioned) AS ds_partitioned__year
              , EXTRACT(year FROM bridge_table_src_22001.ds_partitioned) AS ds_partitioned__extract_year
              , EXTRACT(quarter FROM bridge_table_src_22001.ds_partitioned) AS ds_partitioned__extract_quarter
              , EXTRACT(month FROM bridge_table_src_22001.ds_partitioned) AS ds_partitioned__extract_month
              , EXTRACT(day FROM bridge_table_src_22001.ds_partitioned) AS ds_partitioned__extract_day
              , CASE WHEN EXTRACT(dow FROM bridge_table_src_22001.ds_partitioned) = 0 THEN EXTRACT(dow FROM bridge_table_src_22001.ds_partitioned) + 7 ELSE EXTRACT(dow FROM bridge_table_src_22001.ds_partitioned) END AS ds_partitioned__extract_dow
              , EXTRACT(doy FROM bridge_table_src_22001.ds_partitioned) AS ds_partitioned__extract_doy
              , bridge_table_src_22001.extra_dim AS account_id__extra_dim
              , DATE_TRUNC('day', bridge_table_src_22001.ds_partitioned) AS account_id__ds_partitioned__day
              , DATE_TRUNC('week', bridge_table_src_22001.ds_partitioned) AS account_id__ds_partitioned__week
              , DATE_TRUNC('month', bridge_table_src_22001.ds_partitioned) AS account_id__ds_partitioned__month
              , DATE_TRUNC('quarter', bridge_table_src_22001.ds_partitioned) AS account_id__ds_partitioned__quarter
              , DATE_TRUNC('year', bridge_table_src_22001.ds_partitioned) AS account_id__ds_partitioned__year
              , EXTRACT(year FROM bridge_table_src_22001.ds_partitioned) AS account_id__ds_partitioned__extract_year
              , EXTRACT(quarter FROM bridge_table_src_22001.ds_partitioned) AS account_id__ds_partitioned__extract_quarter
              , EXTRACT(month FROM bridge_table_src_22001.ds_partitioned) AS account_id__ds_partitioned__extract_month
              , EXTRACT(day FROM bridge_table_src_22001.ds_partitioned) AS account_id__ds_partitioned__extract_day
              , CASE WHEN EXTRACT(dow FROM bridge_table_src_22001.ds_partitioned) = 0 THEN EXTRACT(dow FROM bridge_table_src_22001.ds_partitioned) + 7 ELSE EXTRACT(dow FROM bridge_table_src_22001.ds_partitioned) END AS account_id__ds_partitioned__extract_dow
              ...
              , DATE_TRUNC('week', bridge_table_src_22001.ds_partitioned) AS bridge_account__ds_partitioned__week
              , DATE_TRUNC('month', bridge_table_src_22001.ds_partitioned) AS bridge_account__ds_partitioned__month
              , DATE_TRUNC('quarter', bridge_table_src_22001.ds_partitioned) AS bridge_account__ds_partitioned__quarter
              , DATE_TRUNC('year', bridge_table_src_22001.ds_partitioned) AS bridge_account__ds_partitioned__year
              , EXTRACT(year FROM bridge_table_src_22001.ds_partitioned) AS bridge_account__ds_partitioned__extract_year
              , EXTRACT(quarter FROM bridge_table_src_22001.ds_partitioned) AS bridge_account__ds_partitioned__extract_quarter
              , EXTRACT(month FROM bridge_table_src_22001.ds_partitioned) AS bridge_account__ds_partitioned__extract_month
              , EXTRACT(day FROM bridge_table_src_22001.ds_partitioned) AS bridge_account__ds_partitioned__extract_day
              , CASE WHEN EXTRACT(dow FROM bridge_table_src_22001.ds_partitioned) = 0 THEN EXTRACT(dow FROM bridge_table_src_22001.ds_partitioned) + 7 ELSE EXTRACT(dow FROM bridge_table_src_22001.ds_partitioned) END AS bridge_account__ds_partitioned__extract_dow
              , EXTRACT(doy FROM bridge_table_src_22001.ds_partitioned) AS bridge_account__ds_partitioned__extract_doy
              , bridge_table_src_22001.account_id
              , bridge_table_src_22001.customer_id
              , bridge_table_src_22001.customer_id AS account_id__customer_id
              , bridge_table_src_22001.account_id AS bridge_account__account_id
              , bridge_table_src_22001.customer_id AS bridge_account__customer_id
          ...
          LEFT OUTER JOIN (
            ...
            FROM (
              ...
              SELECT
                customer_table_src_22003.customer_name
                , customer_table_src_22003.customer_atomic_weight
                , DATE_TRUNC('day', customer_table_src_22003.ds_partitioned) AS ds_partitioned__day
                , DATE_TRUNC('week', customer_table_src_22003.ds_partitioned) AS ds_partitioned__week
                , DATE_TRUNC('month', customer_table_src_22003.ds_partitioned) AS ds_partitioned__month
                , DATE_TRUNC('quarter', customer_table_src_22003.ds_partitioned) AS ds_partitioned__quarter
                , DATE_TRUNC('year', customer_table_src_22003.ds_partitioned) AS ds_partitioned__year
                , EXTRACT(year FROM customer_table_src_22003.ds_partitioned) AS ds_partitioned__extract_year
                , EXTRACT(quarter FROM customer_table_src_22003.ds_partitioned) AS ds_partitioned__extract_quarter
                , EXTRACT(month FROM customer_table_src_22003.ds_partitioned) AS ds_partitioned__extract_month
                , EXTRACT(day FROM customer_table_src_22003.ds_partitioned) AS ds_partitioned__extract_day
                , CASE WHEN EXTRACT(dow FROM customer_table_src_22003.ds_partitioned) = 0 THEN EXTRACT(dow FROM customer_table_src_22003.ds_partitioned) + 7 ELSE EXTRACT(dow FROM customer_table_src_22003.ds_partitioned) END AS ds_partitioned__extract_dow
                , EXTRACT(doy FROM customer_table_src_22003.ds_partitioned) AS ds_partitioned__extract_doy
                , customer_table_src_22003.customer_name AS customer_id__customer_name
                , customer_table_src_22003.customer_atomic_weight AS customer_id__customer_atomic_weight
                , DATE_TRUNC('day', customer_table_src_22003.ds_partitioned) AS customer_id__ds_partitioned__day
                , DATE_TRUNC('week', customer_table_src_22003.ds_partitioned) AS customer_id__ds_partitioned__week
                , DATE_TRUNC('month', customer_table_src_22003.ds_partitioned) AS customer_id__ds_partitioned__month
                , DATE_TRUNC('quarter', customer_table_src_22003.ds_partitioned) AS customer_id__ds_partitioned__quarter
                , DATE_TRUNC('year', customer_table_src_22003.ds_partitioned) AS customer_id__ds_partitioned__year
                , EXTRACT(year FROM customer_table_src_22003.ds_partitioned) AS customer_id__ds_partitioned__extract_year
                , EXTRACT(quarter FROM customer_table_src_22003.ds_partitioned) AS customer_id__ds_partitioned__extract_quarter
                , EXTRACT(month FROM customer_table_src_22003.ds_partitioned) AS customer_id__ds_partitioned__extract_month
                , EXTRACT(day FROM customer_table_src_22003.ds_partitioned) AS customer_id__ds_partitioned__extract_day
                , CASE WHEN EXTRACT(dow FROM customer_table_src_22003.ds_partitioned) = 0 THEN EXTRACT(dow FROM customer_table_src_22003.ds_partitioned) + 7 ELSE EXTRACT(dow FROM customer_table_src_22003.ds_partitioned) END AS customer_id__ds_partitioned__extract_dow
                , EXTRACT(doy FROM customer_table_src_22003.ds_partitioned) AS customer_id__ds_partitioned__extract_doy
                , customer_table_src_22003.customer_id
              FROM ***************************.customer_table customer_table_src_22003
            ) subq_4
          ) subq_5
          ON
            (
