...
LEFT OUTER JOIN (
  ...
  --    'listing']
  SELECT
    EXTRACT(doy FROM lux_listings_src_10019.valid_from) AS lux_listing__window_start__day
    , EXTRACT(doy FROM lux_listings_src_10019.valid_to) AS lux_listing__window_end__day
