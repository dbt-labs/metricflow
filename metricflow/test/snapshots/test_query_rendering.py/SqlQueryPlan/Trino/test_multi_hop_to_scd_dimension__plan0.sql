          ...
          LEFT OUTER JOIN (
            ...
            FROM (
              ...
              SELECT
                ...
                , EXTRACT(DAY_OF_WEEK FROM lux_listings_src_26004.valid_from) AS window_start__extract_dow
                ...
                , EXTRACT(DAY_OF_WEEK FROM lux_listings_src_26004.valid_to) AS window_end__extract_dow
                ...
                , EXTRACT(DAY_OF_WEEK FROM lux_listings_src_26004.valid_from) AS lux_listing__window_start__extract_dow
                ...
                , EXTRACT(DAY_OF_WEEK FROM lux_listings_src_26004.valid_to) AS lux_listing__window_end__extract_dow
