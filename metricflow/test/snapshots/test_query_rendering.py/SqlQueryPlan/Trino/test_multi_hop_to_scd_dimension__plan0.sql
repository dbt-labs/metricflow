        ...
        FROM (
          ...
          FROM (
            ...
            SELECT
              ...
              , EXTRACT(DAY_OF_WEEK FROM bookings_source_src_10015.ds) AS ds__extract_dow
              ...
              , EXTRACT(DAY_OF_WEEK FROM bookings_source_src_10015.ds_partitioned) AS ds_partitioned__extract_dow
              ...
              , EXTRACT(DAY_OF_WEEK FROM bookings_source_src_10015.paid_at) AS paid_at__extract_dow
              ...
              , EXTRACT(DAY_OF_WEEK FROM bookings_source_src_10015.ds) AS booking__ds__extract_dow
              ...
              , EXTRACT(DAY_OF_WEEK FROM bookings_source_src_10015.ds_partitioned) AS booking__ds_partitioned__extract_dow
              ...
              , EXTRACT(DAY_OF_WEEK FROM bookings_source_src_10015.paid_at) AS booking__paid_at__extract_dow
          ...
          LEFT OUTER JOIN (
            ...
            FROM (
              ...
              SELECT
                ...
                , EXTRACT(DAY_OF_WEEK FROM lux_listings_src_10019.valid_from) AS window_start__extract_dow
                ...
                , EXTRACT(DAY_OF_WEEK FROM lux_listings_src_10019.valid_to) AS window_end__extract_dow
                ...
                , EXTRACT(DAY_OF_WEEK FROM lux_listings_src_10019.valid_from) AS lux_listing__window_start__extract_dow
                ...
                , EXTRACT(DAY_OF_WEEK FROM lux_listings_src_10019.valid_to) AS lux_listing__window_end__extract_dow
