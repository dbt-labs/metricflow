      ...
      LEFT OUTER JOIN (
        ...
        FROM (
          ...
          SELECT
            ...
            , EXTRACT(DAY_OF_WEEK FROM users_ds_source_src_28008.ds) AS ds__extract_dow
            ...
            , EXTRACT(DAY_OF_WEEK FROM users_ds_source_src_28008.created_at) AS created_at__extract_dow
            ...
            , EXTRACT(DAY_OF_WEEK FROM users_ds_source_src_28008.ds_partitioned) AS ds_partitioned__extract_dow
            ...
            , EXTRACT(DAY_OF_WEEK FROM users_ds_source_src_28008.ds) AS user__ds__extract_dow
            ...
            , EXTRACT(DAY_OF_WEEK FROM users_ds_source_src_28008.created_at) AS user__created_at__extract_dow
            ...
            , EXTRACT(DAY_OF_WEEK FROM users_ds_source_src_28008.ds_partitioned) AS user__ds_partitioned__extract_dow
