        ...
        FROM (
          ...
          FROM (
            ...
            SELECT
              ...
              , EXTRACT(DAY_OF_WEEK FROM listings_src_26002.active_from) AS window_start__extract_dow
              ...
              , EXTRACT(DAY_OF_WEEK FROM listings_src_26002.active_to) AS window_end__extract_dow
              ...
              , EXTRACT(DAY_OF_WEEK FROM listings_src_26002.active_from) AS listing__window_start__extract_dow
              ...
              , EXTRACT(DAY_OF_WEEK FROM listings_src_26002.active_to) AS listing__window_end__extract_dow
          ...
          LEFT OUTER JOIN (
            ...
            FROM (
              ...
              SELECT
                ...
                , EXTRACT(DAY_OF_WEEK FROM users_latest_src_26006.ds) AS ds__extract_dow
                ...
                , EXTRACT(DAY_OF_WEEK FROM users_latest_src_26006.ds) AS user__ds__extract_dow
