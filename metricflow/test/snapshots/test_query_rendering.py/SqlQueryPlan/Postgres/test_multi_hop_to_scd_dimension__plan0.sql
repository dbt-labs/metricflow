          ...
          LEFT OUTER JOIN (
            ...
            FROM (
              ...
              SELECT
                ...
                , EXTRACT(isodow FROM lux_listings_src_26004.valid_from) AS window_start__extract_dow
                ...
                , EXTRACT(isodow FROM lux_listings_src_26004.valid_to) AS window_end__extract_dow
                ...
                , EXTRACT(isodow FROM lux_listings_src_26004.valid_from) AS lux_listing__window_start__extract_dow
                ...
                , EXTRACT(isodow FROM lux_listings_src_26004.valid_to) AS lux_listing__window_end__extract_dow
