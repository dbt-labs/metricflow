...
class WhereSpecFactory:
    ...
    def create_from_where_filter(self, where_filter: WhereFilter) -> WhereFilterSpec:  # noqa: D
        ...
        def _dimension_call(dimension_name: str, entity_path: Sequence[str] = ()) -> str:
            ...
            dimension_spec = WhereSpecFactory._convert_to_dimension_spec(call_parameter_set)
        ...
        def _time_dimension_call(
            ...
            assert call_parameter_set in call_parameter_sets.time_dimension_call_parameter_sets

            time_dimension_spec = WhereSpecFactory._convert_to_time_dimension_spec(call_parameter_set)
        ...
        def _entity_call(entity_name: str, entity_path: Sequence[str] = ()) -> str:
            ...
            assert call_parameter_set in call_parameter_sets.entity_call_parameter_sets

            entity_spec = WhereSpecFactory._convert_to_entity_spec(call_parameter_set)
