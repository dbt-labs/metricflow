...
class TimeGranularitySolver:
    ...
    def local_dimension_granularity_range(
        ...
        The 'bookings' measure defined is in the 'fct_bookings' entity. 'fct_bookings' has a local time dimension
        named 'ds' with granularity DAY.

        The 'monthly_bookings' measure is in defined in the 'fct_bookings_monthly' entity. 'fct_bookings_monthly'
